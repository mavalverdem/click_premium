...
Private porstSGUsr As ADODB.Recordset
']
...
Private Sub Form_Load()
 ...
 '[Recordsets.                         'Cambiar.
   ...
   Set porstSGUsr = New ADODB.Recordset
...
'     .CursorLocation = adUseClient   'Es el Default.
   ...
   With porstSGUsr
      .ActiveConnection = pocnnMain
      .Source = "SELECT CodUsr, AbvUsr "
      .Source = .Source & "FROM SGUsr "
      .Source = .Source & "ORDER BY CodUsr"
'     .CursorLocation = adUseClient   'Es el Default.
 ...
 '[Parámetros.                         'Cambiar.
   With txtDato
      For dnContador = 0 To 1
         .Item(dnContador).DataField = "CodUsr"
         .Item(dnContador).MaxLength = porstSGUsr.Fields(.Item(dnContador).DataField).DefinedSize
      Next
   End With
 ']
 ...
 '[Datos predeterminados.              'Cambiar.
  'Límites de rangos.
   With porstSGUsr
      .MoveLast
      txtDato(1).Text = !CodUsr
      .MoveFirst
      txtDato(0).Text = !CodUsr
   End With
...
Private Sub cmdImprimir_Click(Index As Integer)
  ...
  With porstMRp
    ...
    .Source = "SELECT CodUsr, NomUsr, AbvUsr, "
    .Source = .Source & "(CASE EstUsr WHEN '" & ESTUSR_ACT & "' THEN '" & ESTUSR_ACT_TXT & "' ELSE '" & ESTUSR_INA_TXT & "' END) AS cEstUsr, b.CodEmp, b.RazEmp, MesUsr, AnoUsr "
    .Source = .Source & "FROM SGUsr "
    .Source = .Source & "LEFT JOIN tgemp b ON SGUsr.EmpUsr=b.CodEmp "
    .Source = .Source & "WHERE CodUsr BETWEEN '" & txtDato(0).Text & "' AND '" & txtDato(1).Text & "' "
    .Source = .Source & "ORDER BY 1, 5"
    .Open
  End With
  ...
  If usDEstino = PRN_DEST_GRAF Then
    ...
    With frmMain.rptMain
      ...
      .ReportFileName = gsRutRpt & "rptLUsr.rpt"
  ...
  Else
    ...
    With MRViewer
      ...
      .LoadReport gsRutRpt & "rptLUsr.mrp"
...
Private Sub ppAyuBus(tnIndex As Integer)
   Select Case tnIndex
   Case 0, 1                           'Cambiar (añadir índices).
      modAyuBus.Usr_Cod "", txtDato(tnIndex).Text, 0, 0, Me.Top + fraRangos.Top + txtDato(tnIndex).Top + txtDato(tnIndex).Height, Me.Left + fraRangos.Left + txtDato(tnIndex).Left
...
Private Function ppAyuDet(tnIndex As Integer)
   ...
   Case 0, 1
      ...
      With porstSGUsr
         .MoveFirst
         .Find "CodUsr='" & txtDato(tnIndex).Text & "'"
         If .EOF Then
            MsgBox TEXT_8006, vbExclamation
            ppAyuDet = True
         Else
            lblDatoDeta(tnIndex).Caption = " " & !AbvUsr
         End If
      End With
   End Select
End Function
