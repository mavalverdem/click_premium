...
'     .CursorLocation = adUseClient   'Es el Default.
   ...
   With porstTGTDc
      .ActiveConnection = pocnnMain
      .Source = "SELECT CodTDc, "
      .Source = .Source & Choose(gsIdioma, "DetTDc ", "DetTDcx ") & "AS DetTDc "
 ...
 '[Parámetros.                         'Cambiar.
   With txtDato
      For dnContador = 0 To 1
         .Item(dnContador).DataField = "CodTDc"
         .Item(dnContador).MaxLength = porstTGTDc.Fields(.Item(dnContador).DataField).DefinedSize
      Next
   End With
 ']
  ...
  For nElemento = 0 To UBound(aLabel, 1) - 1
    aLabel(nElemento, 0) = Choose(nElemento + 1, "Tipos de Documentos")
    aLabel(nElemento, 1) = Choose(nElemento + 1, "Types of Documents")
  Next nElemento
...
Private Sub cmdImprimir_Click(Index As Integer)
  ...
  With porstMRp
    ...
    .Source = "SELECT CodTDc, " & Choose(gsIdioma, "DetTDc", "DetTDcx") & " AS DetTDc, AbvTDc "
    .Source = .Source & "FROM TGTDc "
    .Source = .Source & "WHERE codemp='" & gsCodEmp & "' "
    .Source = .Source & "AND CodTDc BETWEEN '" & txtDato(0).Text & "' AND '" & txtDato(1).Text & "' "
  ...
  If usDEstino = PRN_DEST_GRAF Then
    ...
    With frmMain.rptMain
      ...
      .ReportFileName = gsRutRpt & "rptLTDc.rpt"
  ...
  Else
    ...
    With MRViewer
      ...
      .LoadReport gsRutRpt & "rptLTDc.mrp"
