...
Begin VB.Form frmMDetracGrd 
   ...
   Begin VB.PictureBox picOpciones 
      ...
      Begin VB.CommandButton cmdImprimir 
         ...
         Index           =   1
         Left            =   2880
         Picture         =   "frmMDetracGrd.frx":0102
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   0
         Width           =   720
      ...
      Begin VB.CommandButton cmdEliminar 
         ...
         Height          =   560
         Left            =   1440
         Picture         =   "frmMDetracGrd.frx":0204
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   0
         Width           =   720
      ...
      Begin VB.CommandButton cmdNuevo 
         ...
         Height          =   560
         Left            =   0
         Picture         =   "frmMDetracGrd.frx":0306
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   0
         Width           =   720
      ...
      Begin VB.CommandButton cmdSalir 
         ...
         Height          =   560
         Left            =   7750
         Picture         =   "frmMDetracGrd.frx":0408
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   0
         Width           =   720
      ...
      Begin VB.CommandButton cmdRefrescar 
         ...
         Height          =   560
         Left            =   2160
         Picture         =   "frmMDetracGrd.frx":0552
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   0
         Width           =   720
...
Private Sub Form_Load()
 '[Recordsets                          'Cambiar.
   ...
   'psConnStrgSele = psConnStrgSele & "detdetrac, tsadetrac,indmod,estdetrac, "
   psConnStrgSele = psConnStrgSele & Choose(gsIdioma, "detdetrac, ", "detdetracx, ")
   psConnStrgSele = psConnStrgSele & "tsadetrac,"
   psConnStrgSele = psConnStrgSele & "(CASE estdetrac WHEN '" & ESTCTA_ACT & "' THEN '" & ESTCTA_ACT_TXT & "'ELSE '" & ESTCTA_INA_TXT & "' END) AS cEstCta, "
...
Private Sub Form_Activate()
   ...
   '2015-06-25 eliminar temporalmente zaOpciones = Array(gbPms01, gbPms03, gbPms04, gbPms05)
   ppDatosGrid
