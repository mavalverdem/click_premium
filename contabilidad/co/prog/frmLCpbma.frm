...
Private Sub cmdImprimir_Click(Index As Integer)
  ...
  With porstMRp
    ...
    .Source = .Source & "b.TpoCtb, b.ImpME, b.ImpMN "
    .Source = .Source & "FROM comacpbcab a "
    .Source = .Source & "LEFT JOIN comacpbdet b ON a.codemp=b.codemp AND a.pdoano=b.pdoano AND a.MesPvs=b.MesPvs AND a.CodDro=b.CodDro AND a.NroCpb = b.NroCpb "
