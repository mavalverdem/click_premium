...
'     .CursorLocation = adUseClient   'Es el Default.
   ...
   With porstTGEMP
      .ActiveConnection = pocnnMain
      .Source = "SELECT CodEmp, RazEmp "
      .Source = .Source & "FROM TGEmp "
 ...
 '[Parámetros.                         'Cambiar.
   With txtDato
      For dnContador = 0 To 1
         .Item(dnContador).DataField = "CodEmp"
         .Item(dnContador).MaxLength = porstTGEMP.Fields(.Item(dnContador).DataField).DefinedSize
      Next
   End With
 ']
  ...
  For nElemento = 0 To UBound(aLabel, 1) - 1
    aLabel(nElemento, 0) = Choose(nElemento + 1, "Empresas")
    aLabel(nElemento, 1) = Choose(nElemento + 1, "Companies")
  Next nElemento
...
Private Sub cmdImprimir_Click(Index As Integer)
  ...
  With porstMRp
    ...
    .Source = "SELECT CodEmp, RazEmp, RUCEmp "
    .Source = .Source & "FROM TGEmp "
    .Source = .Source & "WHERE CodEmp BETWEEN '" & txtDato(0).Text & "' AND '" & txtDato(1).Text & "' "
  ...
  If usDEstino = PRN_DEST_GRAF Then
    ...
    With frmMain.rptMain
      ...
      .ReportFileName = gsRutRpt & "rptLEmp.rpt"
  ...
  Else
    ...
    With MRViewer
      ...
      .LoadReport gsRutRpt & "rptLEmp.mrp"
...
Private Sub ppAyuBus(tnIndex As Integer)
   Select Case tnIndex
   Case 0, 1                           'Cambiar (añadir índices).
      modAyuBus.Emp_Cod "", txtDato(tnIndex).Text, 0, 0, Me.Top + fraRangos.Top + txtDato(tnIndex).Top + txtDato(tnIndex).Height, Me.Left + fraRangos.Left + txtDato(tnIndex).Left
