      ...
      Begin MSComctlLib.Toolbar toolbar 
         ...
         BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty Button1 {66833FEA-8583-11D1-B16A-00C0F0283628} 
               Caption         =   "Reportes"
               Object.ToolTipText     =   "Otros Reportes de presupuesto"
               ImageIndex      =   1
               Style           =   5
         ...
         Begin MSComctlLib.ImageList ImageList1 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmRCtlPsp.frx":1B16
                  Key             =   ""
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmRCtlPsp.frx":1ED8
                  Key             =   ""
               EndProperty
            EndProperty
         End
...
'ini sql8 2015-03-23
toolbar.Buttons(1).ButtonMenus(1).Text = "Presupuesto x Centro de Costo"
toolbar.Buttons(1).ButtonMenus(2).Text = "Presupuesto x Cuenta Contable"
toolbar.Buttons(1).ButtonMenus(3).Text = "Presupuesto x Centro Costo Saldo Anual"
...
Private Sub cmdImprimir_Click(Index As Integer)
  ...
  Select Case pnOpcion
   Case 1: proc_cmd_imprimir Index, 1: Exit Sub
   Case 2: pReporte Index: Exit Sub
   '2016-06-15 no se puede Case 3: proc_cmd_imprimir Index, 3: Exit Sub
   Case 3
    With frmRCtlPsp3
        '.Show vbModal
        .Show
...
Private Sub proc_cmd_imprimir(Index As Integer, xtpo_rpt As Integer)

'ini 2016-06-15 se pone nvo frm reporte interfondo
''        If xtpo_rpt = 3 Then
''        If OptTipo(1).Value Then
''        MsgBox ("No existe reporte")
''        Exit Sub
''        End If
''        End If
...
'xtpo_rpt:
'1=Presupuesto x Centro de Costo
'3=Presupuesto x Centro Costo Saldo Anual
  ...
  If usDEstino = PRN_DEST_GRAF Then
    ...
    With frmMain.rptMain
      ...
      'ini 2016-06-10 rpt ppsto interfondo
...
'fin 2016-06-15 se pone nvo frm reporte interfondo
  ...
  End Select
End Sub
Private Sub toolbar_ButtonMenuClick_2016_06_10(ByVal ButtonMenu As MSComctlLib.ButtonMenu)
