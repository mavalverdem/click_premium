...
Private Sub Form_Load()
   ...
   With frmMHT2Grd                     'Cambiar Formulario de Grid.
    '[Llaves                           'Cambiar
...
Private Sub Form_Activate()
 ...
 ']
''   If pbNuevo Then
''      With frmMHT2Grd.porstUltOrdRep
''         .Open
...
Private Sub Form_Unload(Cancel As Integer)
   If Not frmMHT2Grd.uorstMain.EOF Then
      If frmMHT2Grd.uorstMain.EditMode <> adEditNone Then frmMHT2Grd.uorstMain.CancelUpdate   'Cambiar Formulario de Grid.
   End If
End Sub

Private Sub cmdRetroceder_Click()
   gpTUe_Retroceder frmMHT2Grd.uorstMain, Me 'Cambiar Formulario de Grid.
End Sub

Private Sub cmdAvanzar_Click()
   gpTUe_Avanzar frmMHT2Grd.uorstMain, Me 'Cambiar Formulario de Grid.
End Sub
...
Err:
   ...
   frmMHT2Grd.uocnnMain.RollbackTrans  'RESTAURA TRANSACCION.
End Sub
...
'         uorstMain!CodMon = optMoneda(1).Value
         .uorstMain.Fields("ImpValH") = CDec(txtDato(0).Text)
         .uorstMain.Fields("ImpValA") = CDec(txtDato(1).Text)
      Else
        'Llaves.
...
'         optMoneda(1).Value = uorstMain!CodMon
         txtDato(0).Text = Format(IIf(IsNull(.uorstMain.Fields("ImpValH")), 0, .uorstMain.Fields("ImpValH")), FORMATO_NUM_1)
         txtDato(1).Text = Format(IIf(IsNull(.uorstMain.Fields("ImpValA")), 0, .uorstMain.Fields("ImpValA")), FORMATO_NUM_1)
      End If
   End With
