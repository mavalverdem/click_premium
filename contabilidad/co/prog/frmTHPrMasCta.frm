...
Begin VB.Form frmTHPrMasCta 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdDeshacer 
         ...
         Height          =   560
         Left            =   1950
         Picture         =   "frmTHPrMasCta.frx":014A
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   60
         Width           =   720
      ...
      Begin VB.CommandButton cmdGrabar 
         ...
         Height          =   560
         Left            =   1220
         Picture         =   "frmTHPrMasCta.frx":024C
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   60
         Width           =   720
      ...
      Begin VB.CommandButton cmdCorregir 
         ...
         Height          =   560
         Left            =   480
         Picture         =   "frmTHPrMasCta.frx":034E
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   60
         Width           =   720
      ...
      Begin VB.CommandButton cmdAvanzar 
         ...
         Height          =   270
         Left            =   60
         Picture         =   "frmTHPrMasCta.frx":0498
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   338
         Width           =   360
...
Private Sub Form_Load()
   ...
   With frmTHPrGrd                     'Cambiar Formulario de Grid.
    ...
    ']
    '[Datos                            'Cambiar.
      'txtDato(1).MaxLength = .uorstCOHPrDocCta!ImpCta_MN.DefinedSize
      'txtDato(2).MaxLength = .uorstCOHPrDocCta!ImpCta_ME.DefinedSize
     ...
     If Len(Trim(txtDato(Index).Text)) <> 0 Then
      ...
      With frmTHPrGrd.uorstCOHPrDocCta
         ...
         If Not (.BOF Or .EOF) And .RecordCount > 0 Then
            ...
            .MoveFirst
             .Find "cLlave2='" & frmTHPr.txtLlave(0).Text & frmTHPr.txtLlave(1).Text & frmTHPr.txtLlave(2).Text & frmTHPrMasGrd.unIndice & txtDato(0).Text & "'"
            If Not .EOF Then
