   ...
   With frmMpago                     'Cambiar Formulario de Grid.
    ...
    '[Datos                            'Cambiar.
       With cboIndicador
        ...
        .AddItem "Deposito", 2
       End With
      txtDato(0).MaxLength = .uorstMain!detdetrac.DefinedSize
      txtDato(1).MaxLength = .uorstMain!tsadetrac.DefinedSize
      ...
      If tnFase = 0 Then
        ...
        'Llaves.
         If pbNuevo Then
          ...
          .uorstMain!coddetrac = txtLlave(0).Text
         End If
        'Datos.
         '.uorstMain!indmod = cboIndicador.ListIndex
         .uorstMain!detdetrac = txtDato(0).Text
         .uorstMain!tsadetrac = txtDato(1).Text
         .uorstMain!estdetrac = chkEst.Value
         
      Else
        
        'Llaves.
         txtLlave(0).Text = .uorstMain!coddetrac
        'Datos.
         'cboIndicador.ListIndex = .uorstMain!indmod
         txtDato(0).Text = IIf(IsNull(.uorstMain!detdetrac), "", .uorstMain!detdetrac)
         txtDato(1).Text = IIf(IsNull(.uorstMain!tsadetrac), "", .uorstMain!tsadetrac)
         chkEst.Value = .uorstMain!estdetrac
