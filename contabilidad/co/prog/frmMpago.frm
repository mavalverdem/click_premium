...
Private Sub Form_Load()
 '[Recordsets                          'Cambiar.
   psConnStrgSele = "SELECT codmed, "
   psConnStrgSele = psConnStrgSele & "desmed, abvmed,indmod,estadomed, "
   psConnStrgSele = psConnStrgSele & "codemp, "
   psConnStrgSele = psConnStrgSele & "UsrCre, FyHCre, UsrMdf, FyHMdf "
   psConnStrgSele = psConnStrgSele & "FROM bnmediopago "
...
'     .CursorLocation = adUseClient   'Es el Default.
      ...
      .Open
      .Properties("Unique Table").Value = "bnmediopago"
   End With
 ']
...
Public Sub cmdNuevo_Click()
   gpTUg_Nuevo Me, FrmMPgo            'Cambiar Formulario de Datos.
End Sub
...
Public Sub cmdRevisar_click()
   ...
   With FrmMPgo                        'Cambiar Formulario de Datos.
      .zbNuevo = False
