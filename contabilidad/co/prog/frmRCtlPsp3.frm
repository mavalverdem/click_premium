...
Begin VB.Form frmRCtlPsp3 
   Caption         =   "Presupuesto x Centro Costo Saldo Anual"
   ClientHeight    =   4380
   ClientLeft      =   1620
   ClientTop       =   1515
   ClientWidth     =   6990
         ...
         Begin MSComctlLib.ImageList ImageList1 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmRCtlPsp3.frx":0C7C
                  Key             =   ""
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmRCtlPsp3.frx":0DD6
                  Key             =   ""
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmRCtlPsp3.frx":0F30
                  Key             =   ""
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmRCtlPsp3.frx":12F2
                  Key             =   ""
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmRCtlPsp3.frx":19BC
                  Key             =   ""
               EndProperty
            EndProperty
         End
...
'ini 2016-06-15/17 se pone nvo frm reporte interfondo
'        .Source = "SELECT "
...
'        .Source = .Source & " ,psptot " '2016-06-15 se pone nvo frm reporte interfondo
...
'        .Source = .Source & " ORDER BY OrdRep_1, OrdRep_2, CodCta,codcco"
        .Source = "SELECT "
        .Source = .Source & " codcta,detcta,ordrep_1,detordrep_1,ordrep_2,"
        .Source = .Source & " detordrep_2 , impsdo_mes, impsdo_acu, pspmes,pspacu,"
        .Source = .Source & " numcol0, "
        .Source = .Source & " numcol1,numcol2,numcol3,numcol4,numcol5,"
        .Source = .Source & " numcol6,numcol7,numcol8,numcol9,numcol10,"
        .Source = .Source & " numcol11,numcol12,"
        .Source = .Source & " psptot, " '2016-06-15 se pone nvo frm reporte interfondo
        .Source = .Source & " codaux,razaux,rucaux,codtdc,abvtdc,"
        .Source = .Source & " serdoc,nrodoc,feedoc,fevdoc,refdoc,"
        .Source = .Source & " gloite,codcco,cdocum , coddro, nrocpb,"
        .Source = .Source & " mespvs, blqite, fehope, nomrpt, cdrocpb, "
        .Source = .Source & " tpocta, tposdo, usrcre, detcco,codemp,"
        .Source = .Source & " pdoano"
        .Source = .Source & " FROM COTmpRpt "
        .Source = .Source & " WHERE codemp='" & gsCodEmp & "' "
        .Source = .Source & " AND UsrCre='" & gsCodUsr & "' "
        .Source = .Source & " AND NomRpt='rptRCtlPsp' "
...
'fin 2016-06-15/17 se pone nvo frm reporte interfondo
...
Private Sub cmdImprimir_Click(Index As Integer)
    ...
    'proc_cmd_imprimir_2016_06_28_ok Index, 0
End Sub
...
'ini 2016-06-15 se pone nvo frm reporte interfondo
  'presupuesto acumulado
  Dim sPptoTot As String
  sIni = IIf(OptTipo(0).Value, "", "SUM")
  sPptoTot = sIni & "("
  For nContador = 1 To 12
    sPptoTot = sPptoTot & "Imp" & IIf(cboTpoMon.ListIndex = 0, "MN_", "ME_") & Format(nContador, "00") & IIf(nContador = 12, ")", " + ")
  Next nContador
  sPptoTot = "ROUND(" & IIf(ps_Plataforma = pSrvMySql, "IFNULL", "ISNULL") & "(" & sPptoTot & ", 0), 2)"
'fin 2016-06-15 se pone nvo frm reporte interfondo
    
  '2016-06-28 juntar sql de  txtLlave(0).Text <> "" con igual If txtLlave(0).Text <> "" Then
...
'ini 2016-06-15 se pone nvo frm reporte interfondo
    .Source = .Source & sPptoTot & " AS cPreTot "
'fin 2016-06-15 se pone nvo frm reporte interfondo
    .Source = .Source & "FROM ((COPsp a "
'ini 2016-06-28 error reporte sale por cta debe salir x c.ctos.
'    .Source = .Source & "LEFT JOIN COCtaAcu ON a.codemp=COCtaAcu.codemp AND a.pdoano=COCtaAcu.pdoano AND a.CodCta=COCtaAcu.CodCta) "
    .Source = .Source & "LEFT JOIN CoCCoAcu COCtaAcu ON a.codemp=COCtaAcu.codemp AND a.pdoano=COCtaAcu.pdoano AND a.CodCta=COCtaAcu.CodCta AND a.CodCCo=COCtaAcu.CodCCo)  "
'fin 2016-06-28 error reporte sale por cta debe salir x c.ctos.
    If OptTipo(0).Value Then
...
'ini 2016-06-28 juntar sql de  txtLlave(0).Text <> "" con igual
'biene de arriba, cuando tiene datos en c.costo
        If txtLlave(0).Text <> "" Then
        .Source = .Source & "AND a.codcco='" & txtLlave(0).Text & "' "
        End If
'    .Source = .Source & "AND a.codcco='" & txtLlave(0).Text & "' "
'fin 2016-06-28 juntar sql de  txtLlave(0).Text <> "" con igual

    If OptTipo(0).Value Then
      .Source = .Source & "AND b.TpoCta='" & TPOCTA_TRA & "' "
'ini 2016-06-28 juntar sql de  txtLlave(0).Text <> "" con igual
'biene de abajo, cuando no tiene datos en c.costo
        If txtLlave(0).Text = "" Then
...
'''  End With
'''  End If
'fin 2016-06-28 juntar sql txtLlave(0).Text <> "" con igual
...
'        .Formulas(7) = "mTitulo2='" & IIf(txtLlave(0).Text = "", Choose(gsIdioma, "Todos los Centro de Costos", "All Cost Center"), Trim(txtLlave(0).Text) & " - " & Trim(lblLlaveDeta(0).Caption)) & "'"
'    End With
    ...
    'gpEncabezadoRpt frmMain.rptMain, Me.Caption & " -" & IIf(OptTipo(0).Value, Choose(gsIdioma, "Detalle", "Detail"), Choose(gsIdioma, "Resumen", "Summary")) & "-" & " (" & IIf(cboTpoMon.ListIndex = TPOMON_NAC_IND, TPOMON_NAC_TXT_1, TPOMON_EXT_TXT_1) & ")", udFecha, True, chkImpFecha.Value, porstMRpRs
    With frmMain.rptMain
        .Formulas(7) = "mTitulo2='" & "Centro Costo: " & IIf(txtLlave(0).Text = "", Choose(gsIdioma, "Todos", "All"), Trim(txtLlave(0).Text) & " - " & Trim(lblLlaveDeta(0).Caption)) & "'"

      '[Datos y parámetros del reporte.  'Cambiar.
'ini 2016-06-15 se pone nvo frm reporte interfondo
      '.ReportFileName = gsRutRpt & IIf(OptTipo(0).Value, "rptRCtlPsp", "rptRCtlPspRes") & ".rpt"
      .ReportFileName = gsRutRpt & IIf(OptTipo(0).Value, "rptRCtlPsp3", "") & ".rpt"
'fin 2016-06-15 se pone nvo frm reporte interfondo
...
Private Sub proc_cmd_imprimir_2016_06_28_ok(Index As Integer, ptpo_rpt As Integer)
  Dim sCadena, sIni, cCadReporte As String
  Dim nContador As Integer
...
Public Sub Llena_Temporal()
    ...
    'jp
    ''2016-06-15 se pone nvo frm reporte interfondo Dim aImporte(2, 4) As Double
    Dim aImporte(2, 5) As Double
    Dim nSaldo As Double, nSaldoAcu As Double
    Dim nPresupuesto As Double, nPresupuestoAcu As Double
    Dim nPresupuestoTot As Double '2016-06-15 se pone nvo frm reporte interfondo
    ...
    If porstMRp.RecordCount > 0 Then
        ...
        Do While Not porstMRp.EOF
           ...
           nPresupuestoTot = porstMRp.Fields!cPreTot
           If porstMRp.Fields!cOrden = "A" Then
             ...
             aImporte(1, 5) = aImporte(1, 5) + nPresupuestoTot '2016-06-15 se pone nvo frm reporte interfondo
           Else
             ...
             aImporte(2, 5) = aImporte(2, 5) + nPresupuestoTot '2016-06-15 se pone nvo frm reporte interfondo
           End If
           If (nSaldo <> 0 Or nSaldoAcu <> 0 Or nPresupuesto <> 0 Or nPresupuestoAcu <> 0) Then
                ...
                porstMRpRs.Fields!psptot = nPresupuestoTot '2016-06-15 se pone nvo frm reporte interfondo
                porstMRpRs.Fields!detcco = "SINNULO" '2016-06-15 se pone nvo frm reporte interfondo
                porstMRpRs.Update
...
End Sub
Public Sub Llena_Temporal_2015_06_16()
...
Private Sub ppAyuBusx(tnIndex As Integer)
   ...
   Case 0                              'Cambiar (añadir índices).
      '2016-06-15 traer a 5 digitos modAyuBus.CCo_Cod "length(codcco)=2 ", "", 0, 0, Me.Top + txtLlave(tnIndex).Top + txtLlave(tnIndex).Height, Me.Left + txtLlave(tnIndex).Left
      modAyuBus.CCo_Cod "length(codcco)=5 ", "", 0, 0, Me.Top + txtLlave(tnIndex).Top + txtLlave(tnIndex).Height, Me.Left + txtLlave(tnIndex).Left
