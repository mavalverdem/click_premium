...
Private Sub Form_Load()
 '[Recordsets                          'Cambiar.
   psConnStrgSele = "SELECT CodUsr, NomUsr, AbvUsr, "
   psConnStrgSele = psConnStrgSele & "(CASE EstUsr WHEN '" & ESTUSR_ACT & "' THEN '" & ESTUSR_ACT_TXT & "' ELSE '" & ESTUSR_INA_TXT & "' END) AS cEstUsr, "
   psConnStrgSele = psConnStrgSele & "ClaUsr, EmpUsr, AnoUsr, MesUsr, NvlUsr, EstUsr, "
   psConnStrgSele = psConnStrgSele & "UsrCre, FyHCre, UsrMdf, FyHMdf "
   psConnStrgSele = psConnStrgSele & "FROM SGUsr "
...
'     .CursorLocation = adUseClient   'Es el Default.
      ...
      .Open
'      .Properties("Unique Table").Value = "CodUsr"
   End With
   With uorstTGEmp
      .ActiveConnection = uocnnMain
      .Source = "SELECT a.CodEmp, a.RazEmp "
      .Source = .Source & "FROM TGEmp a"
'     .CursorLocation = adUseClient   'Es el Default.
...
Public Sub cmdNuevo_Click()
   gpTUg_Nuevo Me, frmMUsr             'Cambiar Formulario de Datos.
End Sub
...
Public Sub cmdRevisar_click()
   ...
   With frmMUsr                        'Cambiar Formulario de Datos.
      .zbNuevo = False
...
Public Sub cmdImprimir_Click(Index As Integer)
 '[Datos del formulario de impresión.  'Cambiar.
   frmLUsr.Caption = Choose(gsIdioma, "Listado de ", "Listing of ") & Me.Caption
   frmLUsr.Show vbModal
 ']
End Sub
...
Public Sub ppDatosGrid()               'Cambiar Datos Grid.
   ...
   With dgrMain.Columns
      For dnNum = 0 To .Count - 1
         ...
         Case 2
            .Item(dnNum).Caption = Choose(gsIdioma, "Nombre", "Name")
            .Item(dnNum).Width = 1300
         Case 3
