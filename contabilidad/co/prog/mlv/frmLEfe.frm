...
Begin VB.Form frmLEfe 
   ...
   Begin VB.Frame fraRangos 
      Caption         =   "Rango Flujos de Efectivo"
      ForeColor       =   &H80000002&
      Height          =   1275
      Left            =   0
      TabIndex        =   7
...
Private porstCoEfe As ADODB.Recordset
']
...
Private Sub Form_Load()
 ...
 '[Recordsets.                         'Cambiar.
   ...
   Set porstCoEfe = New ADODB.Recordset
...
'     .CursorLocation = adUseClient   'Es el Default.
   ...
   With porstCoEfe
      .ActiveConnection = pocnnMain
      .Source = "SELECT CodEfe, " & Choose(gsIdioma, "DetEfe", "DetEfex") & " AS DetEfe "
...
'     .CursorLocation = adUseClient   'Es el Default.
 ...
 '[Parámetros.                         'Cambiar.
   With txtDato
      For dnContador = 0 To 1
         .Item(dnContador).DataField = "CodEfe"
         .Item(dnContador).MaxLength = porstCoEfe.Fields(.Item(dnContador).DataField).DefinedSize
      Next
   End With
 ']
  ...
  For nElemento = 0 To UBound(aLabel, 1) - 1
    aLabel(nElemento, 0) = Choose(nElemento + 1, "Flujos")
    aLabel(nElemento, 1) = Choose(nElemento + 1, "Flows")
  Next nElemento
  fraRangos.Caption = Choose(gsIdioma, "Rango de Flujo Efectivo", "Range of Money Flow")
 ...
 '[Datos predeterminados.              'Cambiar.
  'Límites de rangos.
   With porstCoEfe
      .MoveLast
      txtDato(1).Text = !CodEfe
      .MoveFirst
      txtDato(0).Text = !CodEfe
   End With
...
Private Sub cmdImprimir_Click(Index As Integer)
  ...
  With porstMRp
    ...
    .Source = "SELECT CodEfe, " & Choose(gsIdioma, "DetEfe", "DetEfex") & " AS DetEfe, TpoEfe "
    .Source = .Source & "FROM COEfe "
    .Source = .Source & "WHERE codemp='" & gsCodEmp & "' "
    .Source = .Source & "AND pdoano='" & gsAnoAct & "' "
    .Source = .Source & "AND CodEfe BETWEEN '" & txtDato(0).Text & "' AND '" & txtDato(1).Text & "' "
    .Source = .Source & "ORDER BY CodEfe"
    .Open
  End With
  ...
  If usDEstino = PRN_DEST_GRAF Then
    ...
    With frmMain.rptMain
      ...
      .ReportFileName = gsRutRpt & "rptLEfe.rpt"
  ...
  Else
    ...
    With MRViewer
      ...
      .LoadReport gsRutRpt & "rptLEfe.mrp"
...
Private Sub ppAyuBus(tnIndex As Integer)
   Select Case tnIndex
   Case 0, 1                           'Cambiar (añadir índices).
      modAyuBus.Efe_Cod "", txtDato(tnIndex).Text, 0, 0, Me.Top + fraRangos.Top + txtDato(tnIndex).Top + txtDato(tnIndex).Height, Me.Left + fraRangos.Left + txtDato(tnIndex).Left
   ...
   Case 0, 1
      ...
      With porstCoEfe
         ...
         If .EOF Then
            ...
            ppAyuDet = True
         Else
            lblDatoDeta(tnIndex).Caption = " " & !DetEfe
         End If
      End With
   End Select
End Function
