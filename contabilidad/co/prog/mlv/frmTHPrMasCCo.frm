...
Begin VB.Form frmTHPrMasCCo 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdSalir 
         ...
         Height          =   560
         Left            =   2690
         Picture         =   "frmTHPrMasCCo.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   60
         Width           =   720
      ...
      Begin VB.CommandButton cmdDeshacer 
         ...
         Height          =   560
         Left            =   1950
         Picture         =   "frmTHPrMasCCo.frx":014A
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   60
         Width           =   720
      ...
      Begin VB.CommandButton cmdGrabar 
         ...
         Height          =   560
         Left            =   1220
         Picture         =   "frmTHPrMasCCo.frx":024C
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   60
         Width           =   720
      ...
      Begin VB.CommandButton cmdCorregir 
         ...
         Height          =   560
         Left            =   480
         Picture         =   "frmTHPrMasCCo.frx":034E
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   60
         Width           =   720
      ...
      Begin VB.CommandButton cmdAvanzar 
         ...
         Height          =   270
         Left            =   60
         Picture         =   "frmTHPrMasCCo.frx":0498
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   338
         Width           =   360
      ...
      Begin VB.CommandButton cmdRetroceder 
         ...
         Height          =   270
         Left            =   60
         Picture         =   "frmTHPrMasCCo.frx":0642
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   60
         Width           =   360
   ...
   Begin VB.CommandButton cmdDatoAyud 
      ...
      Index           =   0
      Left            =   5040
      Picture         =   "frmTHPrMasCCo.frx":07EC
      Style           =   1  'Graphical
      TabIndex        =   9
      TabStop         =   0   'False
      Top             =   135
   ...
   End
End
Attribute VB_Name = "frmTHPrMasCCo"
...
Private Sub Form_Load()
   ...
   With frmTHPrGrd                     'Cambiar Formulario de Grid.
    '[Datos                            'Cambiar.
      txtDato(0).MaxLength = .uorstCOHPrDocCCo!CodCCo.DefinedSize
      
      'txtDato(1).MaxLength = .uorstCOHPrDocCCo!ImpCCo_MN.DefinedSize
      'txtDato(2).MaxLength = .uorstCOHPrDocCCo!ImpCCo_ME.DefinedSize
    ...
    If Len(Trim(txtDato(Index).Text)) <> 0 Then
      ...
      With frmTHPrGrd.uorstCOHPrDocCCo
         If Not (.BOF Or .EOF) And .RecordCount > 0 Then
            ...
            .MoveFirst
            .Find "cLlave2='" & frmTHPr.txtLlave(0).Text & frmTHPr.txtLlave(1).Text & frmTHPr.txtLlave(2).Text & frmTHPrMasGrd.unIndice & frmTHPrGrd.uorstCOHPrDocCta!orden & frmTHPrMasGrd.dgrMain.Columns(0).Text & txtDato(0).Text & "'"
            If Not .EOF Then
      ...
      If tnFase = 0 Then
        'Llaves.
         If pbNuevo Then
            ...
            !orden = frmTHPrGrd.uorstCOHPrDocCta!orden
            !CodCta = frmTHPrMasGrd.dgrMain.Columns(0).Text
         End If
...
'///Envio de valor desde la pantalla de inicio de registro
   If pbNuevo Then
      If frmTHPr.cboTpoMon.ListIndex = TPOMON_NAC_IND Then
         txtDato(1).Text = Format(frmTHPrGrd.uorstCOHPrDocCta!ImpCta_MN, FORMATO_NUM_1)
      Else
         txtDato(2).Text = Format(frmTHPrGrd.uorstCOHPrDocCta!ImpCta_ME, FORMATO_NUM_1)
      End If
      With frmTHPrGrd.uorstCOHPrDocCCo
