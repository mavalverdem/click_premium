...
Private Sub Form_Load()
 '[Recordsets                          'Cambiar.
   ...
   psConnStrgSele = psConnStrgSele & ",a.buencontri " '2015-08-27 ctr obligac sunat
...
Private Sub cmdAceptar_Click()
  ...
  gsBuenContriEmp = IIf(IsNull(porstMain!BuenContri), "", porstMain!BuenContri) '2015-08-27 ctr obligac sunat
