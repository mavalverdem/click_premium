...
Begin VB.Form frmTCpr 
   ...
   Begin TabDlg.SSTab sstMain 
      ...
      Tab(0).Control(35)=   "cmdDatoAyud(27)"
      Tab(0).Control(35).Enabled=   0   'False
      Tab(0).Control(36)=   "txtDato(27)"
      Tab(0).Control(36).Enabled=   0   'False
      Tab(0).Control(37)=   "txtDato(28)"
      Tab(0).Control(37).Enabled=   0   'False
      Tab(0).Control(38)=   "cmdDatoAyud(28)"
      Tab(0).Control(38).Enabled=   0   'False
      Tab(0).Control(39)=   "cmdDatoAyud(29)"
      Tab(0).Control(39).Enabled=   0   'False
      Tab(0).Control(40)=   "txtDato(29)"
      Tab(0).Control(40).Enabled=   0   'False
      Tab(0).Control(41)=   "cmdDatoAyud(30)"
      Tab(0).Control(41).Enabled=   0   'False
      Tab(0).Control(42)=   "txtDato(30)"
      Tab(0).Control(42).Enabled=   0   'False
      Tab(0).Control(43)=   "cmdDatoAyud(31)"
      Tab(0).Control(43).Enabled=   0   'False
      Tab(0).Control(44)=   "txtDato(31)"
      Tab(0).Control(44).Enabled=   0   'False
      Tab(0).Control(45)=   "cmdDatoAyud(32)"
      Tab(0).Control(45).Enabled=   0   'False
      Tab(0).Control(46)=   "txtDato(32)"
      Tab(0).Control(46).Enabled=   0   'False
      Tab(0).Control(47)=   "cmdDatoAyud(33)"
      Tab(0).Control(47).Enabled=   0   'False
      Tab(0).Control(48)=   "txtDato(33)"
      Tab(0).Control(48).Enabled=   0   'False
      Tab(0).Control(49)=   "cmdDatoAyud(34)"
      Tab(0).Control(49).Enabled=   0   'False
      Tab(0).Control(50)=   "txtDato(34)"
      Tab(0).Control(50).Enabled=   0   'False
      Tab(0).Control(51)=   "cmdDatoAyud(38)"
      Tab(0).Control(51).Enabled=   0   'False
      Tab(0).Control(52)=   "txtDato(38)"
      Tab(0).Control(52).Enabled=   0   'False
      Tab(0).Control(53)=   "cmdDatoAyud(39)"
      Tab(0).Control(53).Enabled=   0   'False
      Tab(0).Control(54)=   "txtDato(39)"
      Tab(0).Control(54).Enabled=   0   'False
      Tab(0).Control(55)=   "cmdDatoAyud(40)"
      Tab(0).Control(55).Enabled=   0   'False
      Tab(0).Control(56)=   "txtDato(40)"
      Tab(0).Control(56).Enabled=   0   'False
      Tab(0).Control(57)=   "cmdDatoAyud(41)"
      Tab(0).Control(57).Enabled=   0   'False
      Tab(0).Control(58)=   "txtDato(41)"
      Tab(0).Control(58).Enabled=   0   'False
      Tab(0).Control(59)=   "cmdDatoAyud(42)"
      Tab(0).Control(59).Enabled=   0   'False
      Tab(0).Control(60)=   "txtDato(42)"
      Tab(0).Control(60).Enabled=   0   'False
      Tab(0).Control(61)=   "cmdDatoAyud(43)"
      Tab(0).Control(61).Enabled=   0   'False
      Tab(0).Control(62)=   "txtDato(43)"
      Tab(0).Control(62).Enabled=   0   'False
      Tab(0).Control(63)=   "cmdMas(1)"
      Tab(0).Control(63).Enabled=   0   'False
      Tab(0).Control(64)=   "cmdMas(2)"
      Tab(0).Control(64).Enabled=   0   'False
      Tab(0).Control(65)=   "cmdMas(3)"
      Tab(0).Control(65).Enabled=   0   'False
      Tab(0).Control(66)=   "cmdMas(4)"
      Tab(0).Control(66).Enabled=   0   'False
      Tab(0).Control(67)=   "cmdMas(5)"
      Tab(0).Control(67).Enabled=   0   'False
      Tab(0).Control(68)=   "cmdMas(6)"
      Tab(0).Control(68).Enabled=   0   'False
      Tab(0).Control(69)=   "cmdMas(7)"
      Tab(0).Control(69).Enabled=   0   'False
      Tab(0).Control(70)=   "cmdMas(8)"
      Tab(0).Control(70).Enabled=   0   'False
      Tab(0).Control(71)=   "chkMonedaActiva"
      Tab(0).Control(71).Enabled=   0   'False
      Tab(0).Control(72)=   "cmdDatoAyud(45)"
      Tab(0).Control(72).Enabled=   0   'False
      Tab(0).Control(73)=   "cmdDatoAyud(44)"
      Tab(0).Control(73).Enabled=   0   'False
      Tab(0).Control(74)=   "txtDato(44)"
      Tab(0).Control(74).Enabled=   0   'False
      Tab(0).Control(75)=   "txtDato(45)"
      Tab(0).Control(75).Enabled=   0   'False
      Tab(0).Control(76)=   "txtDato(16)"
      Tab(0).Control(76).Enabled=   0   'False
      Tab(0).Control(77)=   "txtDato(17)"
      Tab(0).Control(77).Enabled=   0   'False
      Tab(0).Control(78)=   "txtDato(18)"
      Tab(0).Control(78).Enabled=   0   'False
      Tab(0).Control(79)=   "txtDato(19)"
      Tab(0).Control(79).Enabled=   0   'False
      Tab(0).Control(80)=   "txtDato(20)"
      Tab(0).Control(80).Enabled=   0   'False
      Tab(0).Control(81)=   "txtDato(21)"
      Tab(0).Control(81).Enabled=   0   'False
      Tab(0).Control(82)=   "txtDato(22)"
      Tab(0).Control(82).Enabled=   0   'False
      Tab(0).Control(83)=   "txtDato(23)"
      Tab(0).Control(83).Enabled=   0   'False
      Tab(0).Control(84)=   "txtDato(5)"
      Tab(0).Control(84).Enabled=   0   'False
      Tab(0).Control(85)=   "txtDato(6)"
      Tab(0).Control(85).Enabled=   0   'False
      Tab(0).Control(86)=   "txtDato(7)"
      Tab(0).Control(86).Enabled=   0   'False
      Tab(0).Control(87)=   "txtDato(8)"
      Tab(0).Control(87).Enabled=   0   'False
      Tab(0).Control(88)=   "txtDato(9)"
      Tab(0).Control(88).Enabled=   0   'False
      Tab(0).Control(89)=   "txtDato(10)"
      Tab(0).Control(89).Enabled=   0   'False
      Tab(0).Control(90)=   "txtDato(11)"
      Tab(0).Control(90).Enabled=   0   'False
      Tab(0).Control(91)=   "txtDato(12)"
      Tab(0).Control(91).Enabled=   0   'False
      Tab(0).Control(92)=   "txtDato(53)"
      Tab(0).Control(92).Enabled=   0   'False
      Tab(0).Control(93)=   "txtDato(54)"
      Tab(0).Control(93).Enabled=   0   'False
      Tab(0).Control(94)=   "txtDato(55)"
      Tab(0).Control(94).Enabled=   0   'False
      Tab(0).Control(95)=   "txtDato(56)"
      Tab(0).Control(95).Enabled=   0   'False
      Tab(0).Control(96)=   "cmdMasIGV"
      Tab(0).Control(96).Enabled=   0   'False
      Tab(0).Control(97)=   "txtDato(26)"
      Tab(0).Control(97).Enabled=   0   'False
      Tab(0).Control(98)=   "txtDato(25)"
      Tab(0).Control(98).Enabled=   0   'False
      Tab(0).Control(99)=   "txtDato(24)"
      Tab(0).Control(99).Enabled=   0   'False
      Tab(0).Control(100)=   "txtDato(48)"
      Tab(0).Control(100).Enabled=   0   'False
      Tab(0).Control(101)=   "txtDato(47)"
      Tab(0).Control(101).Enabled=   0   'False
      Tab(0).Control(102)=   "cmdDatoAyud(47)"
      Tab(0).Control(102).Enabled=   0   'False
      Tab(0).Control(103)=   "cmdDatoAyud(48)"
      Tab(0).Control(103).Enabled=   0   'False
      Tab(0).Control(104)=   "cmdMas(11)"
      Tab(0).Control(104).Enabled=   0   'False
      Tab(0).Control(105)=   "cmdMas(10)"
      Tab(0).Control(105).Enabled=   0   'False
      Tab(0).Control(106)=   "cmdMas(9)"
      Tab(0).Control(106).Enabled=   0   'False
      Tab(0).Control(107)=   "txtDato(46)"
      Tab(0).Control(107).Enabled=   0   'False
      Tab(0).Control(108)=   "cmdDatoAyud(46)"
      Tab(0).Control(108).Enabled=   0   'False
      Tab(0).Control(109)=   "txtDato(37)"
      Tab(0).Control(109).Enabled=   0   'False
      Tab(0).Control(110)=   "cmdDatoAyud(37)"
      Tab(0).Control(110).Enabled=   0   'False
      Tab(0).Control(111)=   "txtDato(36)"
      Tab(0).Control(111).Enabled=   0   'False
      Tab(0).Control(112)=   "cmdDatoAyud(36)"
      Tab(0).Control(112).Enabled=   0   'False
      Tab(0).Control(113)=   "txtDato(35)"
      Tab(0).Control(113).Enabled=   0   'False
      Tab(0).Control(114)=   "cmdDatoAyud(35)"
      Tab(0).Control(114).Enabled=   0   'False
      Tab(0).Control(115)=   "txtDato(13)"
      Tab(0).Control(115).Enabled=   0   'False
      Tab(0).Control(116)=   "txtDato(14)"
      Tab(0).Control(116).Enabled=   0   'False
      Tab(0).Control(117)=   "txtDato(15)"
      Tab(0).Control(117).Enabled=   0   'False
      Tab(0).Control(118)=   "txtDato(57)"
      Tab(0).Control(118).Enabled=   0   'False
      Tab(0).Control(119)=   "txtDato(58)"
      ...
      Tab(2).Control(0)=   "chkIndreten"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).Control(1)=   "fraExterior"
      Tab(2).Control(2)=   "fraDetracion"
      Tab(2).Control(3)=   "fraReferencia"
      Tab(2).ControlCount=   4
      TabCaption(3)   =   "Sunat"
      TabPicture(3)   =   "frmTCpr.frx":1248
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "lblTexto(38)"
      Tab(3).Control(0).Enabled=   0   'False
      Tab(3).Control(1)=   "lblTexto(39)"
      Tab(3).Control(1).Enabled=   0   'False
      Tab(3).Control(2)=   "lblTexto(40)"
      Tab(3).Control(2).Enabled=   0   'False
      Tab(3).Control(3)=   "lblTexto(41)"
      Tab(3).Control(3).Enabled=   0   'False
      Tab(3).Control(4)=   "lblTexto(42)"
      Tab(3).Control(4).Enabled=   0   'False
      Tab(3).Control(5)=   "lblTexto(43)"
      Tab(3).Control(5).Enabled=   0   'False
      Tab(3).Control(6)=   "lblTexto(44)"
      Tab(3).Control(6).Enabled=   0   'False
      Tab(3).Control(7)=   "lblDatoDeta(62)"
      Tab(3).Control(7).Enabled=   0   'False
      Tab(3).Control(8)=   "lblDatoDeta(63)"
      Tab(3).Control(8).Enabled=   0   'False
      Tab(3).Control(9)=   "lblDatoDeta(64)"
      Tab(3).Control(9).Enabled=   0   'False
      Tab(3).Control(10)=   "lblDatoDeta(65)"
      Tab(3).Control(10).Enabled=   0   'False
      Tab(3).Control(11)=   "lblDatoDeta(66)"
      Tab(3).Control(11).Enabled=   0   'False
      Tab(3).Control(12)=   "lblDatoDeta(67)"
      Tab(3).Control(12).Enabled=   0   'False
      Tab(3).Control(13)=   "lblTexto(45)"
      Tab(3).Control(13).Enabled=   0   'False
      Tab(3).Control(14)=   "lblDatoDeta(61)"
      Tab(3).Control(14).Enabled=   0   'False
      Tab(3).Control(15)=   "lblTexto(46)"
      Tab(3).Control(15).Enabled=   0   'False
      Tab(3).Control(16)=   "txtDato2(0)"
      Tab(3).Control(16).Enabled=   0   'False
      Tab(3).Control(17)=   "cmdDatoAyud(62)"
      Tab(3).Control(17).Enabled=   0   'False
      Tab(3).Control(18)=   "txtDato(62)"
      Tab(3).Control(18).Enabled=   0   'False
      Tab(3).Control(19)=   "cmdDatoAyud(63)"
      Tab(3).Control(19).Enabled=   0   'False
      Tab(3).Control(20)=   "txtDato(63)"
      Tab(3).Control(20).Enabled=   0   'False
      Tab(3).Control(21)=   "cmdDatoAyud(64)"
      Tab(3).Control(21).Enabled=   0   'False
      Tab(3).Control(22)=   "txtDato(64)"
      Tab(3).Control(22).Enabled=   0   'False
      Tab(3).Control(23)=   "cmdDatoAyud(65)"
      Tab(3).Control(23).Enabled=   0   'False
      Tab(3).Control(24)=   "txtDato(65)"
      Tab(3).Control(24).Enabled=   0   'False
      Tab(3).Control(25)=   "cmdDatoAyud(66)"
      Tab(3).Control(25).Enabled=   0   'False
      Tab(3).Control(26)=   "txtDato(66)"
      Tab(3).Control(26).Enabled=   0   'False
      Tab(3).Control(27)=   "cmdDatoAyud(67)"
      Tab(3).Control(27).Enabled=   0   'False
      Tab(3).Control(28)=   "txtDato(67)"
      Tab(3).Control(28).Enabled=   0   'False
      Tab(3).Control(29)=   "cmdDatoAyud(61)"
      Tab(3).Control(29).Enabled=   0   'False
      Tab(3).Control(30)=   "txtDato(61)"
      Tab(3).Control(30).Enabled=   0   'False
      Tab(3).Control(31)=   "txtDato2(1)"
      ...
      Begin VB.Label lblTexto 
         AutoSize        =   -1  'True
         Caption         =   "Pais Beneficiario Pago :"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
...
''fin 2015-07-02 adic tabla detrac
      txtDato(68).MaxLength = .uorstMain!tsadetrac.DefinedSize
'fin 2016-03-30 elimina cboDetraccion


'ini 2016-02-02.03 correccion ple
'    pComboIns cboTpoBns, frmTCprGrd.uorstTpoBns
'    pComboIns cboCodMon, frmTCprGrd.uorstCodMon
'    pComboIns cboPaisNoDomi, frmTCprGrd.uorstPais
'    pComboIns cboPaisBenefi, frmTCprGrd.uorstPais
'    pComboIns cboCnveDobImpo, frmTCprGrd.uorstCnveDobImpo
'    pComboIns cboTpoRta, frmTCprGrd.uorstTpoRta
    
    txtDato2(0).MaxLength = .uorstMain!TasaReten.DefinedSize
'fin 2016-02-02.03 correccion ple

'ini 2016-05-23/24 correccion ple compra
    txtDato2(1).MaxLength = .uorstMain!ImpTCb_inv.DefinedSize
'fin '2016-05-23/24 correccion ple compra


'ini 2016-02-02.08  correccion ple
'    gpcbo_sunat_ins cboTpoBns, frmTCprGrd.uorstTpoBns
'    gpcbo_sunat_ins cboCodMon, frmTCprGrd.uorstCodMon
'    gpcbo_sunat_ins cboPaisNoDomi, frmTCprGrd.uorstPais
'    gpcbo_sunat_ins cboPaisBenefi, frmTCprGrd.uorstPais
'    gpcbo_sunat_ins cboCnveDobImpo, frmTCprGrd.uorstCnveDobImpo
'    gpcbo_sunat_ins cboTpoRta, frmTCprGrd.uorstTpoRta
'fin 2016-02-02.08  correccion ple

      txtDato(61).MaxLength = .uorstMain!nrodociden.DefinedSize

      txtDato(62).MaxLength = .uorstMain!tpobns.DefinedSize
      txtDato(63).MaxLength = .uorstMain!codmon.DefinedSize
      txtDato(64).MaxLength = .uorstMain!PaisNoDomi.DefinedSize
      txtDato(65).MaxLength = .uorstMain!PaisBenefi.DefinedSize
      txtDato(66).MaxLength = .uorstMain!CnveDobImpo.DefinedSize
      txtDato(67).MaxLength = .uorstMain!TpoRta.DefinedSize
...
End Sub
'ini 2016-02-02.03 correccion ple
Private Sub pComboIns(xcombo As ComboBox, xrst As Recordset)
      xcombo.AddItem Choose(gsIdioma, "Ninguna", "Neither"), 0
        ...
        End With
End Sub
Private Sub pComboUpdate(xcombo As ComboBox, xrst As Recordset, xCampo, xCampoLen As Integer)
         With xrst
            '2016-03-02 tpo recordset no funcion RecordCount If .RecordCount > 0 Then .MoveFirst
            If Not (.EOF And .BOF) Then .MoveFirst
            '.Find "CodSunat='" & Left(xcombo.Text, 5) & "'"
            '.Find "LEFT(CodSunat," & xCampoLen & ")='" & Left(xcombo.Text, xCampoLen) & "'"
            .Find "CodSunat='" & Left(xcombo.Text, xCampoLen) & "'"
            If .EOF Then
               frmTCprGrd.uorstMain.Fields(xCampo) = Null
            Else
               'xrst!tsadetrac = IIf(xcombo.ListIndex = 0, Null, !CodSunat)
               frmTCprGrd.uorstMain.Fields(xCampo) = IIf(xcombo.ListIndex = 0, Null, !CodSunat)
           End If
         End With
End Sub
'Private Sub pComboIndex(xcombo As ComboBox, xrst As Recordset, xCampo As String, xCampoLen As Integer)
Private Sub pComboIndex(xcombo As ComboBox, xCampo As String, xCampoLen As Integer)
  'Dim dnContador As Byte
  Dim dnContador As Integer
    xcombo.ListIndex = 0
    With frmTCprGrd.uorstMain
     If Not IsNull(.Fields(xCampo).Value) Then
        'For dnContador = 1 To xcombo.ListCount - 1
...
'ini 2016-02-02.03 correccion ple
'    If cboCodMon.ListIndex = 0 Then MsgBox TEXT_6002, vbCritical: sstMain.Tab = 3: sstMain.SetFocus: cboCodMon.SetFocus: Exit Sub
'    If cboPaisNoDomi.ListIndex = 0 Then MsgBox TEXT_6002, vbCritical: sstMain.Tab = 3: sstMain.SetFocus: cboPaisNoDomi.SetFocus: Exit Sub
'    If cboCnveDobImpo.ListIndex = 0 Then MsgBox TEXT_6002, vbCritical: sstMain.Tab = 3: sstMain.SetFocus: cboCnveDobImpo.SetFocus: Exit Sub
'    If cboTpoRta.ListIndex = 0 Then MsgBox TEXT_6002, vbCritical: sstMain.Tab = 3: sstMain.SetFocus: cboTpoRta.SetFocus: Exit Sub
'fin 2016-02-02.03 correccion ple
  'If txtDato(61).Text = "" Then MsgBox TEXT_6002, vbCritical: txtDato(61).SetFocus: Exit Sub '2016-02-02.08  correccion ple
  
  'If txtDato(63).Text = "" Then MsgBox TEXT_6002, vbCritical: sstMain.Tab = 3: sstMain.SetFocus: txtDato(63).SetFocus: Exit Sub '2016-02-02.08  correccion ple
  'If txtDato(64).Text = "" Then MsgBox TEXT_6002, vbCritical: sstMain.Tab = 3: sstMain.SetFocus: txtDato(64).SetFocus: Exit Sub '2016-02-02.08  correccion ple
  'If txtDato(66).Text = "" Then MsgBox TEXT_6002, vbCritical: sstMain.Tab = 3: sstMain.SetFocus: txtDato(66).SetFocus: Exit Sub '2016-02-02.08  correccion ple
  'If txtDato(67).Text = "" Then MsgBox TEXT_6002, vbCritical: sstMain.Tab = 3: sstMain.SetFocus: txtDato(67).SetFocus: Exit Sub '2016-02-02.08  correccion ple
...
'ini 2016-03-30 elimina cboDetraccion
    'If cboDetraccion.ListIndex = 0 Then MsgBox TEXT_6002, vbCritical: sstMain.Tab = 2: sstMain.SetFocus: cboDetraccion.SetFocus: Exit Sub
    If txtDato(68).Text = "" Then MsgBox TEXT_6002, vbCritical: sstMain.Tab = 2: sstMain.SetFocus: txtDato(68).SetFocus: Exit Sub
'fin 2016-03-30 elimina cboDetraccion
...
'    If txtDetalle(6).Text = "" Then MsgBox TEXT_6002, vbCritical: txtDetalle(6).SetFocus: Exit Sub
  ...
  If ((txtLlave(1).Text = "07" Or txtLlave(1).Text = "08" Or txtLlave(1).Text = "97" Or txtLlave(1).Text = "98") And txtDato(59).Text = "") Then MsgBox Choose(gsIdioma, "Seleccione Tipo de Documento de Referencia", "Select Document Type Reference"), vbCritical: txtDato(59).SetFocus: Exit Sub
  If ((txtLlave(1).Text = "07" Or txtLlave(1).Text = "08" Or txtLlave(1).Text = "97" Or txtLlave(1).Text = "98") And txtDetalle(3).Text = "") Then MsgBox Choose(gsIdioma, "Debe ingresar Serie de Documento de Referencia", "You Must enter the Document Series Reference"), vbCritical: txtDetalle(3).SetFocus: Exit Sub
  If ((txtLlave(1).Text = "07" Or txtLlave(1).Text = "08" Or txtLlave(1).Text = "97" Or txtLlave(1).Text = "98") And txtDetalle(4).Text = "") Then MsgBox Choose(gsIdioma, "Debe ingresar Documento de Referencia", "You Must enter the Document Reference"), vbCritical: txtDetalle(4).SetFocus: Exit Sub
  
  ' validación de tipo de bien
  If txtDato(62).Text = "" Then MsgBox Choose(gsIdioma, "Debe ingresar Tipo de Bien o Servicio", "You Must enter the Type of Right or Service"), vbCritical: txtDato(62).SetFocus: Exit Sub
...
'ini 2016-02-02.08  correccion ple
    ...
    Case 62, 63, 64, 65, 66, 67
     sstMain.Tab = 3: sstMain.SetFocus: txtDato(Index).SetFocus
'fin 2016-02-02.08  correccion ple
    Case 68
        txtDato(Index).SetFocus
    Case Else
...
'ini 2016-02-02.03 correccion ple
Private Sub txtDato2_GotFocus(Index As Integer)
  txtDato2(Index).SelStart = 0
  txtDato2(Index).SelLength = txtDato2(Index).MaxLength
End Sub

Private Sub txtDato2_KeyPress(Index As Integer, KeyAscii As Integer)
  '[ARREGLAR: Retrocede si Shift está presionado.
  If Len(Trim(txtDato2(Index))) + 1 = txtDato2(Index).MaxLength Then
    SendKeys "{TAB}"
  End If
  ']ARREGLAR.
End Sub
...
Private Sub txtDato2_LostFocus(Index As Integer)
  Select Case Index
  Case 0
  End Select
End Sub

Private Sub txtDato2_Validate(Index As Integer, Cancel As Boolean)
  'Asigna 0 a campos numéricos si están vacíos.
  Select Case Index
  '2016-05-23/24 correccion ple compra  Case 0
  Case 0, 1
    If Not IsNumeric(txtDato2(Index).Text) Then
     txtDato2(Index).Text = 0
    End If
  End Select
  'Da formato.
  Select Case Index
  Case 0
      txtDato2(Index).Text = Format(txtDato2(Index).Text, FORMATO_NUM_4)
'ini 2016-05-23/24 correccion ple compra
  Case 1
      txtDato2(Index).Text = Format(txtDato2(Index).Text, FORMATO_NUM_2)
'fin '2016-05-23/24 correccion ple compra
  End Select
...
'ini 2016-05-23/24 correccion ple compra
   If txtLlave(1) <> "46" And txtLlave(1) <> "50" And txtLlave(1) <> "52" Then
    dtpDetalle(1).Visible = False
    lblTexto(47).Visible = False
   Else
    dtpDetalle(1).Visible = True
    lblTexto(47).Visible = True
   End If
'fin '2016-05-23/24 correccion ple compra
  ...
  Else
    Select Case tnIndex
     ...
     Case 60                             ' orden de servicio
      ...
      lblDatoDeta(tnIndex).Caption = " " & frmOAyuBus.uvDato2
'ini 2016-02-02.08  correccion ple
     Case 61 ' Numero de documento de identidad
      ...
      txtDato(tnIndex).Text = frmOAyuBus.uvDato1
      lblDatoDeta(tnIndex).Caption = " " & frmOAyuBus.uvDato2
     Case 62, 63, 64, 65, 66, 67  'Cambiar (añadir índices).
      Dim xxCodTabla As String
      xxCodTabla = IIf(tnIndex = 62, CODSUNAT_030, "")
      xxCodTabla = IIf(tnIndex = 63, CODSUNAT_004, xxCodTabla)
      xxCodTabla = IIf(tnIndex = 64, CODSUNAT_035, xxCodTabla)
      xxCodTabla = IIf(tnIndex = 65, CODSUNAT_035, xxCodTabla)
      xxCodTabla = IIf(tnIndex = 66, CODSUNAT_025, xxCodTabla)
      xxCodTabla = IIf(tnIndex = 67, CODSUNAT_031, xxCodTabla)
      ...
      lblDatoDeta(tnIndex).Caption = " " & frmOAyuBus.uvDato2
'fin 2016-02-02.08  correccion ple
        If txtDato(63).Text = "USD" Then
            txtDato2(1).Text = txtDato(4).Text
        End If
'ini 2016-03-30 elimina cboDetraccion
     Case 68 'detraccion
      modAyuBus.Detrac_Cod "", txtDato(tnIndex).Text, 0, 0, Me.Top + txtDato(tnIndex).Top + txtDato(tnIndex).Height, Me.Left + txtDato(tnIndex).Left
      txtDato(tnIndex).Text = frmOAyuBus.uvDato1
      lblDatoDeta(tnIndex).Caption = " " & frmOAyuBus.uvDato2
'fin 2016-03-30 elimina cboDetraccion
    End Select
...
'ini 2016-02-02.08  correccion ple
       ...
       Case 62, 63, 64, 65, 66, 67
        ...
        Set zxrst = IIf(tnIndex = 62, frmTCprGrd.uorstTpoBns, New ADODB.Recordset)
        Set zxrst = IIf(tnIndex = 63, frmTCprGrd.uorstCodMon, zxrst)
        Set zxrst = IIf(tnIndex = 64, frmTCprGrd.uorstPais, zxrst)
        Set zxrst = IIf(tnIndex = 65, frmTCprGrd.uorstPais, zxrst)
        Set zxrst = IIf(tnIndex = 66, frmTCprGrd.uorstCnveDobImpo, zxrst)
        Set zxrst = IIf(tnIndex = 67, frmTCprGrd.uorstTpoRta, zxrst)
...
'ini 2016-03-30 elimina cboDetraccion
       Case 68
         ...
         With frmTCprGrd.uorstcodetrac
            If .RecordCount > 0 Then .MoveFirst
            .Find "coddetrac='" & txtDato(tnIndex).Text & "'"
            If .EOF Then
               MsgBox TEXT_8006, vbExclamation
               ppAyuDet = True
            Else
               lblDatoDeta(tnIndex).Caption = " " & !detdetrac
            End If
         End With
'fin 2016-03-30 elimina cboDetraccion
      End Select
...
'         End With
''fin 2015-07-02 adic tabla detrac
      !tsadetrac = IIf(txtDato(68).Text = "", Null, txtDato(68).Text)
'fin 2016-03-30 elimina cboDetraccion

        'ini 2016-02-02.03 correccion ple
'        pComboUpdate cboTpoBns, frmTCprGrd.uorstTpoBns, "TpoBns", 1
'        pComboUpdate cboCodMon, frmTCprGrd.uorstCodMon, "CodMon", 3
'        pComboUpdate cboPaisNoDomi, frmTCprGrd.uorstPais, "PaisNoDomi", 4
'        pComboUpdate cboPaisBenefi, frmTCprGrd.uorstPais, "PaisBenefi", 4
'        pComboUpdate cboCnveDobImpo, frmTCprGrd.uorstCnveDobImpo, "CnveDobImpo", 2
'        pComboUpdate cboTpoRta, frmTCprGrd.uorstTpoRta, "TpoRta", 2
        !TasaReten = CDec(txtDato2(0).Text)
        'fin 2016-02-02.03 correccion ple
        
'ini 2016-05-23/24 correccion ple compra
        !ImpTCb_inv = CDec(txtDato2(1).Text)
'fin '2016-05-23/24 correccion ple compra
        
'ini 2016-02-02.08  correccion ple
'        gpcbo_sunat_update cboTpoBns, frmTCprGrd.uorstTpoBns, "TpoBns", 1, frmTCprGrd.uorstMain
'        gpcbo_sunat_update cboCodMon, frmTCprGrd.uorstCodMon, "CodMon", 3, frmTCprGrd.uorstMain
'        gpcbo_sunat_update cboPaisNoDomi, frmTCprGrd.uorstPais, "PaisNoDomi", 4, frmTCprGrd.uorstMain
'        gpcbo_sunat_update cboPaisBenefi, frmTCprGrd.uorstPais, "PaisBenefi", 4, frmTCprGrd.uorstMain
'        gpcbo_sunat_update cboCnveDobImpo, frmTCprGrd.uorstCnveDobImpo, "CnveDobImpo", 2, frmTCprGrd.uorstMain
'        gpcbo_sunat_update cboTpoRta, frmTCprGrd.uorstTpoRta, "TpoRta", 2, frmTCprGrd.uorstMain
'fin 2016-02-02.08  correccion ple
      !nrodociden = IIf(txtDato(61).Text = "", Null, txtDato(61).Text) '2016-02-02.08  correccion ple

      !tpobns = IIf(txtDato(62).Text = "", Null, txtDato(62).Text) '2016-02-02.08  correccion ple
      !codmon = IIf(txtDato(63).Text = "", Null, txtDato(63).Text) '2016-02-02.08  correccion ple
      !PaisNoDomi = IIf(txtDato(64).Text = "", Null, txtDato(64).Text) '2016-02-02.08  correccion ple
      !PaisBenefi = IIf(txtDato(65).Text = "", Null, txtDato(65).Text) '2016-02-02.08  correccion ple
      !CnveDobImpo = IIf(txtDato(66).Text = "", Null, txtDato(66).Text) '2016-02-02.08  correccion ple
      !TpoRta = IIf(txtDato(67).Text = "", Null, txtDato(67).Text) '2016-02-02.08  correccion ple
...
'ini 2016-05-23/24 correccion ple compra
      dtpDetalle(1).Value = IIf(IsNull(!feedoc_inv), Date, !feedoc_inv)
        If txtLlave(1) <> "46" And txtLlave(1) <> "50" And txtLlave(1) <> "52" Then
         dtpDetalle(1).Visible = False
         lblTexto(47).Visible = False
        Else
...
'      If Not IsNull(!feedoc_inv) Then
'      dtpDetalle(1).Value = !feedoc_inv
'      End If
'fin '2016-05-23/24 correccion ple compra
...
''        '2016-02-04 error contador debe comenzar en cero For dnContador = 1 To cboDetraccion.ListCount - 1
''        For dnContador = 0 To cboDetraccion.ListCount - 1
...
''        Next dnContador
''      End If
      txtDato(68).Text = IIf(IsNull(!tsadetrac), "", !tsadetrac)
     ppAyuDet AYUDAT, 68

'fin 2016-03-30 elimina cboDetraccion
'-----------
    'ini 2016-02-02.03 correccion ple
'    pComboIndex cboTpoBns, "TpoBns", 1
'    pComboIndex cboCodMon, "CodMon", 3
'    pComboIndex cboPaisNoDomi, "PaisNoDomi", 4
'    pComboIndex cboPaisBenefi, "PaisBenefi", 4
'    pComboIndex cboCnveDobImpo, "CnveDobImpo", 2
'    pComboIndex cboTpoRta, "TpoRta", 2
    txtDato2(0).Text = Format(!TasaReten, FORMATO_NUM_4)
    'fin 2016-02-02.03 correccion ple
'ini 2016-05-23/24 correccion ple compra
    txtDato2(1).Text = Format(!ImpTCb_inv, FORMATO_NUM_2)
'fin '2016-05-23/24 correccion ple compra

'-----------
'ini 2016-02-02.08  correccion ple
'    gpcbo_sunat_index cboTpoBns, "TpoBns", 1, frmTCprGrd.uorstMain
'    gpcbo_sunat_index cboCodMon, "CodMon", 3, frmTCprGrd.uorstMain
'    gpcbo_sunat_index cboPaisNoDomi, "PaisNoDomi", 4, frmTCprGrd.uorstMain
'    gpcbo_sunat_index cboPaisBenefi, "PaisBenefi", 4, frmTCprGrd.uorstMain
'    gpcbo_sunat_index cboCnveDobImpo, "CnveDobImpo", 2, frmTCprGrd.uorstMain
'    gpcbo_sunat_index cboTpoRta, "TpoRta", 2, frmTCprGrd.uorstMain
'fin 2016-02-02.08  correccion ple
'ini 2016-02-02.08  correccion ple
      txtDato(61).Text = IIf(IsNull(!nrodociden), "", !nrodociden) ' 2016-02-02.08  correccion ple
      
      txtDato(62).Text = IIf(IsNull(!tpobns), "", !tpobns) ' 2016-02-02.08  correccion ple
      txtDato(63).Text = IIf(IsNull(!codmon), "", !codmon) ' 2016-02-02.08  correccion ple
      txtDato(64).Text = IIf(IsNull(!PaisNoDomi), "", !PaisNoDomi) ' 2016-02-02.08  correccion ple
      txtDato(65).Text = IIf(IsNull(!PaisBenefi), "", !PaisBenefi) ' 2016-02-02.08  correccion ple
      txtDato(66).Text = IIf(IsNull(!CnveDobImpo), "", !CnveDobImpo) ' 2016-02-02.08  correccion ple
      txtDato(67).Text = IIf(IsNull(!TpoRta), "", !TpoRta) ' 2016-02-02.08  correccion ple
...
'ini 2016-03-30 elimina cboDetraccion
   'cboDetraccion.ListIndex = 0
   txtDato(68).Text = "" 'fin 2016-02-02.03 correccion ple
'fin 2016-03-30 elimina cboDetraccion

    'ini 2016-02-02.03 correccion ple
'    cboTpoBns.ListIndex = 0
'    cboCodMon.ListIndex = 0
'    cboPaisNoDomi.ListIndex = 0
'    cboPaisBenefi.ListIndex = 0
'    cboCnveDobImpo.ListIndex = 0
'    cboTpoRta.ListIndex = 0
    txtDato2(0).Text = Format(0, FORMATO_NUM_4)
'ini 2016-05-23/24 correccion ple compra
    txtDato2(1).Text = Format(0, FORMATO_NUM_2)
'fin '2016-05-23/24 correccion ple compra
    
    'fin 2016-02-02.03 correccion ple
   txtDato(61).Text = "" 'fin 2016-02-02.03 correccion ple
   
  txtDato(62).Text = "1" 'fin 2016-02-02.03 correccion ple
  txtDato(63).Text = IIf(cboTpoMon.ListIndex = TPOMON_NAC_IND, CODMON_NAC, CODMON_EXT) '2016-02-02.06  correccion ple
   
   txtDato(64).Text = "" 'fin 2016-02-02.03 correccion ple
   txtDato(65).Text = "" 'fin 2016-02-02.03 correccion ple
   txtDato(66).Text = "" 'fin 2016-02-02.03 correccion ple
   txtDato(67).Text = "" 'fin 2016-02-02.03 correccion ple
  
   
  lblDatoDeta(61).Caption = ""  'fin 2016-02-02.03 correccion ple
  lblDatoDeta(62).Caption = ""  'fin 2016-02-02.03 correccion ple
  lblDatoDeta(63).Caption = ""  'fin 2016-02-02.03 correccion ple
  ppAyuDet AYUDAT, 62
  ppAyuDet AYUDAT, 63
  
  lblDatoDeta(64).Caption = ""  'fin 2016-02-02.03 correccion ple
  lblDatoDeta(65).Caption = ""  'fin 2016-02-02.03 correccion ple
  lblDatoDeta(66).Caption = ""  'fin 2016-02-02.03 correccion ple
  lblDatoDeta(67).Caption = ""  'fin 2016-02-02.03 correccion ple
...
'ini 2016-03-30 elimina cboDetraccion
   'cboDetraccion.Enabled = tbHabilitar
    txtDato(68).Enabled = tbHabilitar
   cmdDatoAyud(68).Enabled = tbHabilitar
   lblDatoDeta(68).Enabled = tbHabilitar
'fin 2016-03-30 elimina cboDetraccion
   
'ini 2016-02-02.03 correccion ple
'   cboTpoBns.Enabled = tbHabilitar
'   cboCodMon.Enabled = tbHabilitar
'   cboPaisNoDomi.Enabled = tbHabilitar
'   cboPaisBenefi.Enabled = tbHabilitar
'   cboCnveDobImpo.Enabled = tbHabilitar
'   cboTpoRta.Enabled = tbHabilitar
   txtDato2(0).Enabled = tbHabilitar
'fin 2016-02-02.03 correccion ple
'ini 2016-05-23/24 correccion ple compra
   txtDato2(1).Enabled = tbHabilitar
'fin '2016-05-23/24 correccion ple compra

    txtDato(61).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
    
    txtDato(62).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
    txtDato(63).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
    txtDato(64).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
    txtDato(65).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
    txtDato(66).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
    txtDato(67).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
    
   cmdDatoAyud(61).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
   
   cmdDatoAyud(62).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
   cmdDatoAyud(63).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
   cmdDatoAyud(64).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
   cmdDatoAyud(65).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
   cmdDatoAyud(66).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
   cmdDatoAyud(67).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
  
   lblDatoDeta(61).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
   
   lblDatoDeta(62).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
   lblDatoDeta(63).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
   lblDatoDeta(64).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
   lblDatoDeta(65).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
   lblDatoDeta(66).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
   lblDatoDeta(67).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
...
'2016-08-11 valida cta y ccosto detallePrivate Sub ppAbreCtaCCo()
Private Sub ppAbreCtaCCo(Optional ByVal pOrder As Integer)
  With frmTCprGrd.uorstCOCprDocCCo
  ...
  With frmTCprGrd.uorstCOCprDocCta
    ...
    If .State = adStateOpen Then .Close
'ini 2016-08-11 valida cta y ccosto detalle
'    .Source = frmTCprGrd.usConnStrgSele_COCprDocCta & frmTCprGrd.usConnStrgWher_COCprDocCta & frmTCprGrd.usConnStrgOrde_COCprDocCta
        If pOrder = 0 Then
            .Source = frmTCprGrd.usConnStrgSele_COCprDocCta & frmTCprGrd.usConnStrgWher_COCprDocCta & frmTCprGrd.usConnStrgOrde_COCprDocCta
        Else
            .Source = frmTCprGrd.usConnStrgSele_COCprDocCta & frmTCprGrd.usConnStrgWher_COCprDocCta & " ORDER BY TpoCnc,CodCta, Orden"
        End If
'fin 2016-08-11 valida cta y ccosto detalle
    .Open
...
'ini 2016-05-23/24 correccion ple compra
    'en genera no por que no pasa nada al diario !feedoc_inv = dtpDetalle(1).Value
'fin '2016-05-23/24 correccion ple compra
    ...
    !tpognr = TPOGNR_CPR
'ini 2016-02-02.08  correccion ple
    'gpcbo_sunat_update cboCodMon, frmTCprGrd.uorstCodMon, "CodMon", 3, frmTCprGrd.uorstCOCpbDet '2016-02-02.08  correccion ple
    !codmon = IIf(txtDato(63).Text = "", Null, txtDato(63).Text)
'fin 2016-02-02.08  correccion ple
...
Private Function ValidaCtasCCo() As Boolean
  ...
  For dnContador = INDMASCTA_INI To CANTIDADIMPORTES - 1
    If ((CDec(txtDato(MINIMOINDICEIMPORTEMN + dnContador).Text) <> 0) Or (CDec(txtDato(MINIMOINDICEIMPORTEME + dnContador).Text) <> 0)) And _
      ...
      '2016-08-12 error valida compra If frmTCprGrd.ubGrabaMas = 1 Then
       If cmdMas(dnContador + 1).Tag = 1 Then
        With frmTCprGrd.uorstCOCprDocCta
