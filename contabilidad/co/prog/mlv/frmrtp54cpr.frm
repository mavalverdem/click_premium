...
Begin VB.Form frmRTp54Cpr 
   ...
   Begin VB.ComboBox cboTpoMon 
      Height          =   315
      ItemData        =   "frmrtp54cpr.frx":0354
      Left            =   6180
      List            =   "frmrtp54cpr.frx":0356
...
Private Sub cmdImprimir_Click(Index As Integer)
  ...
  With porstMRp
    ...
    If cboTpoMon.ListIndex = TPOMON_NAC_IND Then
      ...
      .Source = .Source & "(a.ImpOI1_MN * (CASE b.SgnTDc WHEN " & SGNTDC_NEG & " THEN -1 ELSE 1 END)) AS cImpOIm1, "
      .Source = .Source & "(a.ImpOI2_MN * (CASE b.SgnTDc WHEN " & SGNTDC_NEG & " THEN -1 ELSE 1 END)) AS cImpOIm2, "
    ...
    Else
      ...
      .Source = .Source & "(a.ImpOI1_ME * (CASE b.SgnTDc WHEN " & SGNTDC_NEG & " THEN -1 ELSE 1 END)) AS cImpOIm1, "
      .Source = .Source & "(a.ImpOI2_ME * (CASE b.SgnTDc WHEN " & SGNTDC_NEG & " THEN -1 ELSE 1 END)) AS cImpOIm2, "
  ...
  If usDEstino = PRN_DEST_GRAF Then
    ...
    With frmMain.rptMain
      .ReportFileName = gsRutRpt & "rptr54regcpr.rpt"
