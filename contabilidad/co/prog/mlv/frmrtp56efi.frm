...
Private Sub cmdImprimir_Click(Index As Integer)
  ...
  With porstMRp
    ...
    .Source = .Source & "WHERE codemp='" & gsCodEmp & "' "
    .Source = .Source & "AND pdoano='" & gsAnoAct & "' "
    .Source = .Source & "AND CodEfi='" & porstCOEFi!CodEfi & "' "
    .Source = .Source & "ORDER BY NroLin"
    .Open
  End With
  
  '[Reporte, titulo y indices
  sReporte = "rptr56efi": sTitulo = IIf(IsNull(porstCOEFi!DetEFi), "", porstCOEFi!DetEFi)
  ...
  If usDEstino = PRN_DEST_GRAF Then
    ...
    With frmMain.rptMain
      ...
      .Formulas(11) = "mDireccion='" & gsDirEmp & "'"
      .Formulas(12) = "mDistrito='" & gsLocEmp & "'"
      .Formulas(13) = "mActividad='" & gsGirEmp & "'"
      .Formulas(14) = "mRepresentante='" & gsRepEmp & "'"
      sRegistro = FormatNumber(Left(gsRepDNIEmp, 8), 0)
      sRegistro = Replace(sRegistro, ",", ".")
      .Formulas(15) = "mDniRepresentante='" & sRegistro & Mid(gsRepDNIEmp, 9) & "'"
      .Formulas(16) = "mContador='" & gsConEmp & "'"
...
Private Sub ppDatosGrid()               'Cambiar Datos Grid.
   ...
   dgrMain.Caption = Choose(gsIdioma, "Estado Financieros", "Financial Statements")
...
Private Sub Llena_Temporal(ByVal s_Source As String)
    ...
    s_Source = s_Source & "SubLin char(1) DEFAULT 'b', FmlLin varchar(255) NULL, "
        ...
        Do While Not porstMRp.EOF
            Select Case porstMRp.Fields!TpoLin
             ...
             Case 3         ' Formula
               ...
               ResuelveFormula IIf(optProceso(3).Value, 1, 0), Trim$(porstMRp.Fields!FmlLin), aImpFormula
               For nContador = 0 To nLimite
