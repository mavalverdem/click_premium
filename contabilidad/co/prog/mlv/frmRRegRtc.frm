...
Private Sub cmdImprimir_Click(Index As Integer)
  Dim sSentencia As String, nRegistros As Double
  
  ppHabilitacion False
  ' Tabla temporal de documentos por retencion
  pocnnMain.Execute IIf(ps_Plataforma = pSrvMySql, "DROP TABLE IF EXISTS tmpCoCPbDetRPDoc", "IF EXISTS (SELECT * FROM tempdb..sysobjects WHERE LEFT(name, 18)='#tmpCoCPbDetRPDoc_') DROP TABLE #tmpCoCPbDetRPDoc")
  ...
  sSentencia = sSentencia & IIf(ps_Plataforma = pSrvMySql, "IFNULL", "ISNULL") & "(SUM(CASE b.TpoCtb WHEN '" & TPOCTB_HAB & "' THEN a.Imp" & IIf(cboTpoMon.ListIndex = 0, TPOMON_NAC_TXT, TPOMON_EXT_TXT) & "_RtcPcp ELSE 0 END), 0) AS cImpDebe, "
  sSentencia = sSentencia & IIf(ps_Plataforma = pSrvMySql, "IFNULL", "ISNULL") & "(SUM(CASE b.TpoCtb WHEN '" & TPOCTB_DEB & "' THEN a.Imp" & IIf(cboTpoMon.ListIndex = 0, TPOMON_NAC_TXT, TPOMON_EXT_TXT) & "_RtcPcp ELSE 0 END), 0) AS cImpHaber "
  sSentencia = sSentencia & IIf(ps_Plataforma = pSrvSql, "INTO #tmpCoCPbDetRPDoc ", "")
  ...
  sSentencia = sSentencia & "AND a.CodTDc_RtcPcp='" & gsCodTDc_Rtc & "' "
  ...
  ElseIf ps_Plataforma = pSrvSql Then
    sSentencia = sSentencia & "HAVING (ISNULL(SUM(CASE b.TpoCtb WHEN '" & TPOCTB_HAB & "' THEN a.Imp" & IIf(cboTpoMon.ListIndex = 0, TPOMON_NAC_TXT, TPOMON_EXT_TXT) & "_RtcPcp ELSE 0 END), 0) <> 0.00) "
    sSentencia = sSentencia & "OR (ISNULL(SUM(CASE b.TpoCtb WHEN '" & TPOCTB_DEB & "' THEN a.Imp" & IIf(cboTpoMon.ListIndex = 0, TPOMON_NAC_TXT, TPOMON_EXT_TXT) & "_RtcPcp ELSE 0 END), 0) <> 0.00) "
  End If
  sSentencia = sSentencia & "ORDER BY a.CodCta, a.CodAux, a.CodTDc, a.SerDoc, a.NroDoc"
  pocnnMain.Execute sSentencia, nRegistros
  
  ' Tabla temporal de las retenciones
  pocnnMain.Execute IIf(ps_Plataforma = pSrvMySql, "DROP TABLE IF EXISTS tmpCoCPbDetRPMov", "IF EXISTS (SELECT * FROM tempdb..sysobjects WHERE LEFT(name, 18)='#tmpCoCPbDetRPMov_') DROP TABLE #tmpCoCPbDetRPMov")
  sSentencia = IIf(ps_Plataforma = pSrvMySql, "CREATE TEMPORARY TABLE IF NOT EXISTS tmpCoCPbDetRPMov ", "")
  ...
  sSentencia = sSentencia & IIf(ps_Plataforma = pSrvSql, "INTO #tmpCoCPbDetRPMov ", "")
  sSentencia = sSentencia & "FROM ((CoCPbDetRP a "
  sSentencia = sSentencia & "LEFT JOIN CoCPbDet b ON a.codemp=b.codemp AND a.pdoano=b.pdoano AND a.MesPvs=b.MesPvs AND a.CodDro=b.CodDro AND a.NroCpb=b.NroCpb AND a.NroIte=b.NroIte) "
  ...
  ' Generacion de la tabla historico documentos
  pocnnMain.Execute IIf(ps_Plataforma = pSrvMySql, "DROP TABLE IF EXISTS tmpCoCPbDetRPHs", "IF EXISTS (SELECT * FROM tempdb..sysobjects WHERE LEFT(name, 17)='#tmpCoCPbDetRPHs_') DROP TABLE #tmpCoCPbDetRPHs")
  sSentencia = IIf(ps_Plataforma = pSrvMySql, "CREATE TEMPORARY TABLE IF NOT EXISTS tmpCoCPbDetRPHs ", "")
  sSentencia = sSentencia & "SELECT DISTINCT a.CodCta, a.CodAux, a.CodTDc, a.SerDoc, a.NroDoc, "
  sSentencia = sSentencia & "a.MesPvs, a.FehOpe, a.FeEDoc, a.TpoPvs, a.TpoGnr, "
  ...
  sSentencia = sSentencia & "(CASE a.TpoPvs WHEN '" & TPOPVS_PVS & "' THEN '0' WHEN '" & TPOPVS_CAN & "' THEN '2' ELSE '3' END) AS cOrden, c.RazAux, c.RUCAux, "
  ...
  sSentencia = sSentencia & "(CASE WHEN (a.TpoPvs='" & TPOPVS_CAN & "' AND a.MesPvs=b.MesPvs AND a.CodDro=b.CodDro AND a.NroCpb=b.NroCpb AND a.NroIte=b.NroIte) THEN '*' ELSE '' END) AS cBorra, "
  sSentencia = sSentencia & "a.CodDro, a.NroCpb, a.NroIte, "
  sSentencia = sSentencia & "ROUND((" & IIf(ps_Plataforma = pSrvMySql, "IFNULL", "ISNULL") & "((CASE a.TpoCtb WHEN '" & TPOCTB_DEB & "' THEN a.Imp" & IIf(cboTpoMon.ListIndex = 0, TPOMON_NAC_TXT, TPOMON_EXT_TXT) & " ELSE 0 END), 0) - "
  sSentencia = sSentencia & "(CASE WHEN (a.TpoPvs='" & TPOPVS_CAN & "' AND a.MesPvs=b.MesPvs AND a.CodDro=b.CodDro AND a.NroCpb=b.NroCpb AND a.NroIte=b.NroIte) THEN b.cImpRetDeb ELSE 0 END)), 2) AS cDebe, "
  sSentencia = sSentencia & "ROUND((" & IIf(ps_Plataforma = pSrvMySql, "IFNULL", "ISNULL") & "((CASE a.TpoCtb WHEN '" & TPOCTB_HAB & "' THEN a.Imp" & IIf(cboTpoMon.ListIndex = 0, TPOMON_NAC_TXT, TPOMON_EXT_TXT) & " ELSE 0 END), 0) - "
  sSentencia = sSentencia & "(CASE WHEN (a.TpoPvs='" & TPOPVS_CAN & "' AND a.MesPvs=b.MesPvs AND a.CodDro=b.CodDro AND a.NroCpb=b.NroCpb AND a.NroIte=b.NroIte) THEN b.cImpRetHab ELSE 0 END)), 2) AS cHaber, "
  ...
  sSentencia = sSentencia & IIf(ps_Plataforma = pSrvSql, "INTO #tmpCoCPbDetRPHs ", "")
  sSentencia = sSentencia & "FROM (((CoCPbDet a "
  sSentencia = sSentencia & "LEFT JOIN " & ps_Prefijo & "tmpCoCPbDetRPMov b ON a.CodCta=b.CodCta AND a.CodAux=b.CodAux AND a.CodTDc=b.CodTDc AND a.SerDoc=b.SerDoc AND a.NroDoc=b.NroDoc) "
  ...
  sSentencia = sSentencia & "AND a.pdoano='" & gsAnoAct & "' "
  sSentencia = sSentencia & "AND a.MesPvs<='" & gsMesAct & "' "
  sSentencia = sSentencia & "AND b.CodTDc_RtcPcp='" & gsCodTDc_Rtc & "' "
  If Trim(txtDato(0).Text) <> "" Then
    sSentencia = sSentencia & "AND a.CodAux='" & Trim(txtDato(0).Text) & "' "
  End If
  If ps_Plataforma = pSrvMySql Then
  ...
  ElseIf ps_Plataforma = pSrvSql Then
    sSentencia = sSentencia & "AND ((ROUND((ISNULL((CASE a.TpoCtb WHEN '" & TPOCTB_DEB & "' THEN a.Imp" & IIf(cboTpoMon.ListIndex = 0, TPOMON_NAC_TXT, TPOMON_EXT_TXT) & " ELSE 0 END), 0) - "
    ...
    sSentencia = sSentencia & "OR (ROUND((ISNULL((CASE a.TpoCtb WHEN '" & TPOCTB_HAB & "' THEN a.Imp" & IIf(cboTpoMon.ListIndex = 0, TPOMON_NAC_TXT, TPOMON_EXT_TXT) & " ELSE 0 END), 0) - "
  ...
  ' Elimino los registros de cancelacion
  sSentencia = "DELETE a FROM " & ps_Prefijo & "tmpCoCPbDetRPHs a, " & ps_Prefijo & "tmpCoCPbDetRPMov b "
  sSentencia = sSentencia & "WHERE a.MesPvs=b.MesPvs "
  sSentencia = sSentencia & "AND a.CodDro=b.CodDro "
  sSentencia = sSentencia & "AND a.NroCpb=b.NroCpb "
  sSentencia = sSentencia & "AND a.NroIte=b.NroIte "
  sSentencia = sSentencia & "AND a.cBorra=''"
  pocnnMain.Execute sSentencia, nRegistros
  
  ' Genero la tabla temporal del reporte
  pocnnMain.Execute IIf(ps_Plataforma = pSrvMySql, "DROP TABLE IF EXISTS tmprptRegReten", "IF EXISTS (SELECT * FROM tempdb..sysobjects WHERE LEFT(name, 16)='#tmprptRegReten_') DROP TABLE #tmprptRegReten")
  
  sSentencia = IIf(ps_Plataforma = pSrvMySql, "CREATE TEMPORARY TABLE IF NOT EXISTS ", "CREATE TABLE ") & ps_Prefijo & "tmprptRegReten ( "
  sSentencia = sSentencia & "CodCta varchar(8) NULL, "
  ...
  sSentencia = sSentencia & "FehOpe " & IIf(ps_Plataforma = pSrvMySql, "date", "smalldatetime") & " default NULL, "
  sSentencia = sSentencia & "FeEDoc " & IIf(ps_Plataforma = pSrvMySql, "date", "smalldatetime") & " default NULL, "
  sSentencia = sSentencia & "TpoPvs char(1) NOT NULL default 'P', "
  sSentencia = sSentencia & "TpoGnr smallint NOT NULL default 0, "
  sSentencia = sSentencia & "cOperacion varchar(11) NOT NULL default '', "
  sSentencia = sSentencia & "cTipoDoc char(2) NULL, "
  sSentencia = sSentencia & "cDocumento varchar(20) NULL, "
  sSentencia = sSentencia & "cOrden char(1) NOT NULL default '', "
  sSentencia = sSentencia & "RazAux varchar(80) NULL, "
  sSentencia = sSentencia & "RUCAux varchar(11) NULL, "
  sSentencia = sSentencia & "DetTDc varchar(40) NULL, "
  sSentencia = sSentencia & "cDebe decimal(12,2) NOT NULL default '0.00', "
  sSentencia = sSentencia & "cHaber decimal(12,2) NOT NULL default '0.00', "
  sSentencia = sSentencia & "cImpRetDeb decimal(12,2) NOT NULL default '0.00', "
  sSentencia = sSentencia & "cImpRetHab decimal(12,2) NOT NULL default '0.00', "
  sSentencia = sSentencia & "cSaldo decimal(12,2) NOT NULL default '0.00')"
  pocnnMain.Execute sSentencia
  
  ' Generacion de la tabla del reporte
  sSentencia = "SELECT DISTINCT a.CodCta, a.CodAux, a.CodTDc, a.SerDoc, a.NroDoc, "
  sSentencia = sSentencia & "a.MesPvs, a.FehOpe, a.FeEDoc, a.TpoPvs, a.TpoGnr, "
  sSentencia = sSentencia & "a.cOperacion, a.cTipoDoc, a.cDocumento, a.cOrden, a.RazAux, a.RUCAux, "
  sSentencia = sSentencia & Choose(gsIdioma, "a.DetTDc", "a.DetTDcx") & " AS DetTDc, a.cDebe, a.cHaber, "
  sSentencia = sSentencia & "a.cImpRetDeb, a.cImpRetHab, a.cSaldo "
  sSentencia = sSentencia & "FROM " & ps_Prefijo & "tmpCoCPbDetRPHs a "
  sSentencia = sSentencia & "UNION "
  sSentencia = sSentencia & "SELECT DISTINCT b.CodCta, b.CodAux, b.CodTDc, b.SerDoc, b.NroDoc, "
  sSentencia = sSentencia & "b.MesPvs, b.FeEDoc_RtcPcp, b.FeEDoc_RtcPcp AS FeEDoc, '" & TPOPVS_PVS & "' AS TpoPvs, '" & TPOGNR_DRP & "' AS TpoGnr, 'RETENCION' AS cOperacion, "
  ...
  sSentencia = sSentencia & "'4' AS cOrden, c.RazAux, c.RUCAux, " & Choose(gsIdioma, "d.DetTDc", "d.DetTDcx") & " AS DetTDc, "
  ...
  sSentencia = sSentencia & "FROM ((" & ps_Prefijo & "tmpCoCPbDetRPMov b "
  sSentencia = sSentencia & "LEFT JOIN TgAux c ON c.codemp='" & gsCodEmp & "' AND c.CodAux=b.CodAux) "
  sSentencia = sSentencia & "LEFT JOIN TgTDc d ON d.codemp='" & gsCodEmp & "' AND d.CodTDc=b.CodTDc_RtcPcp) "
  ...
  ' Inserto los registros seleccionados
  pocnnMain.Execute "INSERT INTO " & ps_Prefijo & "tmprptRegReten " & sSentencia
  ...
  With porstMRp
    ...
    .Source = "SELECT * "
    .Source = .Source & "FROM " & ps_Prefijo & "tmprptRegReten "
...
Private Sub ppDatosRetencion()
   
  Dim porstRpt As ADODB.Recordset
  Dim nDebe As Double, nHaber As Double, nSaldo As Double
  Dim sCodAux As String, sCodTDc As String
  Dim sSerDoc As String, sNroDoc As String
  Dim lRptJump As Boolean
  ...
  If Not (porstRpt.BOF And porstRpt.EOF) Then
    ...
    Do While Not porstRpt.EOF
      ...
      nSaldo = Round(CDec(nHaber - nDebe), 2)
