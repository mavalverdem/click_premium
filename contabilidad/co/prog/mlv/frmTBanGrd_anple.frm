...
Begin VB.Form frmTBanGrd_anple 
   Caption         =   "[Entidad]-Caja antes del ple"
   ClientHeight    =   5580
   ClientLeft      =   1635
   ClientTop       =   1605
   ClientWidth     =   9360
   ...
   Begin VB.Frame framepagos 
      ...
      Begin VB.CommandButton cmdreporte 
         Height          =   495
         Left            =   5160
         Picture         =   "frmTBanGrd_anple.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   360
         Width           =   495
      ...
      Begin VB.CommandButton cmdabajo 
         Height          =   255
         Left            =   5640
         Picture         =   "frmTBanGrd_anple.frx":058A
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   600
         Width           =   375
      ...
      Begin VB.CommandButton cmdarriba 
         Height          =   255
         Left            =   5640
         Picture         =   "frmTBanGrd_anple.frx":06D4
         Style           =   1  'Graphical
         TabIndex        =   22
         Top             =   360
         Width           =   375
      ...
      Begin VB.CommandButton cmdprocesar 
         Height          =   495
         Left            =   4680
         Picture         =   "frmTBanGrd_anple.frx":081E
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   360
         Width           =   495
      ...
      Begin VB.CommandButton cmdvalidar 
         Height          =   495
         Left            =   4200
         Picture         =   "frmTBanGrd_anple.frx":0968
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   360
         Width           =   495
      ...
      Begin VB.CommandButton cmdfiltrar 
         Height          =   495
         Left            =   3720
         Picture         =   "frmTBanGrd_anple.frx":0AB2
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   360
         Width           =   495
      ...
      Begin VB.CommandButton cmdDatoAyud 
         ...
         Index           =   0
         Left            =   2400
         Picture         =   "frmTBanGrd_anple.frx":0BFC
         Style           =   1  'Graphical
         TabIndex        =   16
         TabStop         =   0   'False
         Top             =   480
   ...
   Begin VB.PictureBox picOpciones 
      ...
      Begin VB.CommandButton cmdpagos 
         ...
         Height          =   560
         Left            =   3600
         Picture         =   "frmTBanGrd_anple.frx":0DA6
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   0
         Width           =   850
      ...
      Begin VB.CommandButton cmdRevisar 
         ...
         Height          =   560
         Left            =   720
         Picture         =   "frmTBanGrd_anple.frx":0EF0
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   0
         Width           =   720
      ...
      Begin VB.CommandButton cmdImprimir 
         ...
         Index           =   1
         Left            =   2880
         Picture         =   "frmTBanGrd_anple.frx":0FF2
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   0
         Width           =   720
      ...
      Begin VB.CommandButton cmdEliminar 
         ...
         Height          =   560
         Left            =   1440
         Picture         =   "frmTBanGrd_anple.frx":10F4
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   0
         Width           =   720
      ...
      Begin VB.CommandButton cmdNuevo 
         ...
         Height          =   560
         Left            =   0
         Picture         =   "frmTBanGrd_anple.frx":11F6
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   0
         Width           =   720
      ...
      Begin VB.CommandButton cmdSalir 
         ...
         Height          =   560
         Left            =   8640
         Picture         =   "frmTBanGrd_anple.frx":12F8
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   0
         Width           =   720
      ...
      Begin VB.CommandButton cmdRefrescar 
         ...
         Height          =   560
         Left            =   2160
         Picture         =   "frmTBanGrd_anple.frx":1442
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   0
         Width           =   720
   ...
   End
End
Attribute VB_Name = "frmTBanGrd_anple"
...
Public Sub cmdNuevo_Click()
  ...
  With uorstMain_1
    ...
    .Properties("Unique Table").Value = "cobandet"
  End With
  gpTUg_Nuevo Me, frmTBanCab_anple          'Cambiar Formulario de Datos.
End Sub
...
Public Sub cmdRevisar_click()
  ...
  With frmTBanCab_anple                     'Cambiar Formulario de Datos.
    .zbNuevo = False
