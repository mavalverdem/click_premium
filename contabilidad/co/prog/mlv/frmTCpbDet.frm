...
'ini 2016-02-02.15 correccion ple
...
'   End If
'fin 2016-02-02.15 correccion ple
...
'      txtDato(2).MaxLength = 6
    ...
    '2016-02-02.15 correccion ple gpcbo_sunat_ins cboCodMon, frmTCpbGrd.uorstCodMon '2016-02-02.07  correccion ple
      txtDato2(0).MaxLength = frmTCpbGrd.uorstMain_1!codmon.DefinedSize
...
Public Sub cmdGrabar_Click()
 ...
 '2016-02-02.15 correccion ple If cboCodMon.ListIndex = 0 Then MsgBox TEXT_6002, vbCritical:   cboCodMon.SetFocus: Exit Sub '2016-02-02.07  correccion ple
    ...
    If Len(Trim(txtDato(0).Text)) <> 0 And optTpoPvs(0).Value = True Then
       With frmTCpbGrd.uorstCoCta
         ...
         Else
            ...
            '
'ini 2016-05-03 segun teo solo valida si TpoAnl=1, IndAjd=2
'            If !tpomon <> Choose(cboTpoMon.ListIndex + 1, TPOMON_NAC, TPOMON_EXT) Then
'                MsgBox TEXT_9021, vbExclamation
'                Exit Sub
'            End If
            If !TpoAnl = INDAJD_ACT And !IndAjd = TPOANL_DOC Then
            If !tpomon <> Choose(cboTpoMon.ListIndex + 1, TPOMON_NAC, TPOMON_EXT) Then
                MsgBox TEXT_9021, vbExclamation
                Exit Sub
            End If
            End If
'fin 2016-05-03 segun teo solo valida si TpoAnl=1, IndAjd=2
...
Private Function ppAyuDet2(tnIndex As Integer)
  ...
  Select Case tnIndex                 'Cambiar.
   Case 0
        ...
        Set zxrst = IIf(tnIndex = 0, frmTCpbGrd.uorstCodMon, zxrst)
...
'tnFase           Fase del procedimiento (0:Grabar 1:Corregir).
   ...
   With frmTCpbGrd                     'Cambiar Formulario de Grid.
      If tnFase = 0 Then
        ...
        '2016-02-02.15 correccion ple gpcbo_sunat_update cboCodMon, frmTCpbGrd.uorstCodMon, "CodMon", 3, .uorstMain_1 '2016-02-02.07  correccion ple
       frmTCpbGrd.uorstMain_1!codmon = IIf(txtDato2(0).Text = "", Null, txtDato2(0).Text) '2016-02-02.08  correccion ple
...
'         txtLlave(0).Text = .uorstMain_1!CodSvc
        ...
        '2016-02-02.15 correccion ple gpcbo_sunat_index cboCodMon, "CodMon", 3, .uorstMain_1 '2016-02-02.07  correccion ple
         txtDato2(0).Text = IIf(IsNull(frmTCpbGrd.uorstMain_1!codmon), "", frmTCpbGrd.uorstMain_1!codmon) ' 2016-02-02.08  correccion ple
         ppAyuDet2 0
...
'   txtLlave(0).Text = ""
  ...
  'Datos.
   ...
   End With
    ...
    '2016-02-02.15 correccion ple gpcbo_sunat_index2 cboCodMon, IIf(cboTpoMon.ListIndex = TPOMON_NAC_IND, CODMON_NAC, CODMON_EXT), 3 '2016-02-02.07  correccion ple
    txtDato2(0).Text = IIf(cboTpoMon.ListIndex = TPOMON_NAC_IND, CODMON_NAC, CODMON_EXT) '2016-02-02.06  correccion ple
    ppAyuDet2 0
...
Public Sub upHabilitacion(tbHabilitar As Boolean) 'Cambiar.
  ...
  '2016-02-02.15 correccion ple  cboCodMon.Enabled = tbHabilitar '2016-02-02.07  correccion ple
