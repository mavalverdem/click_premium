...
Private Sub Form_Load()
 '[Recordsets                          'Cambiar.
   psConnStrgSele = "SELECT codbco, "
   psConnStrgSele = psConnStrgSele & Choose(gsIdioma, "detbco, ", "detbcox, ")
   psConnStrgSele = psConnStrgSele & "codent, forimp,ctactemn,ctacteme, "
   psConnStrgSele = psConnStrgSele & Choose(gsIdioma, "detbcox, ", "detbco, ")
   psConnStrgSele = psConnStrgSele & "codemp, "
   psConnStrgSele = psConnStrgSele & "UsrCre, FyHCre, UsrMdf, FyHMdf "
   psConnStrgSele = psConnStrgSele & "FROM cobco "
...
'     .CursorLocation = adUseClient   'Es el Default.
      ...
      .Open
      .Properties("Unique Table").Value = "cobco"
   End With
 ']
...
Public Sub cmdNuevo_Click()
   gpTUg_Nuevo Me, frmMBco             'Cambiar Formulario de Datos.
End Sub
...
Public Sub cmdRevisar_click()
   ...
   With frmMBco                        'Cambiar Formulario de Datos.
      .zbNuevo = False
...
Public Sub cmdImprimir_Click(Index As Integer)
 ...
 '[Datos del formulario de impresión.  'Cambiar.
   frmLBco.Caption = Choose(gsIdioma, "Listado de ", "Listing of ") & Me.Caption
   frmLBco.Show vbModal
 ']
End Sub
...
Public Sub ppDatosGrid()               'Cambiar Datos Grid.
   ...
   With dgrMain.Columns
      For dnNum = 0 To .Count - 1
         ...
         Case 1
            .Item(dnNum).Caption = Choose(gsIdioma, "Descripción", "Descripction")
            .Item(dnNum).Width = 6100
         Case Else
