...
Private Sub ppGeneraComprobante()
  ...
  If frmTBanGrd.uorstCOTCbMes.State = adStateOpen Then frmTBanGrd.uorstCOTCbMes.Close
  frmTBanGrd.uorstCOTCbMes.Source = sSentencia
  frmTBanGrd.uorstCOTCbMes.Open
  nRegistro = frmTBanGrd.uorstCOTCbMes!registro
...
'fin 2016-02-02.07  correccion ple
      ...
      sSentencia = sSentencia & "'" & txtLlave(0).Text & "', "
      sSentencia = sSentencia & "'" & txtLlave(1).Text & "', "
      sSentencia = sSentencia & frmTBanGrd.uorstCOTCbMes!nroitem & ", "
      sSentencia = sSentencia & "'" & gsMesAct & "', "
      sSentencia = sSentencia & frmTBanGrd.uorstCOTCbMes!nroitem & ", "
      sSentencia = sSentencia & IIf(ps_Plataforma = pSrvMySql, "DATE_FORMAT(", "CONVERT(smalldatetime, ") & "'" & Format(dtpFehBan.Value, "yyyy-mm-dd") & "', " & IIf(ps_Plataforma = pSrvMySql, "'%Y-%m-%d'", "120") & "), "
      sSentencia = sSentencia & "'" & frmTBanGrd.uorstCOTCbMes!codcta & "', "
      sSentencia = sSentencia & IIf(frmTBanGrd.uorstCOTCbMes!indcco = INDCCO_INA Or IsNull(frmTBanGrd.uorstCOTCbMes!codcco), "Null", "'" & frmTBanGrd.uorstCOTCbMes!codcco & "'") & ", "
      sSentencia = sSentencia & IIf(frmTBanGrd.uorstCOTCbMes!IndDoc = INDCCO_INA And IsNull(Trim(frmTBanGrd.uorstCOTCbMes!codaux)), "Null", "'" & frmTBanGrd.uorstCOTCbMes!codaux & "'") & ", "
      sSentencia = sSentencia & IIf(frmTBanGrd.uorstCOTCbMes!IndDoc = INDDOC_INA Or IsNull(frmTBanGrd.uorstCOTCbMes!codtdc), "Null", "'" & frmTBanGrd.uorstCOTCbMes!codtdc & "'") & ", "
      sSentencia = sSentencia & IIf(frmTBanGrd.uorstCOTCbMes!IndDoc = INDDOC_INA Or IsNull(frmTBanGrd.uorstCOTCbMes!serdoc), "Null", "'" & frmTBanGrd.uorstCOTCbMes!serdoc & "'") & ", "
      sSentencia = sSentencia & IIf(frmTBanGrd.uorstCOTCbMes!IndDoc = INDDOC_INA Or IsNull(frmTBanGrd.uorstCOTCbMes!nrodoc), "Null", "'" & frmTBanGrd.uorstCOTCbMes!nrodoc & "'") & ", "
      sSentencia = sSentencia & IIf(ps_Plataforma = pSrvMySql, "DATE_FORMAT(", "CONVERT(smalldatetime, ") & "'" & Format(dtpFehBan.Value, "yyyy-mm-dd") & "', " & IIf(ps_Plataforma = pSrvMySql, "'%Y-%m-%d'", "120") & "), "
      sSentencia = sSentencia & IIf(ps_Plataforma = pSrvMySql, "DATE_FORMAT(", "CONVERT(smalldatetime, ") & "'" & Format(dtpFehBan.Value, "yyyy-mm-dd") & "', " & IIf(ps_Plataforma = pSrvMySql, "'%Y-%m-%d'", "120") & "), "
      sSentencia = sSentencia & IIf(ps_Plataforma = pSrvMySql, "DATE_FORMAT(", "CONVERT(smalldatetime, ") & "'" & Format(dtpFehBan.Value, "yyyy-mm-dd") & "', " & IIf(ps_Plataforma = pSrvMySql, "'%Y-%m-%d'", "120") & "), "
      sSentencia = sSentencia & IIf(IsNull(frmTBanGrd.uorstCOTCbMes!RefDoc), "Null", "'" & frmTBanGrd.uorstCOTCbMes!RefDoc & "'") & ", "
      sSentencia = sSentencia & IIf(IsNull(frmTBanGrd.uorstCOTCbMes!GloIte), "Null", "'" & frmTBanGrd.uorstCOTCbMes!GloIte & "'") & ", "
      sSentencia = sSentencia & IIf(IsNull(frmTBanGrd.uorstCOTCbMes!GloItex), "Null", "'" & frmTBanGrd.uorstCOTCbMes!GloItex & "'") & ", "
      sSentencia = sSentencia & "'" & IIf(Val(frmTBanGrd.uorstCOTCbMes!tpoban) = TPOBAN_EGR, TPOCTB_DEB, TPOCTB_HAB) & "', "
      sSentencia = sSentencia & "'" & IIf(CInt(frmTBanGrd.uorstCOTCbMes!pvsdoc) = INDPREGEN_INA, TPOPVS_CAN, TPOPVS_PVS) & "', "
      sSentencia = sSentencia & "'" & frmTBanGrd.uorstCOTCbMes!tpomon & "', "
      sSentencia = sSentencia & "'" & frmTBanGrd.uorstCOTCbMes!TpoTcb & "', "
      sSentencia = sSentencia & frmTBanGrd.uorstCOTCbMes!ImpTCb & ", "
      sSentencia = sSentencia & CDec(frmTBanGrd.uorstCOTCbMes!ImpMN) & ", "
      sSentencia = sSentencia & CDec(frmTBanGrd.uorstCOTCbMes!ImpME) & ", "
      sSentencia = sSentencia & "'" & TPOGNR_BAN & "', "
      sCodFlujo = IIf(frmTBanGrd.uorstCOTCbMes!IndFjo = INDFJO_ACT, txtDato(5).Text, "")
      sSentencia = sSentencia & IIf(sCodFlujo = "", INDFJO_INA, INDFJO_ACT) & ", "
      sSentencia = sSentencia & "'" & gsAbvUsr & "', "
      sSentencia = sSentencia & IIf(ps_Plataforma = pSrvMySql, "DATE_FORMAT(", "CONVERT(datetime, ") & "'" & Format(Now, s_FmtFeHoMysql_0) & "', " & IIf(ps_Plataforma = pSrvMySql, "'%Y-%m-%d %T'", "120") & "), "
'ini 2016-02-02.07  correccion ple
      sSentencia = sSentencia & "Null, Null,'" & txtDato(10).Text & "',"
      sSentencia = sSentencia & "'" & frmTBanGrd.uorstCOTCbMes!codmon & "' "
      sSentencia = sSentencia & ")"
    Dim xtmp_CodMon As String
    '2016-02-02.12 teo tuvo error de null xtmp_CodMon = frmTBanGrd.uorstCOTCbMes!CodMon
    xtmp_CodMon = IIf(IsNull(frmTBanGrd.uorstCOTCbMes!codmon) = True, "", frmTBanGrd.uorstCOTCbMes!codmon)
'fin 2016-02-02.07  correccion ple
      ...
      If sCodFlujo <> "" Then
        ...
        sSentencia = sSentencia & " '" & IIf(Val(frmTBanGrd.uorstCOTCbMes!tpoban) = TPOBAN_EGR, TPOCTB_DEB, TPOCTB_HAB) & "',"
        sSentencia = sSentencia & CDec(frmTBanGrd.uorstCOTCbMes!ImpMN) & ", "
        sSentencia = sSentencia & frmTBanGrd.uorstCOTCbMes!ImpME & ", "
        sSentencia = sSentencia & " '" & gsAbvUsr & "',"
        sSentencia = sSentencia & " '" & Format(Now, "yyyy-mm-dd hh:mm:ss") & "',"
        sSentencia = sSentencia & " Null, Null)"
        frmTBanGrd.uocnnMain.Execute sSentencia
      End If
      'sSentencia = sSentencia & " '" & IIf(frmTBanGrd.uorstCOTCbMes!tpoban = TPOBAN_EGR, TPOCTB_DEB, TPOCTB_HAB) & "',"
      nNroItem = CLng(frmTBanGrd.uorstCOTCbMes!nroitem)
  ...
  frmTBanGrd.uorstCOTCbMes.Open
  If frmTBanGrd.uorstCOTCbMes.RecordCount <> 0 Then
    sIndDoc = frmTBanGrd.uorstCOTCbMes!IndDoc
    sIndCco = frmTBanGrd.uorstCOTCbMes!indcco
    sIndFjo = frmTBanGrd.uorstCOTCbMes!IndFjo
  End If
  frmTBanGrd.uorstCOTCbMes.Close
...
'ini 2016-02-02.07  correccion ple
    sSentencia = sSentencia & "Null, Null,'" & txtDato(10).Text & "',"
    sSentencia = sSentencia & "'" & xtmp_CodMon & "' "
    sSentencia = sSentencia & ")"
'fin 2016-02-02.07  correccion ple
  ...
  frmTBanGrd.uorstMain_0!ImpMN = CDec(txtDeta(4).Text)
  frmTBanGrd.uorstMain_0!ImpME = CDec(txtDeta(5).Text)
  frmTBanGrd.uorstMain_0!gencpb = IIf(chkGenCpb.Value = vbChecked, INDPREGEN_ACT, INDPREGEN_INA)
  frmTBanGrd.uorstMain_0!genprc = IIf(chkGenPrc.Value = vbChecked, INDPREGEN_ACTx, INDPREGEN_INAx)
  frmTBanGrd.uorstMain_0.Update
  Else
  frmTBanGrd.uorstMain_0Fil!ImpMN = CDec(txtDeta(4).Text)
  frmTBanGrd.uorstMain_0Fil!ImpME = CDec(txtDeta(5).Text)
  frmTBanGrd.uorstMain_0Fil!gencpb = IIf(chkGenCpb.Value = vbChecked, INDPREGEN_ACT, INDPREGEN_INA)
  frmTBanGrd.uorstMain_0Fil!genprc = IIf(chkGenPrc.Value = vbChecked, INDPREGEN_ACTx, INDPREGEN_INAx)
  ...
  If proceso = False Then
    ...
    frmTBanGrd.uorstMain_Grd.Find "cLlave='" & txtLlave(0).Text & txtLlave(1).Text & "'"
    ' ]
  Else
    ' [Actualiza grilla y busco registro actual
    frmTBanGrd.uorstMain_GrdFil.Requery
    frmTBanGrd.ppDatosGrid
    frmTBanGrd.uorstMain_GrdFil.Find "cLlave='" & txtLlave(0).Text & txtLlave(1).Text & "'"
    ' ]
  End If
  Exit Sub
Err:
...
Private Sub Form_Activate()
  ...
  If pbLoad And Not pbNuevo Then
    pbLoad = False
    frmTBanGrd.usConnStrgWher_1 = "WHERE cobandet.codemp='" & gsCodEmp & "' "
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.pdoano='" & gsAnoAct & "' "
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.MesPvs='" & gsMesAct & "' "
    If proceso = False Then
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.coddro='" & frmTBanGrd.uorstMain_0!coddro & "' "
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.nroban='" & frmTBanGrd.uorstMain_0!nroban & "' "
    Else
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.coddro='" & frmTBanGrd.uorstMain_0Fil!coddro & "' "
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.nroban='" & frmTBanGrd.uorstMain_0Fil!nroban & "' "
...
If proceso = False Then
   If frmTBanGrd.uorstMain_0.RecordCount <> 0 Then
'      frmTBanGrd.uorstMain_0.CancelUpdate   'Cambiar Formulario de Grid.
   End If
Else
   If frmTBanGrd.uorstMain_0Fil.RecordCount <> 0 Then
'      frmTBanGrd.uorstMain_0.CancelUpdate   'Cambiar Formulario de Grid.
   End If
End If
End Sub
...
Private Sub cmdRetroceder_Click()
  If proceso = False Then
    gpTUe_Retroceder frmTBanGrd.uorstMain_0, Me
    frmTBanGrd.usConnStrgWher_1 = "WHERE cobandet.codemp='" & gsCodEmp & "' "
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.pdoano='" & gsAnoAct & "' "
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.MesPvs='" & gsMesAct & "' "
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.CodDro='" & frmTBanGrd.uorstMain_0!coddro & "' "
    ...
    ' Busca ítem MA
    frmTBanGrd.uorstMain_Grd.MoveFirst
    frmTBanGrd.uorstMain_Grd.Find "cLlave='" & txtLlave(0).Text & txtLlave(1).Text & "'"
 Else
    gpTUe_Retroceder frmTBanGrd.uorstMain_0Fil, Me
    frmTBanGrd.usConnStrgWher_1 = "WHERE cobandet.codemp='" & gsCodEmp & "' "
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.pdoano='" & gsAnoAct & "' "
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.MesPvs='" & gsMesAct & "' "
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.CodDro='" & frmTBanGrd.uorstMain_0Fil!coddro & "' "
    ...
    ' Busca ítem MA
    frmTBanGrd.uorstMain_GrdFil.MoveFirst
    frmTBanGrd.uorstMain_GrdFil.Find "cLlave='" & txtLlave(0).Text & txtLlave(1).Text & "'"
 End If
End Sub
...
Private Sub cmdAvanzar_Click()
  If proceso = False Then
    ...
    gpTUe_Avanzar frmTBanGrd.uorstMain_0, Me
    frmTBanGrd.usConnStrgWher_1 = "WHERE cobandet.codemp='" & gsCodEmp & "' "
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.pdoano='" & gsAnoAct & "' "
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.MesPvs='" & gsMesAct & "' "
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.CodDro='" & frmTBanGrd.uorstMain_0!coddro & "' "
  ...
  Else
    ...
    gpTUe_Avanzar frmTBanGrd.uorstMain_0Fil, Me
    frmTBanGrd.usConnStrgWher_1 = "WHERE cobandet.codemp='" & gsCodEmp & "' "
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.pdoano='" & gsAnoAct & "' "
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.MesPvs='" & gsMesAct & "' "
    frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.CodDro='" & frmTBanGrd.uorstMain_0Fil!coddro & "' "
...
Public Sub cmdGrabar_Click()
  ...
  With frmTBanGrd                     'Cambiar Formulario de Grid.
    ...
    If pbNuevo Then
      ...
      frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.pdoano='" & gsAnoAct & "' "
      frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.MesPvs='" & gsMesAct & "' "
      frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.CodDro='" & txtLlave(0).Text & "' "
      frmTBanGrd.usConnStrgWher_1 = frmTBanGrd.usConnStrgWher_1 & "AND cobandet.nroban='" & txtLlave(1).Text & "' "
      ppDatosWhere
      ']
...
Public Sub cmdNuevo_Click()
  ...
  End With
  Else
  With frmTBanGrd.uorstMain_0Fil
    If .RecordCount > 0 Then
      .Find "cLlave='" & txtLlave(0).Text & txtLlave(1).Text & "'"
      If .EOF Then
        MsgBox Choose(gsIdioma, "Tiene que Grabar la Cabecera del Comprobante para poder Registrar el Detalle", "You have to save Voucher Header to register Detail"), vbInformation
  ...
  If frmTBanGrd.uorstMain_1.RecordCount > 0 Then
    frmTBanGrd.uorstMain_1.MoveLast
  End If
  Else
  If frmTBanGrd.uorstMain_1Fil.RecordCount > 0 Then
    frmTBanGrd.uorstMain_1Fil.MoveLast
  End If
...
Public Sub cmdRevisar_click()
  ...
  '[Agregado por Angel
  If proceso = False Then
    dvRegistro = frmTBanGrd.uorstMain_1.Bookmark
  Else
    dvRegistro = frmTBanGrd.uorstMain_1Fil.Bookmark
  End If
  ...
  ppDatosWhere
  If proceso = False Then
        frmTBanGrd.uorstMain_1.Bookmark = dvRegistro
  Else
        frmTBanGrd.uorstMain_1Fil.Bookmark = dvRegistro
  End If
  ']
  dgrDetalle.SetFocus
  Exit Sub
  ...
  'fin 2016-05-27/28 nivel=asisten no elimin datos
    ...
    If MsgBox(TEXT_1021 & " " & Trim(dgrDetalle.Columns(1)) & ")?", vbYesNo + vbQuestion + vbDefaultButton2, Me.Caption) = vbYes Then
      ...
      If Trim(.uorstMain_1!tpoban) = TPOBAN_EGR Then
        frmTBanCab.txtDeta(0) = Format(CDec(frmTBanCab.txtDeta(0).Text) - .uorstMain_1!ImpMN, FORMATO_NUM_1)
        frmTBanCab.txtDeta(2) = Format(CDec(frmTBanCab.txtDeta(2).Text) - .uorstMain_1!ImpME, FORMATO_NUM_1)
      Else
        frmTBanCab.txtDeta(1) = Format(CDec(frmTBanCab.txtDeta(1).Text) - .uorstMain_1!ImpMN, FORMATO_NUM_1)
        frmTBanCab.txtDeta(3) = Format(CDec(frmTBanCab.txtDeta(3).Text) - .uorstMain_1!ImpME, FORMATO_NUM_1)
      End If
      frmTBanCab.txtDeta(4) = Format(CDec(frmTBanCab.txtDeta(1).Text) - CDec(frmTBanCab.txtDeta(0).Text), FORMATO_NUM_1)
      frmTBanCab.txtDeta(5) = Format(CDec(frmTBanCab.txtDeta(3).Text) - CDec(frmTBanCab.txtDeta(2).Text), FORMATO_NUM_1)
      ...
      If Trim(.uorstMain_1Fil!tpoban) = TPOBAN_EGR Then
        frmTBanCab.txtDeta(0) = Format(CDec(frmTBanCab.txtDeta(0).Text) - .uorstMain_1Fil!ImpMN, FORMATO_NUM_1)
        frmTBanCab.txtDeta(2) = Format(CDec(frmTBanCab.txtDeta(2).Text) - .uorstMain_1Fil!ImpME, FORMATO_NUM_1)
      Else
        frmTBanCab.txtDeta(1) = Format(CDec(frmTBanCab.txtDeta(1).Text) - .uorstMain_1Fil!ImpMN, FORMATO_NUM_1)
        frmTBanCab.txtDeta(3) = Format(CDec(frmTBanCab.txtDeta(3).Text) - .uorstMain_1Fil!ImpME, FORMATO_NUM_1)
      End If
      frmTBanCab.txtDeta(4) = Format(CDec(frmTBanCab.txtDeta(1).Text) - CDec(frmTBanCab.txtDeta(0).Text), FORMATO_NUM_1)
      frmTBanCab.txtDeta(5) = Format(CDec(frmTBanCab.txtDeta(3).Text) - CDec(frmTBanCab.txtDeta(2).Text), FORMATO_NUM_1)
      .uocnnMain.BeginTrans     ' Inicio transaccion
...
Public Sub cmdRefrescar_Click()
  ...
  If proceso = False Then
    frmTBanGrd.uorstMain_1.Requery
  Else
    frmTBanGrd.uorstMain_1Fil.Requery
  End If
  frmTBanCab.upDatosGrid
  frmTBanCab.dgrDetalle.SetFocus
  ']
End Sub

Public Sub cmdCalcular_Click()
  If proceso = False Then
  With frmTBanGrd.uorstMain_1
    txtDeta(0).Text = Format(0, FORMATO_NUM_1)
    txtDeta(1).Text = Format(0, FORMATO_NUM_1)
    txtDeta(2).Text = Format(0, FORMATO_NUM_1)
    txtDeta(3).Text = Format(0, FORMATO_NUM_1)
    ...
    txtDeta(5).Text = Format(0, FORMATO_NUM_1)
    If frmTBanGrd.uorstMain_1.RecordCount > 0 Then
      frmTBanGrd.uorstMain_1.MoveFirst
      Do
        ...
        frmTBanGrd.uorstMain_1.MoveNext
      Loop Until .EOF
    End If
  End With
  ...
  Set dgrDetalle.DataSource = frmTBanGrd.uorstMain_1
  Else
  With frmTBanGrd.uorstMain_1Fil
    txtDeta(0).Text = Format(0, FORMATO_NUM_1)
    txtDeta(1).Text = Format(0, FORMATO_NUM_1)
    txtDeta(2).Text = Format(0, FORMATO_NUM_1)
    txtDeta(3).Text = Format(0, FORMATO_NUM_1)
    ...
    txtDeta(5).Text = Format(0, FORMATO_NUM_1)
    If frmTBanGrd.uorstMain_1Fil.RecordCount > 0 Then
      frmTBanGrd.uorstMain_1Fil.MoveFirst
      Do
        txtDeta(0).Text = Format(CDec(txtDeta(0).Text) + !cImpMN_Deb, FORMATO_NUM_1)
        txtDeta(1).Text = Format(CDec(txtDeta(1).Text) + !cImpMN_Hab, FORMATO_NUM_1)
        txtDeta(2).Text = Format(CDec(txtDeta(2).Text) + !cImpME_Deb, FORMATO_NUM_1)
        txtDeta(3).Text = Format(CDec(txtDeta(3).Text) + !cImpME_Hab, FORMATO_NUM_1)
        frmTBanGrd.uorstMain_1Fil.MoveNext
      Loop Until .EOF
    End If
  End With
  txtDeta(4).Text = Format(CDec(txtDeta(1).Text) - CDec(txtDeta(0).Text), FORMATO_NUM_1)
  txtDeta(5).Text = Format(CDec(txtDeta(3).Text) - CDec(txtDeta(2).Text), FORMATO_NUM_1)
  Set dgrDetalle.DataSource = frmTBanGrd.uorstMain_1Fil
   ...
   Case 2                           'Cambiar (añadir índices).
    ...
    If lblDatoDeta(Index).Caption <> "" Then
      ...
      'If psCodCCo_Def <> "" Then
        ...
        cboTpoMon.ListIndex = IIf(frmTBanGrd.uorstCoCta!tpomon = TPOMON_NAC, TPOMON_NAC_IND, TPOMON_EXT_IND)
        
      'End If
    
        txtDato(9).Text = IIf(IsNull(frmTBanGrd.uorstCoCta!codbco), "", frmTBanGrd.uorstCoCta!codbco)
...
Private Sub dgrDetalle_KeyUp(KeyCode As Integer, Shift As Integer)
   If proceso = False Then
   If frmTBanGrd.uorstMain_1.RecordCount = 0 Then Exit Sub
   ...
   End Select
   Else
   If frmTBanGrd.uorstMain_1Fil.RecordCount = 0 Then Exit Sub
...
Private Sub ppDatosWhere()             'Cambiar.
  If proceso = False Then
    frmTBanGrd.uorstMain_1.Close
    frmTBanGrd.uorstMain_1.Source = frmTBanGrd.usConnStrgSele_1 & frmTBanGrd.usConnStrgWher_1 & frmTBanGrd.usConnStrgOrde_1
    frmTBanGrd.uorstMain_1.Open
    frmTBanGrd.uorstMain_1.Properties("Unique Table").Value = "cobandet"
    cmdCalcular_Click
  Else
    frmTBanGrd.uorstMain_1Fil.Close
    frmTBanGrd.uorstMain_1Fil.Source = frmTBanGrd.usConnStrgSele_1 & frmTBanGrd.usConnStrgWher_1 & frmTBanGrd.usConnStrgOrde_1
    frmTBanGrd.uorstMain_1Fil.Open
    frmTBanGrd.uorstMain_1Fil.Properties("Unique Table").Value = "cobandet"
    cmdCalcular_Click
    ...
    For dnNum = 0 To .Count - 1
      Select Case dnNum
       ...
       Case 2
        ...
        If proceso = False Then
        .Item(dnNum).Width = 90 * (frmTBanGrd.uorstMain_1.Fields("CodCCo").DefinedSize + 1)
        Else
        .Item(dnNum).Width = 90 * (frmTBanGrd.uorstMain_1Fil.Fields("CodCCo").DefinedSize + 1)
        End If
       Case 3
        .Item(dnNum).Caption = Choose(gsIdioma, "Auxiliar", "Auxiliary")
        If proceso = False Then
        .Item(dnNum).Width = 90 * (frmTBanGrd.uorstMain_1.Fields("codaux").DefinedSize + 1)
        Else
        .Item(dnNum).Width = 90 * (frmTBanGrd.uorstMain_1Fil.Fields("codaux").DefinedSize + 1)
        End If
       Case 4
        .Item(dnNum).Caption = "Doc"
        If proceso = False Then
        .Item(dnNum).Width = 100 * (frmTBanGrd.uorstMain_1.Fields("AbvTDc").DefinedSize + 1)
        Else
        .Item(dnNum).Width = 100 * (frmTBanGrd.uorstMain_1Fil.Fields("AbvTDc").DefinedSize + 1)
        End If
       Case 5
        .Item(dnNum).Caption = Choose(gsIdioma, "Serie", "Series")
        If proceso = False Then
        .Item(dnNum).Width = 100 * (frmTBanGrd.uorstMain_1.Fields("SerDoc").DefinedSize + 1.5)
        Else
        .Item(dnNum).Width = 100 * (frmTBanGrd.uorstMain_1Fil.Fields("SerDoc").DefinedSize + 1.5)
        End If
       Case 6
        .Item(dnNum).Caption = Choose(gsIdioma, "Numero", "Number")
        If proceso = False Then
        .Item(dnNum).Width = 90 * (frmTBanGrd.uorstMain_1.Fields("NroDoc").DefinedSize + 1)
        Else
        .Item(dnNum).Width = 90 * (frmTBanGrd.uorstMain_1Fil.Fields("NroDoc").DefinedSize + 1)
        End If
       Case 7
