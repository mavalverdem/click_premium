...
Private Sub cmdRevertir_Click()
 '[Datos del formulario de impresión.  'Cambiar.
  frmPReversion.Caption = Choose(gsIdioma, "Generar Reversión", "Generate Reverse")
  frmPReversion.Show vbModal
End Sub
Private Sub Form_Load()
 ...
 '[Recordsets                          'Cambiar.
   ...
   usConnStrgSele_1 = usConnStrgSele_1 & "COCpbDet.codmon, " '2016-02-02.07  correccion ple
...
'fin 2016-02-02.07  correccion ple
  ...
  If ps_Plataforma = pSrvMySql Then
    ...
    uocnnMain.Execute "CREATE TEMPORARY TABLE tmpCoCpbDetFjo LIKE CoCpbDetFjo"
...
'            .Item(dnNum).Width = 2200
            ...
            .Item(dnNum).Width = 100 * (uorstMain_0.Fields("GloCpb").DefinedSize - 6) - 50
         Case 4
