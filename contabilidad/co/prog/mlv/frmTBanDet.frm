...
Begin VB.Form frmTBanDet 
   ...
   Begin VB.TextBox txtDato2 
      ...
      Width           =   1275
   End
   Begin VB.CommandButton cmdDatoAyud2 
      Appearance      =   0  'Flat
      Caption         =   "..."
      Height          =   280
      Index           =   0
...
'ini 2016-02-02.12 correccion ple
...
'   End If
'fin 2016-02-02.12 correccion ple
     txtDato2(0).Text = IIf(cboTpoMon.ListIndex = TPOMON_NAC_IND, CODMON_NAC, CODMON_EXT) '2016-02-02.06  correccion ple
     ppAyuDet2 0
...
Private Sub chkPvsDoc_Click()
  ...
  If pbNuevo Then
    If chkPvsDoc.Value = vbChecked Then
      ...
      sSentencia = sSentencia & "AND fyhcre=" & IIf(sProcesoFyH = "", "Null", "'" & sProcesoFyH & "'") & ""
...
Private Sub cmdDatoAyud2_Click(Index As Integer)
...
'    txtDato(Index).SetFocus
'   End Select
  If (pnCta_IndCCo = INDCCO_ACT And Index = 1) Or Index <> 1 Then ppAyuBus2 Index
...
Private Sub Form_Load()
  ...
  With frmTBanGrd                     'Cambiar Formulario de Grid.
    ...
    '2016-02-02.12 correccion ple gpcbo_sunat_ins cboCodMon, frmTBanGrd.uorstCodMon '2016-02-02.07  correccion ple
      txtDato2(0).MaxLength = frmTBanGrd.uorstMain_1!codmon.DefinedSize
...
'   On Error GoTo Err
 ...
 '2016-02-02.12 correccion ple If cboCodMon.ListIndex = 0 Then MsgBox TEXT_6002, vbCritical:   cboCodMon.SetFocus: Exit Sub '2016-02-02.07  correccion ple
 If txtDato2(0).Text = "" Then MsgBox TEXT_6002, vbCritical: txtDato2(0).SetFocus: Exit Sub '2016-02-02.08  correccion ple
  ...
  With frmTBanGrd                     'Cambiar Formulario de Grid.
    ...
    sSqlexe = sSqlexe & "AND fyhcre=" & IIf(sProcesoFyH = "", "Null", "'" & sProcesoFyH & "'") & ""
...
''ini 2016-02-02.12 correccion ple
'   Case 11                           'Cambiar (añadir índices).
...
Private Sub ppAyuBus(tnIndex As Integer)
  ...
  Select Case tnIndex
   ...
   Case 5                              'Cambiar (añadir índices).
    ...
    cmdDatoAyud(tnIndex).Tag = cmdDatoAyud(tnIndex).Tag & "AND fyhcre=" & IIf(sProcesoFyH = "", "Null", "'" & sProcesoFyH & "'")
...
'ini 2016-02-02.12 correccion ple
'     Case 11   'codmon Cambiar (añadir índices).
'      Dim xxCodTabla As String
'      xxCodTabla = IIf(tnIndex = 11, CODSUNAT_004, xxCodTabla)
...
End Sub
'ini 2016-02-02.12 correccion ple
Private Sub ppAyuBus2(tnIndex As Integer)
  Select Case tnIndex                 'Cambiar.
   Case 0
      Dim xxCodTabla As String
      xxCodTabla = IIf(tnIndex = 0, CODSUNAT_004, xxCodTabla)
      modAyuBus.Sunat_Cod " estsunat ='" & ESTSUNAT_ACT & "' ", txtDato2(tnIndex).Text, 0, 0, Me.Top + txtDato2(tnIndex).Top + txtDato2(tnIndex).Height, Me.Left + txtDato2(tnIndex).Left, xxCodTabla
      txtDato2(tnIndex).Text = frmOAyuBus.uvDato1
      lblDatoDeta2(tnIndex).Caption = " " & frmOAyuBus.uvDato2
   End Select

End Sub
Private Function ppAyuDet2(tnIndex As Integer)
    If txtDato2(tnIndex).Text = "" Then
      lblDatoDeta2(tnIndex).Caption = ""
      Exit Function
    End If
  Select Case tnIndex                 'Cambiar.
   Case 0
        ...
        Set zxrst = IIf(tnIndex = 0, frmTBanGrd.uorstCodMon, zxrst)
         If gf_tb_sunat_seek(zxrst, txtDato2(tnIndex).Text, lblDatoDeta2(tnIndex)) Then
...
'         End If
'        Dim zxrst As Recordset
'        Set zxrst = IIf(tnIndex = 11, frmTBanGrd.uorstCodMon, zxrst)
...
'ini 2016-02-02.17 correccion ple
       frmTBanGrd.uorstMain_1!codmon = IIf(txtDato2(0).Text = "", Null, txtDato2(0).Text) '2016-02-02.08  correccion ple
'fin 2016-02-02.17 correccion ple
  ...
  With frmTBanGrd                     'Cambiar Formulario de Grid.
    If tnFase = 0 Then
      ...
      End If
        ...
        '2016-02-02.12 correccion plegp cbo_sunat_update cboCodMon, frmTBanGrd.uorstCodMon, "CodMon", 3, .uorstMain_1 '2016-02-02.07  correccion ple
       frmTBanGrd.uorstMain_1!codmon = IIf(txtDato2(0).Text = "", Null, txtDato2(0).Text) '2016-02-02.08  correccion ple
    ...
    Else
      ...
      End With
        ...
        '2016-02-02.12 correccion ple gpcbo_sunat_index cboCodMon, "CodMon", 3, .uorstMain_1 '2016-02-02.07  correccion ple
        txtDato2(0).Text = IIf(IsNull(frmTBanGrd.uorstMain_1!codmon), "", frmTBanGrd.uorstMain_1!codmon) ' 2016-02-02.08  correccion ple
        ppAyuDet2 0
...
Public Sub upDatosPredeterminados()    'Cambiar.
  ...
  End With
    ...
    '2016-02-02.12 correccion ple gpcbo_sunat_index2 cboCodMon, IIf(cboTpoMon.ListIndex = TPOMON_NAC_IND, CODMON_NAC, CODMON_EXT), 3 '2016-02-02.07  correccion ple
    txtDato2(0).Text = IIf(cboTpoMon.ListIndex = TPOMON_NAC_IND, CODMON_NAC, CODMON_EXT) '2016-02-02.06  correccion ple
    ppAyuDet2 0
...
'ini 2016-02-02.12 correccion ple
      .Item(dnContador).Enabled = tbHabilitar
'      If dnContador >= 6 And dnContador <= 10 Then
'      Else
'      .Item(dnContador).Enabled = tbHabilitar
'      End If
'fin 2016-02-02.12 correccion ple
  ...
  '2016-02-02.12 correccion ple cboCodMon.Enabled = tbHabilitar '2016-02-02.07  correccion ple
   txtDato2(0).Enabled = tbHabilitar 'fin 2016-02-02.03 correccion ple
   cmdDatoAyud2(0).Enabled = tbHabilitar
   lblDatoDeta2(0).Enabled = tbHabilitar
...
Private Sub txtDato2_KeyUp(Index As Integer, KeyCode As Integer, Shift As Integer)
  If KeyCode = vbKeyF2 Then
    ppAyuBus2 Index
  End If
End Sub
