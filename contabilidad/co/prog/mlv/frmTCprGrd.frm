...
Public uorstTpoBns As ADODB.Recordset
Public uorstCodMon As ADODB.Recordset
Public uorstPais As ADODB.Recordset
Public uorstCnveDobImpo As ADODB.Recordset
Public uorstTpoRta As ADODB.Recordset
...
Private Sub cmdGenera_Click()
  ...
  With porstCancel
    ...
    .Source = .Source & "cpr.codmon, " '2016-02-02.08  correccion ple
...
'ini 2016-02-02.03 correccion ple
  psConnStrgSele = psConnStrgSele & "COCprDoc.TpoBns, COCprDoc.CodMon,COCprDoc.PaisNoDomi,COCprDoc.PaisBenefi,"
  '2016-05-23 correccion ple compra psConnStrgSele = psConnStrgSele & "COCprDoc.CnveDobImpo, COCprDoc.TpoRta,COCprDoc.TasaReten,nrodociden,"
  psConnStrgSele = psConnStrgSele & "COCprDoc.CnveDobImpo, COCprDoc.TpoRta,COCprDoc.TasaReten,nrodociden,imptcb_inv,feedoc_inv, "
'fin 2016-02-02.03 correccion ple
  ...
  Set uorstcodetrac = New ADODB.Recordset '2015-07-02 adic tabla detrac
    ...
    'ini 2016-02-02-03  correccion ple
  Set uorstTpoBns = New ADODB.Recordset
  Set uorstCodMon = New ADODB.Recordset
  Set uorstPais = New ADODB.Recordset
  Set uorstCnveDobImpo = New ADODB.Recordset
  Set uorstTpoRta = New ADODB.Recordset
    'fin 2016-02-02-03 correccion ple
...
'aqui va con el selec de la compra,
'pero aqui recien retoma valores del cocpbdet
'en el proceso ppDatosWhere de frmTCpr
  With uorstCOCpbDet
     .ActiveConnection = uocnnMain
     .Source = psConnStrgSele & psConnStrgOrde
  '     .CursorLocation = adUseClient   'Es el Default.
...
'ini 2016-02-02-03  correccion ple
  ...
  With uorstTpoBns
     ...
     '.Source = fSqlTabla("030")
     '.Source = fSqlTabla(CODSUNAT_030) '2016-02-02.06  correccion ple
     .Source = gf_tb_sunat(CODSUNAT_030)
     .CursorType = adOpenDynamic
     .LockType = adLockOptimistic
     .Open
  End With
  ...
  With uorstPais
     '.ActiveConnection = uocnnMain
     .ActiveConnection = CONNSTRG & gsNomBDC
     '.Source = fSqlTabla("035")
     '.Source = fSqlTabla(CODSUNAT_035) '2016-02-02.06  correccion ple
     .Source = gf_tb_sunat(CODSUNAT_035)
     .CursorType = adOpenDynamic
     .LockType = adLockOptimistic
     .Open
  End With
  With uorstCnveDobImpo
     '.ActiveConnection = uocnnMain
     .ActiveConnection = CONNSTRG & gsNomBDC
     '.Source = fSqlTabla("025")
     '.Source = fSqlTabla(CODSUNAT_025) '2016-02-02.06  correccion ple
     .Source = gf_tb_sunat(CODSUNAT_025)
     .CursorType = adOpenDynamic
     .LockType = adLockOptimistic
     .Open
  End With
  With uorstTpoRta
     '.ActiveConnection = uocnnMain
     .ActiveConnection = CONNSTRG & gsNomBDC
     '.Source = fSqlTabla("031")
     .Source = gf_tb_sunat(CODSUNAT_031) '2016-02-02.06  correccion ple
     '.Source = fSqlTabla(CODSUNAT_031)
     .CursorType = adOpenDynamic
     .LockType = adLockOptimistic
     .Open
  End With
...
'se borro para ponerlo en gf_tb_sunat asi servira para ventas la funcion
'Private Function fSqlTabla(xCodTabla As String) As String
...
'ini 2016-02-02.06  correccion ple
    Set uorstTpoBns = Nothing
    Set uorstCodMon = Nothing
    Set uorstPais = Nothing
    Set uorstCnveDobImpo = Nothing
    Set uorstTpoRta = Nothing
'fin 2016-02-02.06  correccion ple
