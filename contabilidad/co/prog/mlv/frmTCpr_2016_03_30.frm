...
Begin VB.Form frmTCpr 
   ...
   Begin TabDlg.SSTab sstMain 
      ...
      Tab(3).Control(15)=   "txtDato2(0)"
      Tab(3).Control(15).Enabled=   0   'False
      Tab(3).Control(16)=   "cmdDatoAyud(62)"
      Tab(3).Control(16).Enabled=   0   'False
      Tab(3).Control(17)=   "txtDato(62)"
      Tab(3).Control(17).Enabled=   0   'False
      Tab(3).Control(18)=   "cmdDatoAyud(63)"
      Tab(3).Control(18).Enabled=   0   'False
      Tab(3).Control(19)=   "txtDato(63)"
      Tab(3).Control(19).Enabled=   0   'False
      Tab(3).Control(20)=   "cmdDatoAyud(64)"
      Tab(3).Control(20).Enabled=   0   'False
      Tab(3).Control(21)=   "txtDato(64)"
      Tab(3).Control(21).Enabled=   0   'False
      Tab(3).Control(22)=   "cmdDatoAyud(65)"
      Tab(3).Control(22).Enabled=   0   'False
      Tab(3).Control(23)=   "txtDato(65)"
      Tab(3).Control(23).Enabled=   0   'False
      Tab(3).Control(24)=   "cmdDatoAyud(66)"
      Tab(3).Control(24).Enabled=   0   'False
      Tab(3).Control(25)=   "txtDato(66)"
      Tab(3).Control(25).Enabled=   0   'False
      Tab(3).Control(26)=   "cmdDatoAyud(67)"
      Tab(3).Control(26).Enabled=   0   'False
      Tab(3).Control(27)=   "txtDato(67)"
      Tab(3).Control(27).Enabled=   0   'False
      Tab(3).Control(28)=   "cmdDatoAyud(61)"
      Tab(3).Control(28).Enabled=   0   'False
      Tab(3).Control(29)=   "txtDato(61)"
...
Private Sub pComboUpdate(xcombo As ComboBox, xrst As Recordset, xCampo, xCampoLen As Integer)
         With xrst
            ...
            Else
               ...
               'xrst!pctdetrac = IIf(cboDetraccion.ListIndex = 0, 0#, !pctdetrac)
           End If
         End With
End Sub
...
'    cboTpoRta.ListIndex = 0
   ...
   txtDato(62).Text = "" 'fin 2016-02-02.03 correccion ple
   txtDato(63).Text = "" 'fin 2016-02-02.03 correccion ple
