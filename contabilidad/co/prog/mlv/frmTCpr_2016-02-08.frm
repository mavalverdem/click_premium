...
Begin VB.Form frmTCpr 
   ...
   Begin TabDlg.SSTab sstMain 
      ...
      Tab(3).Control(7)=   "cboTpoBns"
      Tab(3).Control(7).Enabled=   0   'False
      Tab(3).Control(8)=   "cboCodMon"
      Tab(3).Control(8).Enabled=   0   'False
      Tab(3).Control(9)=   "cboPaisNoDomi"
      Tab(3).Control(9).Enabled=   0   'False
      Tab(3).Control(10)=   "cboPaisBenefi"
      Tab(3).Control(10).Enabled=   0   'False
      Tab(3).Control(11)=   "cboCnveDobImpo"
      Tab(3).Control(11).Enabled=   0   'False
      Tab(3).Control(12)=   "cboTpoRta"
      Tab(3).Control(12).Enabled=   0   'False
      Tab(3).Control(13)=   "txtDato2(0)"
      ...
      Begin VB.ComboBox cboTpoRta 
         ...
         Width           =   5085
      End
      Begin VB.ComboBox cboCnveDobImpo 
         Height          =   315
         Left            =   1860
         Style           =   2  'Dropdown List
         TabIndex        =   230
         ...
         Width           =   5085
      End
      Begin VB.ComboBox cboPaisBenefi 
         Height          =   315
         Left            =   1860
         Style           =   2  'Dropdown List
         TabIndex        =   228
         ...
         Width           =   5085
      End
      Begin VB.ComboBox cboPaisNoDomi 
         Height          =   315
         Left            =   1860
         Style           =   2  'Dropdown List
         TabIndex        =   226
...
'fin 2016-02-02.03 correccion ple
   ...
   cmdDatoAyud(61).Enabled = tbHabilitar
   lblDatoDeta(61).Enabled = tbHabilitar
