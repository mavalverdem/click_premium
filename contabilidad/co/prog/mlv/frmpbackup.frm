...
Begin VB.Form frmPBackup 
   ...
   Begin TabDlg.SSTab tabProceso 
      ...
      Tab(0).Control(4)=   "chkactivar_todos"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).ControlCount=   5
      Begin VB.CheckBox chkactivar_todos 
         Caption         =   "Activa o Desactiva todo"
         Height          =   240
         Left            =   2640
         TabIndex        =   51
         Top             =   0
...
Private Sub chkactivar_todos_Click()
    Dim nContador As Integer
    If optProceso(1).Value Then
        If chkProceso.Value Then
            MsgBox ("No se puede aplicar, por que Restore General esta activado")
            chkactivar_todos.Value = 1
            Exit Sub
        End If
    End If
    For nContador = 0 To chkImporTabla.Count - 1
        chkImporTabla(nContador).Value = chkactivar_todos.Value
        'chkImporProceso
        If nContador < 8 Then
        chkImporProceso(nContador).Value = chkactivar_todos.Value
        End If
    Next
...
Private Sub cmdAceptar_Click()
 ...
 '   On Error GoTo Err
  ...
  plEliminar = True
  'Shell "cmd /K cd\ & cd " & "C:\Program Files\MySQL\MySQL Server 5.7\bin\" & " & mysqldump --complete-insert --host=" & ps_Servidor & " --user=" & ps_UserId & " --password=" & ps_Password & " sysmaban > " & "E:\MIGUEL\LucyAri\backup\sysmaban" & Year(Date) & Month(Date) & Day(Date) & ".bsql" & " & exit "
...
'ini 2015-08-10 adicionar detrac
...
'      aWhere = Choose(nContador + 1, Array("S"), Array("N"), Array("S"), Array("N", "N"), Array("N"), Array("S"), Array("S", "S"), Array("N", "S"), Array("S", "S"), Array("S", "S", "S"), Array("S", "S", "S", "S"), Array("S", "S"), Array("N"), Array("N", "N", "N", "N"))
      aTabla = Choose(nContador + 1, Array("CoDro"), Array("cobco"), Array("CoCta"), Array("TgAux", "TgAuxNat"), Array("TgTDc"), Array("CoCCo"), Array("CoEfe", "CoFjo"), Array("TgTcb", "CoTcbMes"), Array("TgCfg", "CoCfg"), Array("CoEFi", "CoEFiLin", "CoPsp"), Array("CoCCoCfg", "CoCieMes", "cofil", "cofildet"), Array("coasitipo", "coasidet"), Array("codpe"), Array("coctaban", "bnmediopago", "rangoimpresion", "colib"), Array("CoDetrac"))
      aWhere = Choose(nContador + 1, Array("S"), Array("N"), Array("S"), Array("N", "N"), Array("N"), Array("S"), Array("S", "S"), Array("N", "S"), Array("S", "S"), Array("S", "S", "S"), Array("S", "S", "S", "S"), Array("S", "S"), Array("N"), Array("N", "N", "N", "N"), Array("N"))
'fin 2015-08-10 adicionar detrac
      For nSecuencia = UBound(aTabla, 1) To 0 Step -1
...
'fin 2015-08-10 adicionar detrac
         ...
         aArchivo = Choose(nContador + 1, Array("dro"), Array("bco"), Array("pct"), Array("aux", "nat"), Array("tdc"), Array("cco"), Array("fef", "fjo"), Array("tpc", "tcm"), Array("cfg", "cfe"), Array("dpe"), Array("rpt", "cms", "fic", "fid"), Array("asi", "asd"), Array("efi", "cef", "psp"), Array("ot1", "ot2", "ot3", "ot4"), Array("ot51"))
        '2015-08-04 verificar estructura de la base de datos aColumnas = Choose(nContador + 1, Array(24), Array(12), Array(35), Array(19, 11), Array(11), Array(11), Array(10, 11), Array(10, 10), Array(15, 36), Array(9), Array(13, 7, 10, 28), Array(10, 13), Array(11, 24, 33), Array(11, 10, 5, 8))
        aTabla = Choose(nContador + 1, Array("CoDro"), Array("cobco"), Array("CoCta"), Array("TgAux", "TgAuxNat"), Array("TgTDc"), Array("CoCCo"), Array("CoEfe", "CoFjo"), Array("TgTcb", "CoTcbMes"), Array("TgCfg", "CoCfg"), Array("codpe"), Array("CoCCoCfg", "CoCieMes", "cofil", "cofildet"), Array("coasitipo", "coasidet"), Array("CoEFi", "CoEFiLin", "CoPsp"), Array("coctaban", "bnmediopago", "rangoimpresion", "colib"), Array("codetrac"))
        aWhere = Choose(nContador + 1, Array("AND pdoano='" & gsAnoAct & "'"), Array(""), Array("AND pdoano='" & gsAnoAct & "'"), Array("", ""), Array(""), Array("AND pdoano='" & gsAnoAct & "'"), Array("AND pdoano='" & gsAnoAct & "'", "AND pdoano='" & gsAnoAct & "'"), Array("", "AND pdoano='" & gsAnoAct & "'"), Array("AND pdoano='" & gsAnoAct & "'", "AND pdoano='" & gsAnoAct & "'"), Array(""), Array("AND pdoano='" & gsAnoAct & "'", "AND pdoano='" & gsAnoAct & "'", "AND pdoano='" & gsAnoAct & "'", "AND pdoano='" & gsAnoAct & "'"), Array("AND pdoano='" & gsAnoAct & "'", "AND pdoano='" & gsAnoAct & "'"), Array("AND pdoano='" & gsAnoAct & "'", "AND pdoano='" & gsAnoAct & "'", "AND pdoano='" & gsAnoAct & "'"), Array("", "", "", ""), Array(""))
...
'''fin 2015-08-04 verificar estructura de la base de datos
        ...
        For nSecuencia = 0 To UBound(aArchivo, 1)
          ...
          '2016-06-08 rcs moentaneo para probar en fisico
          sSentencia = IIf(ps_Plataforma = pSrvMySql, "CREATE TEMPORARY TABLE IF NOT EXISTS tmp" & aTabla(nSecuencia) & " ", "")
          '2016-06-30 solo se poner para revisar el tempora en fisico sSentencia = IIf(ps_Plataforma = pSrvMySql, "CREATE TABLE IF NOT EXISTS tmp" & aTabla(nSecuencia) & " ", "")
...
'        aClave = Choose(nContador + 1, Array("CodDro"), Array("codbco"), Array("CodCta"), Array("CodAux", "CodAux"), Array("CodTDc"), Array("CodCCo"), Array("CodEfe", "CodFjo"), Array("FehTCb", "MesPvs"), Array("pdoano", "pdoano"), Array("coddpe"), Array("NumOrd", "MesCie", "codfil", "codfil"), Array("codasi", "codasi"), Array("CodEfi", "CodEfi", "CodCta"), Array("codbco", "codmed", "codemp", "codlib"))
        ...
        aArchivo = Choose(nContador + 1, Array("dro"), Array("bco"), Array("pct"), Array("aux", "nat"), Array("tdc"), Array("cco"), Array("fef", "fjo"), Array("tpc", "tcm"), Array("cfg", "cfe"), Array("dpe"), Array("rpt", "cms", "fic", "fid"), Array("asi", "asd"), Array("efi", "cef", "psp"), Array("ot1", "ot2", "ot3", "ot4"), Array("ot51"))
        aTabla = Choose(nContador + 1, Array("CoDro"), Array("cobco"), Array("CoCta"), Array("TgAux", "TgAuxNat"), Array("TgTDc"), Array("CoCCo"), Array("CoEfe", "CoFjo"), Array("TgTcb", "CoTcbMes"), Array("TgCfg", "CoCfg"), Array("codpe"), Array("CoCCoCfg", "CoCieMes", "cofil", "cofildet"), Array("coasitipo", "coasidet"), Array("CoEFi", "CoEFiLin", "CoPsp"), Array("coctaban", "bnmediopago", "rangoimpresion", "colib"), Array("codetrac"))
        aClave = Choose(nContador + 1, Array("CodDro"), Array("codbco"), Array("CodCta"), Array("CodAux", "CodAux"), Array("CodTDc"), Array("CodCCo"), Array("CodEfe", "CodFjo"), Array("FehTCb", "MesPvs"), Array("pdoano", "pdoano"), Array("coddpe"), Array("NumOrd", "MesCie", "codfil", "codfil"), Array("codasi", "codasi"), Array("CodEfi", "CodEfi", "CodCta"), Array("codbco", "codmed", "codemp", "codlib"), Array("coddetrac"))
'fin 2015-08-10 adicionar detrac
...
'        aOrden = Choose(nContador + 1, Array("a.CodDro"), Array("a.codbco"), Array("a.CodCta"), Array("a.CodAux", "a.CodAux"), Array("a.CodTDc"), Array("a.CodCCo"), Array("a.CodEfe", "a.CodFjo"), Array("a.FehTCb", "a.MesPvs"), Array("a.pdoano, a.MesAtu", "a.pdoano, a.MesAtu"), Array("a.coddpe"), Array("a.NumOrd, a.CodCCo", "a.MesCie", "a.codfil", "a.codfil, a.nrolin"), Array("a.CodAsi", "a.CodAsi, a.TpoCnc, a.Codcta_mn, a.orden"), Array("a.CodEfi", "a.CodEfi, a.NroLin", "a.CodCta"), Array("a.codaux,a.codbco,a.tpocta,a.tpomon", "a.codmed", "a.proceso", "a.codlib"))
        aTabla = Choose(nContador + 1, Array("CoDro"), Array("cobco"), Array("CoCta"), Array("TgAux", "TgAuxNat"), Array("TgTDc"), Array("CoCCo"), Array("CoEfe", "CoFjo"), Array("TgTcb", "CoTcbMes"), Array("TgCfg", "CoCfg"), Array("codpe"), Array("CoCCoCfg", "CoCieMes", "cofil", "cofildet"), Array("coasitipo", "coasidet"), Array("CoEFi", "CoEFiLin", "CoPsp"), Array("coctaban", "bnmediopago", "rangoimpresion", "colib"), Array("codetrac"))
        aJoin = Choose(nContador + 1, Array("b.CodDro=a.CodDro"), Array("b.codbco=a.codbco"), Array("b.CodCta=a.CodCta"), Array("b.CodAux=a.CodAux", "b.CodAux=a.CodAux"), Array("b.CodTdc=a.CodTdc"), Array("b.CodCCo=a.CodCCo"), Array("b.CodEfe=a.CodEfe", "b.CodFjo=a.CodFjo"), Array("b.FehTcb=a.FehTcb", "b.MesPvs=a.MesPvs"), Array("", ""), Array("b.coddpe=a.coddpe"), Array("b.TipoFmt=a.TipoFmt AND b.NumOrd=a.NumOrd AND b.CodCCo=a.CodCCo", "b.MesCie=a.MesCie", "b.codfil=a.codfil", "b.codfil=a.codfil AND b.nrolin=a.nrolin"), Array("a.codemp=b.codemp AND a.CodAsi=b.CodAsi", "a.codemp=b.codemp AND a.CodAsi=b.CodAsi AND a.TpoCnc=b.TpoCnc AND a.codcta_mn=b.codcta_mn AND a.orden=b.orden"), Array("b.CodEfi=a.CodEfi", "b.CodEfi=a.CodEfi AND b.NroLin=a.NroLin", "b.CodCta=a.CodCta"), Array("a.codaux=b.codaux and a.codbco=b.codbco and a.tpocta=b.tpocta and a.tpomon=b.tpomon ", "a.codmed=b.codmed", "a.proceso=b.proceso and a.valor=b.valor", "a.codlib=b.codlib"), Array("b.CodDetrac=a.CodDetrac"))
        aWhere = Choose(nContador + 1, Array("a.CodDro"), Array("a.codbco"), Array("a.CodCta"), Array("a.CodAux", "a.CodAux"), Array("a.CodTDc"), Array("a.CodCCo"), Array("a.CodEfe", "a.CodFjo"), Array("a.FehTCb", "a.MesPvs"), Array("a.MesAtu", "a.MesAtu"), Array("a.coddpe"), Array("a.NumOrd, a.CodCCo", "a.MesCie", "a.codfil", "a.codfil, a.nrolin"), Array("a.CodAsi", "a.CodAsi, a.TpoCnc, a.Codcta_mn, RTrim(a.orden)"), Array("a.CodEfi", "a.CodEfi, a.NroLin", "a.CodCta"), Array("a.codbco", "a.codmed", "a.proceso", "a.codlib"), Array("a.CodDetrac"))
        aPeriodo = Choose(nContador + 1, Array("S"), Array("N"), Array("S"), Array("N", "N"), Array("N"), Array("S"), Array("S", "S"), Array("N", "S"), Array("S", "S"), Array("N"), Array("S", "S", "S", "S"), Array("S", "S"), Array("S", "S", "S"), Array("N", "N", "N", "N"), Array("N"))
        aOrden = Choose(nContador + 1, Array("a.CodDro"), Array("a.codbco"), Array("a.CodCta"), Array("a.CodAux", "a.CodAux"), Array("a.CodTDc"), Array("a.CodCCo"), Array("a.CodEfe", "a.CodFjo"), Array("a.FehTCb", "a.MesPvs"), Array("a.pdoano, a.MesAtu", "a.pdoano, a.MesAtu"), Array("a.coddpe"), Array("a.NumOrd, a.CodCCo", "a.MesCie", "a.codfil", "a.codfil, a.nrolin"), Array("a.CodAsi", "a.CodAsi, a.TpoCnc, a.Codcta_mn, a.orden"), Array("a.CodEfi", "a.CodEfi, a.NroLin", "a.CodCta"), Array("a.codaux,a.codbco,a.tpocta,a.tpomon", "a.codmed", "a.proceso", "a.codlib"), Array("a.CodDetrac"))
...
optProceso(0).Value = vbChecked
  ...
  For nElemento = 0 To chkImporTabla.Count - 1
    If gsIdioma = NvlUsr_Sup Then
      '2015-08-10 adicionar detrac chkImporTabla(nElemento).Caption = Choose(nElemento + 1, "&Diario", "&Bancos", "&Plan de Cuentas", "&Auxiliares", "&Tipo de Documentos", "&Centro de Costo", "&Flujo de Caja/Efectivo", "Tipo de Ca&mbio", "Ta&bla de Configuración", "&EE Financieros Presupuesto", "Configuración &Reportes", "A&siento Tipo", "&Proyecto", "&Otros")
      chkImporTabla(nElemento).Caption = Choose(nElemento + 1, "&Diario", "&Bancos", "&Plan de Cuentas", "&Auxiliares", "&Tipo de Documentos", "&Centro de Costo", "&Flujo de Caja/Efectivo", "Tipo de Ca&mbio", "Ta&bla de Configuración", "&EE Financieros Presupuesto", "Configuración &Reportes", "A&siento Tipo", "&Proyecto", "&Otros", "&Otros 2")
    Else
      '2015-08-10 adicionar detrac chkImporTabla(nElemento).Caption = Choose(nElemento + 1, "&Journal", "&Banks", "&Plan of Account", "&Auxiliaries", "&Type of Documents", "&Cost Center", "Cash/Money &Flow", "&Rate of Exchange", "Ta&ble of Configutaion", "Financial &Statement, Budget", "Configuraton &Reports", "&Standar Recorded", "&Project", "&Other")
      chkImporTabla(nElemento).Caption = Choose(nElemento + 1, "&Journal", "&Banks", "&Plan of Account", "&Auxiliaries", "&Type of Documents", "&Cost Center", "Cash/Money &Flow", "&Rate of Exchange", "Ta&ble of Configutaion", "Financial &Statement, Budget", "Configuraton &Reports", "&Standar Recorded", "&Project", "&Other", "&Other 2")
   End If
  Next nElemento
