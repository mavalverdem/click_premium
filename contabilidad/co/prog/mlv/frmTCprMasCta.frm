...
Begin VB.Form frmTCprMasCta 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdSalir 
         ...
         Height          =   560
         Left            =   2690
         Picture         =   "frmTCprMasCta.frx":01AA
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   60
         Width           =   720
      ...
      Begin VB.CommandButton cmdDeshacer 
         ...
         Height          =   560
         Left            =   1950
         Picture         =   "frmTCprMasCta.frx":02F4
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   60
         Width           =   720
      ...
      Begin VB.CommandButton cmdGrabar 
         ...
         Height          =   560
         Left            =   1220
         Picture         =   "frmTCprMasCta.frx":03F6
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   60
         Width           =   720
      ...
      Begin VB.CommandButton cmdCorregir 
         ...
         Height          =   560
         Left            =   480
         Picture         =   "frmTCprMasCta.frx":04F8
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   60
         Width           =   720
   ...
   Begin VB.CommandButton cmdDatoAyud 
      ...
      Index           =   0
      Left            =   7305
      Picture         =   "frmTCprMasCta.frx":0996
      Style           =   1  'Graphical
      TabIndex        =   21
      TabStop         =   0   'False
      Top             =   135
...
Private Sub Form_Load()
   ...
   With frmTCprGrd                     'Cambiar Formulario de Grid.
    '[Datos                            'Cambiar.
      ...
      txtDato(Choose(gsIdioma, 3, 5)).MaxLength = .uorstCOCprDocCta!glodet.DefinedSize
      txtDato(Choose(gsIdioma, 5, 3)).MaxLength = .uorstCOCprDocCta!glodetx.DefinedSize
    ...
    If Len(Trim(txtDato(Index).Text)) <> 0 Then
      ...
      With frmTCprGrd.uorstCOCprDocCta
         If Not (.BOF Or .EOF) And .RecordCount > 0 Then
            ...
            .MoveFirst
            .Find "cLlave2='" & frmTCpr.txtLlave(0).Text & frmTCpr.txtLlave(1).Text & frmTCpr.txtLlave(2).Text & frmTCpr.txtLlave(3).Text & frmTCprMasGrd.unIndice & ps_OrdCuenta & txtDato(0).Text & "'"
            If Not .EOF Then
     ...
     If Len(Trim(txtDato(Index).Text)) <> 0 Then
       ...
       With frmTCprGrd.uorstCOCprDocCta
          If Not (.BOF Or .EOF) And .RecordCount > 0 Then
             dvRegistroActual = .Bookmark
             .MoveFirst
             .Find "cLlave2='" & frmTCpr.txtLlave(0).Text & frmTCpr.txtLlave(1).Text & frmTCpr.txtLlave(2).Text & frmTCpr.txtLlave(3).Text & frmTCprMasGrd.unIndice & ps_OrdCuenta & txtDato(4).Text & "'"
             If Not .EOF Then
                MsgBox TEXT_8007, vbExclamation
                If dvRegistroActual <> -1 Then .Bookmark = dvRegistroActual
                Cancel = True
...
'///Envio de valor desde la pantalla de inicio de registro
   If pbNuevo Then
      txtDato(3).Text = frmTCpr.txtDato(3).Text
'ini 12-09-2016 corrige glosa vta
'      txtDato(5).Text = frmTCpr.txtDato(44).Text
      txtDato(5).Text = frmTCpr.txtDato(49).Text
'fin 12-09-2016 corrige glosa vta
      ...
      Else
         txtDato(2).Text = Format(frmTCpr.txtDato(frmTCprMasGrd.unIndice + 15).Text, FORMATO_NUM_1)
      End If
      With frmTCprGrd.uorstCOCprDocCta
