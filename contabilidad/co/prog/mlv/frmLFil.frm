...
'     .CursorLocation = adUseClient   'Es el Default.
   ...
   With porstCoFil
      .ActiveConnection = pocnnMain
      .Source = "SELECT codfil, " & Choose(gsIdioma, "detfil", "detfilx") & " AS detfil "
...
'     .CursorLocation = adUseClient   'Es el Default.
 ...
 '[Parámetros.                         'Cambiar.
   With txtDato
      For dnContador = 0 To 1
         .Item(dnContador).DataField = "codfil"
         .Item(dnContador).MaxLength = porstCoFil.Fields(.Item(dnContador).DataField).DefinedSize
      Next
   End With
 ']
  ...
  Next nElemento
  fraRangos.Caption = Choose(gsIdioma, "Estructura de Archivos", "Structure Files")
 ...
 '[Datos predeterminados.              'Cambiar.
  'Límites de rangos.
   With porstCoFil
      .MoveLast
      txtDato(1).Text = !codfil
      .MoveFirst
      txtDato(0).Text = !codfil
   End With
...
Private Sub cmdImprimir_Click(Index As Integer)
  ...
  With porstMRp
    ...
    .Source = "SELECT a.codfil, " & Choose(gsIdioma, "a.detfil", "a.detfilx") & " AS detfil, b.nrolin, "
    ...
    .Source = .Source & "FROM cofil a "
    .Source = .Source & "LEFT JOIN cofildet b ON a.codemp=b.codemp AND a.pdoano=b.pdoano AND a.codfil=b.codfil "
    .Source = .Source & "WHERE a.codemp='" & gsCodEmp & "' "
    .Source = .Source & "AND a.pdoano='" & gsAnoAct & "' "
    .Source = .Source & "AND a.codfil BETWEEN '" & txtDato(0).Text & "' AND '" & txtDato(1).Text & "' "
  ...
  If usDEstino = PRN_DEST_GRAF Then
    ...
    With frmMain.rptMain
      ...
      .ReportFileName = gsRutRpt & "rptLFil.rpt"
  ...
  Else
    ...
    With MRViewer
      ...
      .LoadReport gsRutRpt & "rptLFil.mrp"
...
Private Sub ppAyuBus(tnIndex As Integer)
   Select Case tnIndex
   Case 0, 1                           'Cambiar (añadir índices).
      modAyuBus.Fil_Cod "", txtDato(tnIndex).Text, 0, 0, Me.Top + fraRangos.Top + txtDato(tnIndex).Top + txtDato(tnIndex).Height, Me.Left + fraRangos.Left + txtDato(tnIndex).Left
...
Private Function ppAyuDet(tnIndex As Integer)
   ...
   Case 0, 1
      ...
      With porstCoFil
         .MoveFirst
         .Find "codfil='" & txtDato(tnIndex).Text & "'"
         If .EOF Then
            MsgBox TEXT_8006, vbExclamation
            ppAyuDet = True
         Else
            lblDatoDeta(tnIndex).Caption = " " & !detfil
         End If
      End With
   End Select
End Function
