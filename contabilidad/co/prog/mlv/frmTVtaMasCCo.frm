    ...
    If Len(Trim(txtDato(Index).Text)) <> 0 Then
      ...
      With frmTVtaGrd.uorstCOVtaDocCCo
         If Not (.BOF Or .EOF) And .RecordCount > 0 Then
            ...
            .MoveFirst
            .Find "cLlave2='" & frmTVta.txtLlave(0).Text & frmTVta.txtLlave(1).Text & frmTVta.txtLlave(2).Text & frmTVtaMasGrd.unIndice & frmTVtaGrd.uorstCOVtaDocCta!orden & frmTVtaMasGrd.dgrMain.Columns(0).Text & txtDato(0).Text & "'"
            If Not .EOF Then
      ...
      If tnFase = 0 Then
        'Llaves.
         If pbNuevo Then
            ...
            !orden = frmTVtaGrd.uorstCOVtaDocCta!orden
