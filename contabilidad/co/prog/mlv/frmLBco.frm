...
'     .CursorLocation = adUseClient   'Es el Default.
   ...
   With porstCoBco
      .ActiveConnection = pocnnMain
      .Source = "SELECT codbco, "
      .Source = .Source & Choose(gsIdioma, "detbco ", "detbcox ") & "AS detbco "
...
'     .CursorLocation = adUseClient   'Es el Default.
 ...
 ']
  ...
  For nElemento = 0 To UBound(aLabel, 1) - 1
    aLabel(nElemento, 0) = Choose(nElemento + 1, "Bancos")
    aLabel(nElemento, 1) = Choose(nElemento + 1, "Banks")
  Next nElemento
...
Private Sub cmdImprimir_Click(Index As Integer)
  ...
  With porstMRp
    ...
    .Source = "SELECT codbco, " & Choose(gsIdioma, "detbco", "detbcox") & " AS detbco, codent "
    .Source = .Source & "FROM cobco "
    .Source = .Source & "WHERE codemp='" & gsCodEmp & "' "
    .Source = .Source & "AND codbco BETWEEN '" & txtDato(0).Text & "' AND '" & txtDato(1).Text & "' "
  ...
  If usDEstino = PRN_DEST_GRAF Then
    ...
    With frmMain.rptMain
      ...
      .ReportFileName = gsRutRpt & "rptLBco.rpt"
  ...
  Else
    ...
    With MRViewer
      ...
      .LoadReport gsRutRpt & "rptLBco.mrp"
