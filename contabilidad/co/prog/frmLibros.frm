...
toolbar.Buttons(1).ButtonMenus(29).Text = "Formato 8.1.1: Registro de Compras (A3) - SIRE SUNAT"
toolbar.Buttons(1).ButtonMenus(30).Text = "Formato 8.1.2: Registro de Compras (A4) - SIRE SUNAT"
'toolbar.Buttons(1).ButtonMenus(30).Text = "-"
toolbar.Buttons(1).ButtonMenus(31).Text = "Formato 14.1 : Registro de Ventas - SIRE SUNAT"
...
Private Sub ppArchivoElectronico(ByVal sArchivo As String, ByVal sNombreArchivo As String, ByVal sSentencia As String)
  ...
  Dim n_SdoDeb As Double, n_SdoHab As Double
...
'error option explict
    ...
    ' Genero archivo comprimido
    gpComprimirArchivo sArchivo
  End If
  GoTo Finalizar
...
'ini 2015-06-27 cambio ple libros 8.1 y 8.2
    sSentencia = sSentencia & "IFNULL(case com.codtdc when '50' then com.codaduana else com.serdoc end, '-') as serdoc, "
'fin 2015-06-27 cambio ple libros 8.1 y 8.2
...
'    Else
'        '2015-04-29 elimina segun teo sSentencia = sSentencia & "AND com.codtdc IN('00','91','97','98') "
'        sSentencia = sSentencia & "AND com.codtdc IN('91','97','98') "
'    End If
...
'ini 2015-09-16 t.cam solo ME
    ...
    sSentencia = sSentencia & "com.nrocdt, com.fehcdt,"
    '2016-05-23/25 correccion ple compra  sSentencia = sSentencia & "CASE tpomon WHEN '" & TPOMON_EXT & "' THEN com.imptcb ELSE 0 END imptcb,"
    sSentencia = sSentencia & "CASE tpomon WHEN '" & TPOMON_EXT & "' THEN com.imptcb_inv ELSE 0 END imptcb_inv,"
    sSentencia = sSentencia & "com.feedoc_ref, com.codtdc_ref, com.serdoc_ref, com.nrodoc_ref, com.indreten, '" & sMoneda & "' as Moneda "
...
'fin 2016-02-02.05 correccion ple
    sSentencia = sSentencia & ", date_format(com.fehope,'%d/%m/%Y') as fehope " '215-08-10 adicionado por teo
    sSentencia = sSentencia & ", date_format(com.feedoc_inv,'%d/%m/%Y') as feedoc_inv " '2016-06-06 error campo no existe, si esta en el arc plano
'ini 2015-06-27 cambio ple libros 8.1 y 8.2
    sSentencia = sSentencia & ",impbasref_mn,impigvref_mn,codtdc_ref "
'fin 2015-06-27 cambio ple libros 8.1 y 8.2
    sSentencia = sSentencia & "FROM cocprdoc com "
    sSentencia = sSentencia & "INNER JOIN tgaux aux ON com.nrodociden=aux.codaux and aux.codemp='" & gsCodEmp & "' "
    sSentencia = sSentencia & "INNER JOIN tgtdc tdc ON com.codemp=tdc.codemp and com.codtdc=tdc.codtdc and tdc.codemp='" & gsCodEmp & "' "
    sSentencia = sSentencia & "WHERE com.codemp='" & gsCodEmp & "' AND com.pdoano='" & gsAnoAct & "' AND mespvs='" & xqmes & "' "
'ini 2015-04-29 elimina segun teo

'ini 2016-07-13 pidio corregir no estuvo de acuerdo con el cambio
''''ini 2016-05-11 corregido nuevament por teo volvio a su estado original
''''    If xFiltro = 1 Then
''''        sSentencia = sSentencia & "AND NOT com.codtdc_ref IN('91','97','98') "
''''    Else
'''        sSentencia = sSentencia & "AND com.codtdc_ref IN('00','91','97','98') "
''''    End If
''''fin 2016-05-11 corregido nuevament por teo volvio a su estado original
'fin 2016-07-13 pidio corregir no estuvo de acuerdo con el cambio
...
''        sSentencia = sSentencia & "AND com.codtdc IN('91','97','98') "
''    End If
'fin 2015-04-29 elimina segun teo
...
Private Function fAE_08_2_reg_cpr(xNroCorr As Long) As String
  ...
  ' 1: periodo
  s_Expresion = gsAnoAct & Left(cmbEjercicio.Text, 2)
  psRegistro = psRegistro & s_Expresion & s_Caracter
  ...
  ' 4: Tipo de Comprobante de Pago o Documento del sujeto no domiciliado
  s_Expresion = porstMRp!codtdc
  psRegistro = psRegistro & s_Expresion & s_Caracter
  ...
  ' 6: Número del comprobante de pago o documento.
  s_Expresion = porstMRp!nrodoc
  psRegistro = psRegistro & s_Expresion & s_Caracter
  ...
  s_Expresion = IIf(porstMRp!codtdc = "50" And porstMRp!codtdc_ref = "91", porstMRp!impbasref_mn, s_Expresion)
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 10: tipo comprobante de pago
  s_Expresion = Format(IIf(porstMRp!codtdc = "91", porstMRp!codtdc_ref, ""), "00")
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 11: serie comprobante de pago
  's_Expresion = IIf(porstMRp!codtdc = "05", Right(porstMRp!serdoc, 1), porstMRp!serdoc) '2014-07-16
  '2016-07-13 correcion en la molina s_Expresion = IIf(porstMRp!codtdc = "91", "", porstMRp!serdoc) '2014-07-16
  
  s_Expresion = IIf(IsNull(porstMRp!serdoc_ref), "", porstMRp!serdoc_ref)
  's_Expresion = IIf(porstMRp!codtdc_ref = "91", porstMRp!serdoc_ref, s_Expresion)
  s_Expresion = IIf(porstMRp!codtdc_ref = "46", porstMRp!serdoc_ref, s_Expresion)
  s_Expresion = IIf(porstMRp!codtdc_ref = "50", Right(porstMRp!serdoc_ref, 3), s_Expresion)
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 12: año emision DUA
  '2016-07-13 correcion en la molina s_Expresion = IIf(IsNull(porstMRp!anno), "0", porstMRp!anno)
  s_Expresion = IIf(porstMRp!codtdc_ref = "50", porstMRp!anno, "0")
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 13: numero comprobante de pago
  ...
  s_Expresion = IIf(porstMRp!codtdc_ref = "01" _
  Or porstMRp!codtdc_ref = "03" _
  Or porstMRp!codtdc_ref = "04" _
  Or porstMRp!codtdc_ref = "06" _
  Or porstMRp!codtdc_ref = "07" _
  Or porstMRp!codtdc_ref = "08", Right(porstMRp!nrodoc_ref, 7), _
  IIf(porstMRp!codtdc_ref = "91", "", porstMRp!nrodoc_ref))
  
  s_Expresion = IIf(porstMRp!codtdc_ref = "46", porstMRp!nrodoc_ref, s_Expresion)
  s_Expresion = IIf(porstMRp!codtdc_ref = "50", Right(porstMRp!nrodoc_ref, 6), s_Expresion)
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 14: Monto de retención del IGV
  's_Expresion = ""
  s_Expresion = Replace(FormatNumber(CDec(porstMRp!imp2 + porstMRp!imp4 + porstMRp!imp6), 2), ",", "")
  s_Expresion = IIf(porstMRp!codtdc = "50" And porstMRp!codtdc_ref = "91", porstMRp!impigvref_mn, s_Expresion)
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 15: Código  de la Moneda (Tabla 4)
  s_Expresion = porstMRp!codmon
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  'nuevo 17: Tipo de cambio
  'por teo 2016-02-10 s_Expresion = ""
  'ini 2016-07-13 correcion en la molina s_Expresion = Replace(FormatNumber(CDec(IIf(IsNull(porstMRp!imptcb_inv), 0, porstMRp!imptcb_inv)), 3), ",", "")
  s_Expresion = Replace(FormatNumber(CDec(IIf(IsNull(porstMRp!ImpTCb_inv), 0, porstMRp!ImpTCb_inv)), 3), ",", "")
  psRegistro = psRegistro & s_Expresion & s_Caracter
  ...
  '2015-05-11 corrige teo s_Expresion = ""
  s_Expresion = IIf(IsNull(porstMRp!razAux), "", porstMRp!razAux)
  psRegistro = psRegistro & s_Expresion & s_Caracter
...
Private Function fAE_08_1_reg_cpr(xNroCorr As Long) As String
  ...
  psRegistro = ""
  ' 1: RUC empresa
  s_Expresion = gsRUCEmp
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 2: Razon social empresa
  s_Expresion = gfSacaEntRetApos(gsRazEmp)
  psRegistro = psRegistro & s_Expresion & s_Caracter
  ...
  ' 7: tipo comprobante de pago
  s_Expresion = Format(porstMRp!codtdc, "00")
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 8: serie comprobante de pago
  s_Expresion = IIf(IsNull(porstMRp!serdoc), "", porstMRp!serdoc)
  s_Expresion = IIf(porstMRp!codtdc = "05", Right(porstMRp!serdoc, 1), porstMRp!serdoc)
  psRegistro = psRegistro & s_Expresion & s_Caracter
  ...
  ' 10: numero comprobante de pago
  s_Expresion = IIf(porstMRp!codtdc = "01" Or porstMRp!codtdc = "03" _
  Or porstMRp!codtdc = "04" Or porstMRp!codtdc = "06" _
  Or porstMRp!codtdc = "07" Or porstMRp!codtdc = "08", Right(porstMRp!nrodoc, 7), _
  IIf(porstMRp!codtdc = "36", Right(porstMRp!nrodoc, 8), porstMRp!nrodoc))
  s_Expresion = IIf(porstMRp!codtdc = "50", Right(porstMRp!nrodoc, 6), s_Expresion)
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 11: numero final no dan derecho a credito - constante
  s_Expresion = ""
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 12: tipo documento identidad proveedor
  s_Expresion = IIf(IsNull(porstMRp!TpoDci), "0", porstMRp!TpoDci)
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 13: numero documento identidad proveedor
  ...
  ' 28: fecha emision comprobante modifica
  ...
  ' 29: tipo comprobante pago modifica
  s_Expresion = Format(IIf(IsNull(porstMRp!codtdc_ref), "0", porstMRp!codtdc_ref), "00")
  s_Expresion = IIf(porstMRp!codtdc = "07" Or porstMRp!codtdc = "08" _
  Or porstMRp!codtdc = "87" Or porstMRp!codtdc = "88" _
  Or porstMRp!codtdc = "97" Or porstMRp!codtdc = "98", s_Expresion, "")
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 30: serie comprobante pago modifica
  s_Expresion = IIf(porstMRp!codtdc = "07" Or porstMRp!codtdc = "08" _
  Or porstMRp!codtdc = "87" Or porstMRp!codtdc = "88" _
  Or porstMRp!codtdc = "97" Or porstMRp!codtdc = "98", porstMRp!serdoc_ref, "")
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 31: Codigo dependencia aduana (DUA)
  s_Expresion = IIf(IsNull(porstMRp!codaduana), "", porstMRp!codaduana)
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 32: numero comprobante pago modifica
  s_Expresion = IIf(porstMRp!codtdc = "07" Or porstMRp!codtdc = "08" _
  Or porstMRp!codtdc = "87" Or porstMRp!codtdc = "88" _
  Or porstMRp!codtdc = "97" Or porstMRp!codtdc = "98", porstMRp!nrodoc_ref, "")
  s_Expresion = IIf(porstMRp!codtdc_ref = "01" Or porstMRp!codtdc_ref = "03" _
  Or porstMRp!codtdc_ref = "04" Or porstMRp!codtdc_ref = "06" _
  Or porstMRp!codtdc_ref = "07" Or porstMRp!codtdc_ref = "08", Right(s_Expresion, 7), _
  IIf(porstMRp!codtdc_ref = "36", Right(s_Expresion, 8), s_Expresion))
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 33: Clasificación de los bienes y servicios adquiridos
  s_Expresion = IIf(IsNull(porstMRp!tpobns), "", porstMRp!tpobns)
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 34: Identificación del Contrato o del proyecto.dejar vacio
  s_Expresion = ""
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 35: Porcentaje en Contrato o del proyecto - cero
  s_Expresion = "0.00"
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
 ' 36: Impuesto materia beneficio Ley 31053
  s_Expresion = "0.00"
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 37: CAR CP a modificar en ajustes posteriores - vacio
  s_Expresion = ""
  psRegistro = psRegistro & s_Expresion & s_Caracter

  ' NC: fecha emision constancia detracción
  ...
  ' NC: numero comprobante pago no domiciliado
  s_Expresion = IIf(IsNull(porstMRp!NroCDt), "0", porstMRp!NroCDt)
  s_Expresion = IIf(s_Expresion = "", "0", s_Expresion)
  'psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' NC: Indicador de Comprobantes de pago cancelados. siempre poner valor 1
  s_Expresion = "1"
  'psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' NC: identifica ajuste - constante
...
Private Function fAE_14_1_reg_vta(xNroCorr As Long) As String
  ...
  ' 10: numero final agrupar documentos
  s_Expresion = IIf(IsNull(porstMRp!nrodoc_fin), "", porstMRp!nrodoc_fin)
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 11: tipo documento identidad cliente
  s_Expresion = Right(IIf(IsNull(porstMRp!TpoDci), "0", porstMRp!TpoDci), 1)
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 12: numero documento identidad cliente
  If IIf(IsNull(porstMRp!TpoDci), "0", porstMRp!TpoDci) = "1" Then
    s_Expresion = IIf(IsNull(porstMRp!codaux), "", porstMRp!codaux)
  ...
  ' 15: base imponible operacion gravada
  s_Expresion = IIf(porstMRp!impogr > 0, Replace(FormatNumber(CDec(porstMRp!impogr), 2), ",", ""), "0.00")
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 16: Descuento de la Base Imponible.deja vacio
  s_Expresion = IIf(porstMRp!impogr <= 0, Replace(FormatNumber(CDec(porstMRp!impogr), 2), ",", ""), "0.00")
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 17: igv y/o ipm
  s_Expresion = IIf(porstMRp!impigv > 0, Replace(FormatNumber(CDec(porstMRp!impigv), 2), ",", ""), "0.00")
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 18: Descuento del IGV y/o IPM - vacio
  s_Expresion = IIf(porstMRp!impigv <= 0, Replace(FormatNumber(CDec(porstMRp!impigv), 2), ",", ""), "0.00")
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 19: importe operacion exonerada
  s_Expresion = Replace(FormatNumber(CDec(porstMRp!impexo), 2), ",", "")
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 20: importe total operacion inafecta
  ...
  ' 22: base imponible operacion gravada ivap - constante
  s_Expresion = "0.00"
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 23: impuesto ventas arroz pilado (ivap) - constante
  s_Expresion = "0.00"
  psRegistro = psRegistro & s_Expresion & s_Caracter
  ...
  ' 27: Código  de la Moneda (Tabla 4)
  ...
  ' 29: fecha emision comprobante modifica
  ...
  ' 30: tipo comprobante pago modifica - codtdc_ref
  s_Expresion = Format(IIf(IsNull(porstMRp!d2), "0", porstMRp!d2), "00")
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 31: serie comprobante pago modifica- serdoc_ref
  s_Expresion = IIf(IsNull(porstMRp!d3), "", porstMRp!d3)
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 32: numero comprobante pago modifica- nrodoc_ref
  ...
  ' 33: Identificación del Contrato o del proyecto en el caso de los Operadores de las sociedades - vacio
  s_Expresion = ""
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 34: Error tipo 1: inconsistencia en el tipo de cambio - vacio
  s_Expresion = ""
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 35: Indicador de Comprobantes de pago cancelados con medios de pago (Tabla 1) - vacio
  s_Expresion = ""
  psRegistro = psRegistro & s_Expresion & s_Caracter
  
  ' 36: campos libre - constante
  s_Expresion = ""
  psRegistro = psRegistro & s_Expresion & s_Caracter
...
'ini 2016-03-22 error diario y mayor ple solu
        s_Expresion = porstMRp!TpoDci  'TC 29-03-2016
        psRegistro = psRegistro & s_Expresion & s_Caracter
'        s_Expresion = ""
'        psRegistro = psRegistro & s_Expresion & s_Caracter
...
'ini 2015-05-23 validacion ruc 8dig tdoc=01
        's_Expresion = porstMRp!codaux  ' TC 29-03-2016
        '2016-08-23 revision error If IIf(IsNull(porstMRp!TpoDci), "0", porstMRp!TpoDci) = "01" Then
        If IIf(IsNull(porstMRp!TpoDci), "0", porstMRp!TpoDci) = "1" Then
             s_Expresion = IIf(IsNull(porstMRp!codaux), "", porstMRp!codaux)
             s_Expresion = Right(s_Expresion, 8)
        Else
...
'fin 2016-03-22 error diario y mayor ple solu
        ...
        's_Expresion = Format(porstMRp!codtdc, "00")  TC
        's_Expresion = IIf(Trim(porstMRp!codtdc) = "", "00", Format(porstMRp!codtdc, "00")) TC
        s_Expresion = IIf(IsNull(porstMRp!codtdc) Or Trim(porstMRp!codtdc) = "", "00", porstMRp!codtdc)
        psRegistro = psRegistro & s_Expresion & s_Caracter
        
        'Nuevo 11: serie comprobante de pago
        
        's_Expresion = IIf(IsNull(porstMRp!serdoc), "-", porstMRp!serdoc) TC 29-03-2016
        s_Expresion = IIf(porstMRp!codtdc = "05", Right(porstMRp!serdoc, 1), IIf(IsNull(porstMRp!serdoc), "-", porstMRp!serdoc))
        s_Expresion = IIf(porstMRp!codtdc = "50", Right(porstMRp!serdoc, 3), s_Expresion) '2016-08-23
        ...
        If IsNull(porstMRp!nrodoc) Or Trim(porstMRp!nrodoc) = "" Then
           s_Expresion = "-"
           psRegistro = psRegistro & s_Expresion & s_Caracter
        Else
           s_Expresion = IIf(porstMRp!codtdc = "01" Or porstMRp!codtdc = "03" _
           Or porstMRp!codtdc = "04" Or porstMRp!codtdc = "06" _
           Or porstMRp!codtdc = "07" Or porstMRp!codtdc = "08" Or porstMRp!codtdc = "02", gfSacaEntRetApos(Right(porstMRp!nrodoc, 8)), _
           IIf(porstMRp!codtdc = "36" Or porstMRp!codtdc = "40", gfSacaEntRetApos(Right(porstMRp!nrodoc, 8)), _
           IIf(porstMRp!codtdc = "50", gfSacaEntRetApos(Right(porstMRp!nrodoc, 6)), gfSacaEntRetApos(porstMRp!nrodoc)))) '2016-08-23
           
'2016-04-21 error ple tpodoc40           IIf(porstMRp!codtdc = "36", Right(porstMRp!nrodoc, 8), porstMRp!nrodoc))
           psRegistro = psRegistro & s_Expresion & s_Caracter
        ...
        s_Expresion = gfSacaEntRetApos(porstMRp!RefDoc)
        psRegistro = psRegistro & s_Expresion & s_Caracter
...
'fin 2016-02-02.07  correccion ple
        ...
        If Not IsNull(porstMRp!cDocume) Then
          s_Expresion = gfSacaEntRetApos(porstMRp!cDocume)
        End If
        psRegistro = psRegistro & s_Expresion & s_Caracter
        ...
        If Not IsNull(porstMRp!codaux) Then
          's_Expresion = porstMRp!codaux & "-" & porstMRp!razAux  TC 29-03-2016
           s_Expresion = gfSacaEntRetApos(porstMRp!codaux) & "-" & gfSacaEntRetApos(porstMRp!razAux)
        End If
        psRegistro = psRegistro & s_Expresion & s_Caracter
        ...
        If Not IsNull(porstMRp!RefDoc) Then
          's_Expresion = porstMRp!RefDoc  TC 29-03-2016
          s_Expresion = gfSacaEntRetApos(porstMRp!RefDoc)
        End If
        psRegistro = psRegistro & s_Expresion & s_Caracter
...
Private Function fAE_05_1_lib_diario_sql(sMoneda As String) As String
  ...
  sSentencia = sSentencia & fIsNull() & "det.codtdc,'') AS codtdc, " & fIsNull() & "det.serdoc,'') AS serdoc, " & fIsNull() & "det.nrodoc,'') AS nrodoc, "
  sSentencia = sSentencia & "det.codcta, cta.detcta, " & fIsNull() & "det.codaux,'') AS codaux, " & fIsNull() & "aux.razaux,'') AS razaux, "
  sSentencia = sSentencia & fIsNull() & "det.refdoc,'') AS refdoc, " & Choose(gsIdioma, "det.gloite", "det.gloitex") & " AS gloite, "
  ...
  sSentencia = sSentencia & fIsNull() & "det.codmon,'') AS codmon, " & fIsNull() & "right(aux.tpodci,1),'') AS tpodci, "
  sSentencia = sSentencia & fIsNull() & "det.codcco,'') AS codcco, fevdoc, feedoc "
  ']
  ...
  '[2015-04-01 convierte un solo mes 12y00
  If xqmes = "12" Then
...
'fin 2016-02-02.07  correccion ple
        ...
        'Nuevo 6: Código del Centro de Costos, Centro de Utilidades
        's_Expresion = porstMRp!codcco TC
        s_Expresion = IIf(IsNull(porstMRp!codcco) Or Trim(porstMRp!codcco) = "", "-", porstMRp!codcco)
        psRegistro = psRegistro & s_Expresion & s_Caracter
...
'ini 2016-03-22 error diario y mayor ple solu
        's_Expresion = IIf(IsNull(porstMRp!serdoc), "-", porstMRp!serdoc)
        's_Expresion = IIf(IsNull(porstMRp!serdoc) Or Trim(porstMRp!serdoc) = "", "-", porstMRp!serdoc) TC 29-03-2016
        s_Expresion = IIf(porstMRp!codtdc = "05", Right(porstMRp!serdoc, 1), IIf(IsNull(porstMRp!serdoc) Or Trim(porstMRp!serdoc) = "", "-", porstMRp!serdoc))
        s_Expresion = IIf(porstMRp!codtdc = "50", Right(porstMRp!serdoc, 3), s_Expresion) '2016-08-23
...
'ini 2016-03-22 error diario y mayor ple solu
        ...
        Else
            ...
            Or porstMRp!codtdc = "04" Or porstMRp!codtdc = "06" _
            Or porstMRp!codtdc = "07" Or porstMRp!codtdc = "08" Or porstMRp!codtdc = "02", gfSacaEntRetApos(Right(porstMRp!nrodoc, 8)), _
            IIf(porstMRp!codtdc = "36", gfSacaEntRetApos(Right(porstMRp!nrodoc, 8)), _
            IIf(porstMRp!codtdc = "50", gfSacaEntRetApos(Right(porstMRp!nrodoc, 6)), gfSacaEntRetApos(porstMRp!nrodoc)))) '2016-08-23
        End If
'fin 2016-03-22 error diario y mayor ple solu
        psRegistro = psRegistro & s_Expresion & s_Caracter
...
'ini 2016-06-09 mes01 inclye 00
'    sSentencia = "SELECT " & IIf(s_MesIni = "12", "det.mespvs", "'" & s_MesIni & "'") & " as mespvs, "
    sSentencia = "SELECT " & IIf(s_MesIni = "12" Or s_MesIni = "01", "det.mespvs", "'" & s_MesIni & "'") & " as mespvs, "
'fin 2016-06-09 mes01 inclye 00
...
'ini 2016-06-09 mes01 inclye 00
    ElseIf s_MesIni = "01" Then
    sSentencia = sSentencia & "AND det.MesPvs>='00' AND det.MesPvs<='" & "" & s_MesIni & "" & "' "
'fin 2016-06-09 mes01 inclye 00
    Else
    sSentencia = sSentencia & "AND det.MesPvs>='" & s_MesIni & "' AND det.MesPvs<='" & s_MesFin & "' "
    End If
...
' Saldo anterior
'ini 2016-06-09 mes01 inclye 00
'tambien se acordo que esto se comentara por que no tiene sentido
'generar esto
'    If s_MesIni = "13" Then
'    '2016-06-09 mes01 inclye 00  If s_MesIni = "01" Or s_MesIni = "13" Then
'      sSalAntDeb = "ROUND(("
'      sSalAntHab = "ROUND(("
...
'ini 2016-06-09 mes01 inclye 00
Private Function fAE_06_1_lib_mayor_sql_2016_06_09(sMoneda As String) As String
    Dim sSentencia As String
    Dim s_MesIni As String, s_MesFin As String
    Dim sSalAntDeb As String, sSalAntHab As String
    Dim nSecuencia As Long
...
'fin 2015-04-01 convierte un solo mes 12y00
    ...
    End If
    sSentencia = sSentencia & "ORDER BY codcta, mespvs, coddro, nrocpb, nroite"
    fAE_06_1_lib_mayor_sql_2016_06_09 = sSentencia
...
'fin 2015-11-12/18 PLE rpt fmt electro archivo
   ...
   Case 29, 30    ' registro  de compras - SIRE
    sArchivo = "080400" & "02" & "1"
    sSentencia = fAE_08_1_reg_cpr_sql(sMoneda, 1)
   Case 31      ' registro de ventas -SIRE
     sArchivo = "140400" & "02"
  ...
  Case 29, 30, 31
    sArchivo = "LE" & gsRUCEmp & gsAnoAct & Left(cmbEjercicio.Text, 2) & "00" & sArchivo & "1" & sMoneda & "2" & ".txt"
  Case Else
    sArchivo = "LE" & gsRUCEmp & gsAnoAct & Left(cmbEjercicio.Text, 2) & "00" & sArchivo & "0" & sMoneda & "1" & ".txt"
  End Select
