...
'Public uorstCodMdl As ADODB.Recordset
']

Private Sub Form_Load()
 '[Recordsets                          'Cambiar.
   psConnStrgSele = "SELECT CodMdl, DetMdl, NomMdl," _
                  & "  If(EstMdl='" & ESTMDL_ACT & "','" & ESTMDL_ACT_TXT & "','" & ESTMDL_INA_TXT & "') as cEstMdl," _
                  & "  EstMdl," _
...
'     .CursorLocation = adUseClient   'Es el Default.
      ...
      .Open
'      .Properties("Unique Table").Value = "CodMdl"
   End With
'   With uorstCodMdl
'      .ActiveConnection = uocnnMain
'      .Source = "SELECT a.CodMdl, a.DetMdl " _
'              & "FROM SGMdl a"
''     .CursorLocation = adUseClient   'Es el Default.
...
Public Sub cmdNuevo_Click()
   gpTUg_Nuevo Me, frmMMdl             'Cambiar Formulario de Datos.
End Sub
...
Public Sub cmdRevisar_click()
   ...
   With frmMMdl                        'Cambiar Formulario de Datos.
      .zbNuevo = False
...
'   frmLMdl.Caption = Choose(gsIdioma, "Listado de ", "Listing of ") & Me.Caption
'   frmLMdl.Show vbModal
 ']
End Sub
...
Public Sub ppDatosGrid()               'Cambiar Datos Grid.
   ...
   With dgrMain.Columns
      For dnNum = 0 To .Count - 1
         ...
         Case 2
            .Item(dnNum).Caption = "Nombre"
            .Item(dnNum).Width = 1300
         Case 3
            .Item(dnNum).Caption = "Situación"
