...
Private Sub Form_Load()
 '[Recordsets                          'Cambiar.
   psConnStrgSele = "SELECT CodTDc, "
   psConnStrgSele = psConnStrgSele & Choose(gsIdioma, "DetTDc, ", "DetTDcx, ")
   psConnStrgSele = psConnStrgSele & "AbvTDc, SgnTDc, ForImp, "
   psConnStrgSele = psConnStrgSele & Choose(gsIdioma, "DetTDcx, ", "DetTDc, ")
   psConnStrgSele = psConnStrgSele & "codemp, "
   psConnStrgSele = psConnStrgSele & "UsrCre, FyHCre, UsrMdf, FyHMdf "
   psConnStrgSele = psConnStrgSele & "FROM TGTDc "
...
'     .CursorLocation = adUseClient   'Es el Default.
      ...
      .Open
      .Properties("Unique Table").Value = "TGTDc"
...
Public Sub cmdNuevo_Click()
   gpTUg_Nuevo Me, frmMTDc             'Cambiar Formulario de Datos.
End Sub
...
Public Sub cmdRevisar_click()
   ...
   With frmMTDc                        'Cambiar Formulario de Datos.
      .zbNuevo = False
...
Public Sub ppDatosGrid()               'Cambiar Datos Grid.
   ...
   With dgrMain.Columns
      For dnNum = 0 To .Count - 1
         ...
         Case 2
            .Item(dnNum).Caption = Choose(gsIdioma, "Abreviatura", "Abbreviation")
