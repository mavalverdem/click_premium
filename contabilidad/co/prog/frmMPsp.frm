...
Private xHabilitaKey0 As Integer '2016-07-12 correccion de presupuesto
Private xHabilitaKey1 As Integer '2016-07-12 correccion de presupuesto
...
Private Sub Form_Load()
   xHabilitaKey0 = 0 '2016-07-12 correccion de presupuesto
   xHabilitaKey1 = 0 '2016-07-12 correccion de presupuesto
...
'      pbValidada = True
'      txtDato(0).SetFocus
        If xHabilitaKey0 = 1 And xHabilitaKey1 = 1 Then
            cmdGrabar.Enabled = True
            upHabilitacion True
            pbValidada = True
            txtDato(0).SetFocus
...
'ini 2016-07-12 correccion de presupuesto
      xHabilitaKey0 = 0
      If Len(Trim(lblLlaveDeta(tnIndex).Caption)) <> 0 Then
        xHabilitaKey0 = 1
      End If
'fin 2016-07-12 correccion de presupuesto
   Case 1
'2016-07-13 cambios a presupuest ayuda cco       modAyuBus.CCo_Cod "length(codcco)=2 ", "", 0, 0, Me.Top + txtDato(tnIndex).Top + txtDato(tnIndex).Height, Me.Left + txtDato(tnIndex).Left
      modAyuBus.CCo_Cod "length(codcco)=" & Right(gsNivCCo, 1) & " ", "", 0, 0, Me.Top + txtDato(tnIndex).Top + txtDato(tnIndex).Height, Me.Left + txtDato(tnIndex).Left
      txtLlave(tnIndex).Text = frmOAyuBus.uvDato1
      lblLlaveDeta(tnIndex).Caption = " " & frmOAyuBus.uvDato2
'ini 2016-07-12 correccion de presupuesto
      xHabilitaKey1 = 0
   ...
   Case 0
      ...
      With frmMPspGrd.porstCOCta
         ...
         Else
            ...
            xHabilitaKey0 = 1 '2016-07-12 correccion de presupuesto
         End If
      End With
   Case 1
      If txtLlave(tnIndex).Text = "" Then
         ...
         Exit Function
      End If
      With frmMPspGrd.porstCoCCo
         .MoveFirst
         .Find "CodCCo='" & txtLlave(tnIndex).Text & "'"
         If .EOF Then
            MsgBox TEXT_8006, vbExclamation
            xHabilitaKey1 = 0 '2016-07-12 correccion de presupuesto
            ppAyuDet = True
         Else
            lblLlaveDeta(tnIndex).Caption = " " & IIf(IsNull(!detcco), "", !detcco)
            xHabilitaKey1 = 1 '2016-07-12 correccion de presupuesto
         End If
...
Public Sub upHabilitacion_llave(tbHabilitar As Boolean) 'Cambiar.
   Dim dnContador As Integer
  'Llaves
   With txtLlave
...
End Sub
Public Sub upHabilitacion_2016_07_12(tbHabilitar As Boolean) 'Cambiar.
   Dim dnContador As Integer
'  'Llaves
'ini 2016-07-12 correccion de presupuesto
'   With txtLlave
