...
'   psConnStrgSele = "SELECT a.CodCCo, a.DetCCo," _
                  ...
                  & "FROM COCCo as a "
   psConnStrgSele = "SELECT COHojTra3.CodCta, " & Choose(gsIdioma, "CoCta.DetCta", "CoCta.DetCtax") & " AS DetCta, " _
                  & "  COHojTra3.ImpSalIH, COHojTra3.ImpAmtH, COHojTra3.ImpAmtAdH, " _
                  & "  COHojTra3.ImpSalIA, COHojTra3.ImpAmtA, COHojTra3.ImpAmtAdA, " _
                  & "  COHojTra3.UsrCre, COHojTra3.FyHCre, COHojTra3.UsrMdf, COHojTra3.FyHMdf " _
                  & "FROM (COHojTra3 Left Join COCta As COCta On COHojTra3.CodCta = COCta.CodCta) "
   psConnStrgOrde = "ORDER BY COHojTra3.CodCta"
...
'     .CursorLocation = adUseClient   'Es el Default.
      ...
      .Open
      .Properties("Unique Table").Value = "COHojTra3"
   End With
   With porstCOCta
      .ActiveConnection = uocnnMain
...
Public Sub cmdNuevo_Click()
   gpTUg_Nuevo Me, frmMHT3             'Cambiar Formulario de Datos.
End Sub
...
Public Sub cmdRevisar_click()
   ...
   With frmMHT3                        'Cambiar Formulario de Datos.
      .zbNuevo = False
...
Public Sub cmdEliminar_Click()
   ...
   If uorstMain.RecordCount = 0 Then
      MsgBox Choose(gsIdioma, "No hay datos creados.", "There are not created date"), vbCritical
      Exit Sub
   End If
