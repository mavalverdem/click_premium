...
Private Sub Form_Load()
 '[Recordsets                          'Cambiar.
'   psConnStrgSele = "SELECT a.CodCCo, a.DetCCo," _
                  & "  a.UsrCre, a.FyHCre, a.UsrMdf, a.FyHMdf " _
                  & "FROM COCCo as a "
   psConnStrgSele = "SELECT COHojTra1.CodCta, " & Choose(gsIdioma, "CoCta.DetCta", "CoCta.DetCtax") & " AS DetCta, " _
                  & "  COHojTra1.ImpSalI, COHojTra1.ImpAdq, COHojTra1.ImpVtRr, " _
                  & "  COHojTra1.ImpSalIA, COHojTra1.ImpAdqA, COHojTra1.ImpVtRrA, " _
                  & "  COHojTra1.ImpSalIH, COHojTra1.ImpDepH, COHojTra1.ImpVtRrH, " _
                  & "  COHojTra1.ImpSalIDA, COHojTra1.ImpDepA, COHojTra1.ImpVtRrDA, " _
                  & "  COHojTra1.UsrCre, COHojTra1.FyHCre, COHojTra1.UsrMdf, COHojTra1.FyHMdf " _
                  & "FROM (COHojTra1 Left Join COCta As COCta On COHojTra1.CodCta = COCta.CodCta) "
   psConnStrgOrde = "ORDER BY COHojTra1.CodCta"
...
'     .CursorLocation = adUseClient   'Es el Default.
      ...
      .Open
      .Properties("Unique Table").Value = "COHojTra1"
   End With
   With porstCOCta
      .ActiveConnection = uocnnMain
      .Source = "Select CodCta, " & Choose(gsIdioma, "DetCta", "DetCtax") & " AS DetCta, TpoCta From COCta"
      .CursorType = adOpenDynamic
...
Public Sub cmdNuevo_Click()
   gpTUg_Nuevo Me, frmMHT1             'Cambiar Formulario de Datos.
End Sub
...
Public Sub cmdRevisar_click()
   ...
   With frmMHT1                        'Cambiar Formulario de Datos.
      .zbNuevo = False
