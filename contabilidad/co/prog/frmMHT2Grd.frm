...
'   psConnStrgSele = "SELECT a.CodCCo, a.DetCCo," _
                  ...
                  & "FROM COCCo as a "
   psConnStrgSele = "SELECT COHojTra2.CodCta, " & Choose(gsIdioma, "CoCta.DetCta", "CoCta.DetCtax") & " AS DetCta, " _
                  & "  COHojTra2.ImpValH, COHojTra2.ImpValA, " _
                  & "  COHojTra2.UsrCre, COHojTra2.FyHCre, COHojTra2.UsrMdf, COHojTra2.FyHMdf " _
                  & "FROM (COHojTra2 Left Join COCta As COCta On COHojTra2.CodCta = COCta.CodCta) "
   psConnStrgOrde = "ORDER BY COHojTra2.CodCta"
...
'     .CursorLocation = adUseClient   'Es el Default.
      ...
      .Open
      .Properties("Unique Table").Value = "COHojTra2"
   End With
   With porstCOCta
      .ActiveConnection = uocnnMain
...
Public Sub cmdNuevo_Click()
   gpTUg_Nuevo Me, frmMHT2             'Cambiar Formulario de Datos.
End Sub
...
Public Sub cmdRevisar_click()
   ...
   With frmMHT2                        'Cambiar Formulario de Datos.
      .zbNuevo = False
