    ...
    If Len(Trim(txtDato(Index).Text)) <> 0 Then
      ...
      With frmTHPrGrd.uorstCOHPrDocCCo
         If Not (.BOF Or .EOF) And .RecordCount > 0 Then
            ...
            .MoveFirst
             .Find "cLlave2='" & frmTHPr.txtLlave(0).Text & frmTHPr.txtLlave(1).Text & frmTHPr.txtLlave(2).Text & frmTHPrMasGrd.unIndice & frmTHPrMasGrd.dgrMain.Columns(0).Text & txtDato(0).Text & "'"
            If Not .EOF Then
