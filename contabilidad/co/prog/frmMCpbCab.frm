...
' Obtengo la información del comprobante
  With porstMRp
    ...
    .Source = .Source & "c.UsrCre, c.FyHCre, c.UsrMdf, c.FyHMdf "
    .Source = .Source & "FROM ((comacpbcab c "
    .Source = .Source & "LEFT JOIN comacpbdet a ON c.codemp=a.codemp AND c.pdoano=a.pdoano AND c.MesPvs=a.MesPvs AND c.CodDro=a.CodDro and c.NroCpb=a.NroCpb) "
    ...
    .Source = .Source & "AND a.MesPvs = '" & rcMesAct & "' "
...
'      With dtpFehCpb
'        .MinDate = CDate("01/" & rcgfMesAct(IIf(rcMesAct = "00", "01", rcMesAct)) & "/" & gsAnoAct)
'        .MaxDate = gfUltDia(.MinDate)
'        .Value = .MaxDate
'      End With
      With dtpFehCpb
        .MinDate = CDate("01/" & rcgfMesAct(IIf(rcMesAct = "00", "12", rcMesAct)) & "/" & gsAnoAct)
        .MaxDate = gfUltDia(.MinDate)
        .Value = .MaxDate
      End With
...
'   End If
   ...
   If pbLoad And Not pbNuevo Then
      pbLoad = False
      frmMCpbGrd.usConnStrgWher_1 = "WHERE comacpbdet.codemp='" & gsCodEmp & "' "
      frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.pdoano='" & gsAnoAct & "' "
      frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.MesPvs='" & rcMesAct & "' "
      frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.CodDro='" & frmMCpbGrd.uorstMain_0!coddro & "' "
      frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.NroCpb='" & frmMCpbGrd.uorstMain_0!nrocpb & "' "
      ppDatosWhere
   End If
   upDatosGrid
...
'[Propio del Formulario.
'   If Month(dtpFehCpb.Value) <> Val(rcMesAct) Or Year(dtpFehCpb.Value) <> Val(gsAnoAct) Then
   If Month(dtpFehCpb.Value) <> Val(rcgfMesAct(IIf(rcMesAct = "00", "01", rcMesAct))) Or Year(dtpFehCpb.Value) <> Val(gsAnoAct) Then
...
']
'[2008/06/18 se utilizara diario contable
'txtLlave(0).Text = "9999"
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
   If frmMCpbGrd.uorstMain_0.RecordCount <> 0 Then
'      frmMCpbGrd.uorstMain_0.CancelUpdate   'Cambiar Formulario de Grid.
   End If
...
'   gpTUe_Retroceder frmTFacGrd.uorstMain_0, Me 'Cambiar Formulario de Grid.
   If txtDeta(0).Text <> txtDeta(1).Text Then
      ...
      If frmMCpbGrd.uorstMain_0!tpognr <> TPOGNR_DRO Then GoTo Finalizar
   ...
   End If
Finalizar:
   gpTUe_Retroceder frmMCpbGrd.uorstMain_0, Me
   frmMCpbGrd.usConnStrgWher_1 = "WHERE comacpbdet.codemp='" & gsCodEmp & "' "
   frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.pdoano='" & gsAnoAct & "' "
   frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.MesPvs='" & rcMesAct & "' "
   frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.CodDro='" & frmMCpbGrd.uorstMain_0!coddro & "' "
...
Finalizar:
   gpTUe_Avanzar frmMCpbGrd.uorstMain_0, Me
   frmMCpbGrd.usConnStrgWher_1 = "WHERE comacpbdet.codemp='" & gsCodEmp & "' "
   frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.pdoano='" & gsAnoAct & "' "
   frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.MesPvs='" & rcMesAct & "' "
   frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.CodDro='" & frmMCpbGrd.uorstMain_0!coddro & "' "
...
Public Sub cmdGrabar_Click()
   ...
   With frmMCpbGrd                     'Cambiar Formulario de Grid.
      ...
      '[ rcs 2008/06/18 teo no conseva numero cptbte
''''      If pbNuevo Then
''''         pbGraba = True
''''         .uocnnMain.BeginTrans
''''         ' MA para conservar el numero digitado por el usuario
''''         .uorstcodro.Fields("Cpb" & rcMesAct).Value = txtLlave(1).Text
''''         .uorstcodro.Update
...
'         .uorstMain_0.Find "CodDro='" & txtLlave(0).Text & "' And NroCpb='" & txtLlave(1).Text & "'"
       ...
       '[ No Pertenece al Formulario - Agregado por Angel
         ...
         frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.pdoano='" & gsAnoAct & "' "
         frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.MesPvs='" & rcMesAct & "' "
         frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.CodDro='" & txtLlave(0).Text & "' "
         frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.NroCpb='" & txtLlave(1).Text & "' "
         ppDatosWhere
       ']
...
'gpTVd_Nuevo Me, frmTFacDet          'Cambiar Formulario de Datos.
  ...
  If frmMCpbGrd.uorstMain_1.RecordCount > 0 Then
    frmMCpbGrd.uorstMain_1.MoveLast
  End If
   ']
End Sub
...
'      MsgBox TEXT_8001, vbInformation
   ...
   End With
   '[Agregado por Angel
   dvRegistro = frmMCpbGrd.uorstMain_1.Bookmark
  frmMCpbGrd.usConnStrgWher_1 = "WHERE comacpbdet.codemp='" & gsCodEmp & "' "
  frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.pdoano='" & gsAnoAct & "' "
  frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.MesPvs='" & rcMesAct & "' "
  frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.CodDro='" & txtLlave(0).Text & "' "
  frmMCpbGrd.usConnStrgWher_1 = frmMCpbGrd.usConnStrgWher_1 & "AND comacpbdet.NroCpb='" & txtLlave(1).Text & "' "
   ppDatosWhere
   frmMCpbGrd.uorstMain_1.Bookmark = dvRegistro
   ']
'''   dgrMain.SetFocus
dgrDetalle.SetFocus
...
Dim dvRegistro As Variant
   ...
   With frmMCpbGrd                     'Cambiar Formulario de Grid.
     'Verificaciones.
      ...
      End If
      If frmMCpbGrd.uorstMain_1!tpognr <> TPOGNR_DRO Then
     ...
     'Confirmación                     'Cambiar.
      If MsgBox(TEXT_1021 & " " & Trim(dgrDetalle.Columns(1)) & ")?", vbYesNo + vbQuestion + vbDefaultButton2, Me.Caption) = vbYes Then
         If .uorstMain_1!tpoctb = TPOCTB_DEB Then
            frmMCpbCab.txtDeta(0) = Format(CDec(frmMCpbCab.txtDeta(0).Text) - .uorstMain_1!impmn, FORMATO_NUM_1)
            frmMCpbCab.txtDeta(2) = Format(CDec(frmMCpbCab.txtDeta(2).Text) - .uorstMain_1!impme, FORMATO_NUM_1)
         Else
            frmMCpbCab.txtDeta(1) = Format(CDec(frmMCpbCab.txtDeta(1).Text) - .uorstMain_1!impmn, FORMATO_NUM_1)
            frmMCpbCab.txtDeta(3) = Format(CDec(frmMCpbCab.txtDeta(3).Text) - .uorstMain_1!impme, FORMATO_NUM_1)
         End If
         .uocnnMain.BeginTrans
         With .uorstMain_1
            dvRegistro = .Bookmark
...
Public Sub cmdRefrescar_Click()
  ...
  frmMCpbGrd.uorstMain_1.Requery
  frmMCpbCab.upDatosGrid
  frmMCpbCab.dgrDetalle.SetFocus
  ']
End Sub
...
Public Sub cmdCalcular_Click()
   With frmMCpbGrd.uorstMain_1
      ...
      txtDeta(3).Text = Format(0, FORMATO_NUM_1)
      If frmMCpbGrd.uorstMain_1.RecordCount > 0 Then
         frmMCpbGrd.uorstMain_1.MoveFirst
         Do
            ...
            frmMCpbGrd.uorstMain_1.MoveNext
         Loop Until .EOF
      End If
   End With
   Set dgrDetalle.DataSource = frmMCpbGrd.uorstMain_1
   upDatosGrid
End Sub
   ...
   If Index = 0 And Len(Trim(txtLlave.Item(0).Text)) <> 0 Then
      If pbNuevo Then
         With frmMCpbGrd.uorstCODro
            ...
            End If
            txtLlave(1).Text = rcgfNumComprobante(gsAnoAct, rcMesAct, txtLlave(0).Text)
         End With
      End If
   End If
...
Private Sub dgrDetalle_KeyUp(KeyCode As Integer, Shift As Integer)
   If frmMCpbGrd.uorstMain_1.RecordCount = 0 Then Exit Sub
...
'         modAyuBus.maDro_Cod IIf(ps_Plataforma = pSrvMySql, "Length", "Len") & "(CodDro)=4", txtLlave(tnIndex).Text, 0, 0, Me.Top + txtLlave(tnIndex).Top + txtLlave(tnIndex).Height, Me.Left + txtLlave(tnIndex).Left
...
'2014-03-31 se condicion esta linea por que sale error en sql
         'svValores = Val(gfRetornaValor(.uocnnMain, "SELECT COUNT(*) AS cRegistro FROM comacpbdet WHERE CodDro = '" & txtLlave(0).Text & "' AND NroCpb='" & txtLlave(1).Text & "' AND MesPvs='" & rcMesAct & "' AND CodCta = '" & CTAFZD_CTA & "'"))
...
''   dcoSocio.BoundText = ""
   dtpFehCpb.Value = IIf(Month(Date) = Val(rcMesAct) And Year(Date) = Val(gsAnoAct), Date, gfUltDia("01/" & rcgfMesAct(IIf(rcMesAct = "00", "01", rcMesAct)) & "/" & gsAnoAct))
...
Private Sub ppDatosWhere()             'Cambiar.
   frmMCpbGrd.uorstMain_1.Close
   frmMCpbGrd.uorstMain_1.Source = frmMCpbGrd.usConnStrgSele_1 & frmMCpbGrd.usConnStrgWher_1 & frmMCpbGrd.usConnStrgOrde_1
   frmMCpbGrd.uorstMain_1.Open
   frmMCpbGrd.uorstMain_1.Properties("Unique Table").Value = "comacpbdet"

' '  frmTFacGrd.usConnStrgWher_1 = "WHERE a.NroDoc='" & frmTFacGrd.uorstMain_0!NroDoc & "' "
''   frmMCpbGrd.usConnStrgWher_1 = "WHERE CodDro='" & frmMCpbGrd.uorstMain_0!CodDro & "' And NroCpb='" & frmMCpbGrd.uorstMain_0!NroCpb & "'"
''   With frmTFacGrd.uorstMain_1
'   With frmMCpbGrd.uorstMain_1
'      .Close
''      .Source = frmTFacGrd.usConnStrgSele_1 & frmTFacGrd.usConnStrgWher_1 & frmTFacGrd.usConnStrgOrde_1
'      .Source = frmMCpbGrd.usConnStrgSele_1 & frmMCpbGrd.usConnStrgWher_1 & frmMCpbGrd.usConnStrgOrde_1
'      .Open
   ...
   With dgrDetalle.Columns
      For dnNum = 0 To .Count - 1
         ...
         Case 1
            ...
            .Item(dnNum).Width = 850 '70 * (frmMCpbGrd.uorstMain_1.Fields("CodCta").DefinedSize + 1)
         Case 2
            .Item(dnNum).Caption = Choose(gsIdioma, "C.Cto.", "Cost Center")
            .Item(dnNum).Width = 90 * (frmMCpbGrd.uorstMain_1.Fields("CodCCo").DefinedSize + 1)
         Case 3
            .Item(dnNum).Caption = Choose(gsIdioma, "Auxiliar", "Auxiliary")
            .Item(dnNum).Width = 1000 '100 * (frmMCpbGrd.uorstMain_1.Fields("CodAux").DefinedSize + 1)
         Case 4
            .Item(dnNum).Caption = "Doc"
            .Item(dnNum).Width = 100 * (frmMCpbGrd.uorstMain_1.Fields("AbvTDc").DefinedSize + 2)
         Case 5
            .Item(dnNum).Caption = Choose(gsIdioma, "Serie", "Series")
            .Item(dnNum).Width = 100 * (frmMCpbGrd.uorstMain_1.Fields("SerDoc").DefinedSize + 2)
         Case 6
            .Item(dnNum).Caption = Choose(gsIdioma, "Numero", "Number")
            .Item(dnNum).Width = 90 * (frmMCpbGrd.uorstMain_1.Fields("NroDoc").DefinedSize + 1)
         Case 7
         ...
         Case 10
            ...
            .Item(dnNum).Width = 100 * (frmMCpbGrd.uorstMain_0.Fields("TpoGnr").DefinedSize + 5)
...
Dim dnNroIte As Integer
  ...
  With frmMCpbGrd
      ...
      .uorstMain_1!nroite = frmMCpbGrd.pfNumItemCpb(gsAnoAct, rcMesAct, frmMCpbCab.txtLlave(0).Text, frmMCpbCab.txtLlave(1).Text)
    ...
    '[Modificado por Miguel Angel (17/01/2004).
      ...
      If frmMCpbGrd.uorstTGTCb.RecordCount <> 0 Then
        frmMCpbGrd.uorstTGTCb.MoveFirst
        frmMCpbGrd.uorstTGTCb.Find "FehTCb = '" & .uorstMain_1!feedoc & "'"
        If Not frmMCpbGrd.uorstTGTCb.EOF Then
           .uorstMain_1!imptcb = Format(frmMCpbGrd.uorstTGTCb!ImpTCb_Vta, FORMATO_NUM_2)
        End If
      End If
   ']
...
Private Sub ppbotones_tpognr0(tbgraba As Boolean)
   ...
   If Not pbNuevo Then
      If frmMCpbGrd.uorstMain_0.RecordCount > 0 And frmMCpbGrd.uorstMain_0!tpognr <> TPOGNR_DRO Then
         cmdCorregir.Enabled = False
         cmdLlaveAyud(0).Enabled = False
         cmdNuevo.Enabled = False
         cmdEliminar.Enabled = False
...
''Private Sub dtpFehCpb_Validate(Cancel As Boolean)
   If Month(dtpFehCpb.Value) <> Val(rcMesAct) Or Year(dtpFehCpb.Value) <> Val(gsAnoAct) Then
      If Month(dtpFehCpb.Value) <> Val(rcMesAct) Then
         If Month(dtpFehCpb.Value) = 1 And rcMesAct = "00" Or Month(dtpFehCpb.Value) = 12 And rcMesAct = "13" Then
            Exit Sub
         End If
      End If
