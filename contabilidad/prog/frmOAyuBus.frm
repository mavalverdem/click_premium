...
Public uvDato3Posicion As Integer, uvDato3 As Variant
Public uvDato4Posicion As Integer, uvDato4 As Variant
...
Private Sub cmdAceptar_Click()
   ...
   If Left(usCriterio, 6) = "codmed" Then
