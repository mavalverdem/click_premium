   ...
   Begin TabDlg.SSTab tabRegister 
      ...
      Begin Threed.SSFrame frmCuadro 
         ...
         Begin VB.Label lblDato 
            Caption         =   "Remuneración Percibida (1) :"
            ForeColor       =   &H00C00000&
            Height          =   195
            Index           =   0
            Left            =   180
         ...
         End
         Begin VB.Label lblDato 
            Caption         =   "Remuneración Percibida (2) :"
            ForeColor       =   &H00C00000&
            Height          =   195
            Index           =   1
            Left            =   180
         ...
         End
         Begin VB.Label lblDato 
            Caption         =   "Remuneración Percibida (3) :"
            ForeColor       =   &H00C00000&
            Height          =   195
            Index           =   2
            Left            =   180
         ...
         End
         Begin VB.Label lblDato 
            Caption         =   "Remuneración Percibida (4) :"
            ForeColor       =   &H00C00000&
            Height          =   195
            Index           =   3
            Left            =   180
...
Private Sub cmdUpdate_Click(Index As Integer)
  ...
  If txtRemunera(0) = "" Then Beep: MsgBox "Debe Ingresar el Concepto de Remuneración Percibida(1)", vbExclamation: txtRemunera(0).SetFocus: Exit Sub
  If lblHelp(0) = "???" Then Beep: MsgBox "Concepto de Remuneración Percibida(1) no es valido; Verificar", vbExclamation: txtRemunera(0).SetFocus: Exit Sub
  If lblHelp(1) = "???" Then Beep: MsgBox "Concepto de Remuneración Percibida(2) no es valido; Verificar", vbExclamation: txtRemunera(1).SetFocus: Exit Sub
  If lblHelp(2) = "???" Then Beep: MsgBox "Concepto de Remuneración Percibida(3) no es valido; Verificar", vbExclamation: txtRemunera(2).SetFocus: Exit Sub
  If lblHelp(3) = "???" Then Beep: MsgBox "Concepto de Remuneración Percibida(4) no es valido; Verificar", vbExclamation: txtRemunera(3).SetFocus: Exit Sub
  ...
  If CDec(txtPorcentaje.Text) < 0 Then Beep: MsgBox "Porcentaje de Participación debe ser mayor o igual a cero", vbExclamation: txtPorcentaje.SetFocus: Exit Sub
