...
Private Sub cmdAction_Click(Index As Integer)
  ...
  Beep
  If MsgBox("¿ Estás Seguro de Eliminar la " & lblTitle & " '" & lblHelp(0) & "' ?", vbCritical + vbYesNo + vbDefaultButton2) = vbYes Then
...
Private Sub Form_Load()
  ...
  s_TitleWindow = "Actualización Distribucción por Centro de Costo"
  lblTitle = "Distribución Centro Costo"
...
Private Sub txtCenCosto_KeyPress(KeyAscii As Integer)
  ...
  If KeyAscii = vbKeyReturn Then
    If txtCenCosto.Text = "" Then Beep: MsgBox "Debe Ingresar el Código del " & lblTitle, vbExclamation: txtCenCosto.SetFocus
    SendKeys "{TAB}"
    KeyAscii = 0
  End If
