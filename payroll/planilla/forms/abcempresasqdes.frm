...
Begin VB.Form fAbcEmpresasqdes 
   ...
   Begin TabDlg.SSTab tabRegister 
      ...
      TabPicture(0)   =   "abcempresasqdes.frx":0000
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdCancel 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcempresasqdes.frx":001C
      End
      Begin Threed.SSCommand cmdUpdate 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcempresasqdes.frx":0038
      End
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdMove 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcempresasqdes.frx":0054
      End
      Begin Threed.SSCommand cmdMove 
         Height          =   360
         Index           =   2
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcempresasqdes.frx":0070
      End
      Begin Threed.SSCommand cmdMove 
         Height          =   360
         Index           =   1
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcempresasqdes.frx":008C
      End
      Begin Threed.SSCommand cmdMove 
         Height          =   360
         Index           =   0
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcempresasqdes.frx":00A8
      End
   End
   Begin Threed.SSPanel panToolBar 
      Height          =   3165
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcempresasqdes.frx":00C4
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   1
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcempresasqdes.frx":00E0
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   2
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcempresasqdes.frx":00FC
      End
   End
   ...
   End
End
Attribute VB_Name = "fAbcEmpresasqdes"
...
Sub ShowScreen()
  ...
  If Me.Tag = s_MdoData_Ins Then
    gdl_Procedure.EditText "PK", txtCodigo, "", Me.Tag, False, fEmpresasqdes.dcaRegistro.Recordset!codeqd.DefinedSize
    gdl_Procedure.EditText "AT", txtDescripcion, "", Me.Tag, False, fEmpresasqdes.dcaRegistro.Recordset!deseqd.DefinedSize
    gdl_Procedure.EditText "AT", txtActividad, "", Me.Tag, False, fEmpresasqdes.dcaRegistro.Recordset!acteqd.DefinedSize
  ...
  Else
    gdl_Procedure.EditText "PK", txtCodigo, fEmpresasqdes.dcaRegistro.Recordset!codeqd, Me.Tag, True, fEmpresasqdes.dcaRegistro.Recordset!codeqd.DefinedSize
    gdl_Procedure.EditText "AT", txtDescripcion, gdl_Funcion.aTexto(fEmpresasqdes.dcaRegistro.Recordset!deseqd), Me.Tag, False, fEmpresasqdes.dcaRegistro.Recordset!deseqd.DefinedSize
    gdl_Procedure.EditText "AT", txtActividad, gdl_Funcion.aTexto(fEmpresasqdes.dcaRegistro.Recordset!acteqd), Me.Tag, False, fEmpresasqdes.dcaRegistro.Recordset!acteqd.DefinedSize
    gdl_Procedure.EditMask "AT", mskFecha(0), IIf(IsNull(fEmpresasqdes.dcaRegistro.Recordset!fechaini_eqd), "", fEmpresasqdes.dcaRegistro.Recordset!fechaini_eqd), Me.Tag, True, "##/##/####"
    gdl_Procedure.EditMask "AT", mskFecha(1), IIf(IsNull(fEmpresasqdes.dcaRegistro.Recordset!fechafin_eqd), "", fEmpresasqdes.dcaRegistro.Recordset!fechafin_eqd), Me.Tag, True, "##/##/####"
    gdl_Procedure.EditOptionCheck "AT", optEstado(0), (fEmpresasqdes.dcaRegistro.Recordset!estadoeqd = s_Estado_Act), Me.Tag, True
    gdl_Procedure.EditOptionCheck "AT", optEstado(1), (fEmpresasqdes.dcaRegistro.Recordset!estadoeqd = s_Estado_Ina), Me.Tag, True
  End If
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  If MsgBox("¿ Estás Seguro de Eliminar el " & lblTitle & " '" & Trim$(txtDescripcion) & "' ?", vbCritical + vbYesNo + vbDefaultButton2) = vbYes Then
    ...
    a_Where = Array("codeqd")
    a_Valores = Array(s_Destaque)
    a_Tipos = Array(TipoDato.Caracter)
      
    gdl_Conexion.IniciaTransaccion    'Inicia transacción
    ' Elimino el registro
    If Not Records_Del("plempresasqdes", a_Where, a_Valores, a_Tipos) Then GoTo Error
    gdl_Conexion.ConfirmaTransaccion  'Confirma transacción
    
    MsgBox "Se Elimino exitosamente " & lblTitle, vbInformation
    ' Refresco el Ado control y la grilla
    gdl_Procedure.RefreshAdoControl fEmpresasqdes.dcaRegistro, fEmpresasqdes.tdbRegistro, lblTitle
    ' Verifico si aun existen registros
    l_ExistRecord = ((fEmpresasqdes.dcaRegistro.Recordset.EOF And fEmpresasqdes.dcaRegistro.Recordset.BOF) Or fEmpresasqdes.dcaRegistro.Recordset.RecordCount = 0)
    If Not l_ExistRecord Then
      fEmpresasqdes.dcaRegistro.Recordset.Find ("codeqd >= '" & s_Destaque & "'")
      If fEmpresasqdes.dcaRegistro.Recordset.EOF Then fEmpresasqdes.dcaRegistro.Recordset.MoveLast
    Else
      Unload Me
    End If
  End If
...
Private Sub cmdMove_Click(Index As Integer)
  ...
  Select Case Index
   Case 0: fEmpresasqdes.dcaRegistro.Recordset.MoveFirst
   Case 1: If Not fEmpresasqdes.dcaRegistro.Recordset.BOF Then fEmpresasqdes.dcaRegistro.Recordset.MovePrevious
           If fEmpresasqdes.dcaRegistro.Recordset.BOF Then fEmpresasqdes.dcaRegistro.Recordset.MoveFirst
   Case 2: If Not fEmpresasqdes.dcaRegistro.Recordset.EOF Then fEmpresasqdes.dcaRegistro.Recordset.MoveNext
           If fEmpresasqdes.dcaRegistro.Recordset.EOF Then fEmpresasqdes.dcaRegistro.Recordset.MoveLast
   Case 3: fEmpresasqdes.dcaRegistro.Recordset.MoveLast
  End Select
...
Private Sub cmdUpdate_Click()
  ...
  a_Campos = Array("codeqd", "deseqd", "acteqd", "fechaini_eqd", "fechafin_eqd", "estadoeqd", IIf(Me.Tag = s_MdoData_Ins, "usrcre", "usrmdf"), IIf(Me.Tag = s_MdoData_Ins, "fyhcre", "fyhmdf"))
  ...
  If Me.Tag = s_MdoData_Ins Then
    If Not Records_Ins("plempresasqdes", a_Campos, a_Valores, a_Tipos) Then GoTo Error
  Else
    If Not Records_Upd("plempresasqdes", a_Campos, a_Valores, a_Tipos, a_Where) Then GoTo Error
  End If
  gdl_Conexion.ConfirmaTransaccion ' Confirma transacción
...
Private Sub Form_Load()
  ...
  s_TitleWindow = "Actualización Empresas que Destaco o Desplazo Personal"
...
' Coloco el puntero en espera
  ...
  l_ExistRecord = (fEmpresasqdes.dcaRegistro.Recordset.EOF Or fEmpresasqdes.dcaRegistro.Recordset.BOF)
  If Not l_ExistRecord Then s_ParCodigo = fEmpresasqdes.dcaRegistro.Recordset!codeqd
