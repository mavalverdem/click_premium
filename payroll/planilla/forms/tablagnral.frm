...
Dim Resp As Integer
Resp = MsgBox(vbCrLf & "Esta seguro, se copiaran los datos de las Tablas Basicas del Año Anterior al Año Actual", vbQuestion + vbYesNo + vbDefaultButton2, "Sistema de Planilla")
...
cnn.Open
  ...
  For n_Index = 0 To (UBound(aElemento, 1) - 1)
    aElemento(n_Index, 0) = Choose(n_Index + 1, "Código", "Descripción", "Valor", "TP")
