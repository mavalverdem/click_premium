...
Begin VB.Form fSelPersoxDetalle 
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "selpersoxdeta.frx":000C
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   4
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "selpersoxdeta.frx":0028
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   5
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "selpersoxdeta.frx":0044
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   6
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "selpersoxdeta.frx":0060
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   0
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "selpersoxdeta.frx":007C
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   1
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "selpersoxdeta.frx":0098
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   2
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "selpersoxdeta.frx":00B4
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   7
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "selpersoxdeta.frx":00D0
      End
   End
   Begin Threed.SSPanel panToolBar 
      Align           =   1  'Align Top
      ...
      Begin Threed.SSRibbon ribParametro 
         ...
         BevelWidth      =   0
         Outline         =   0   'False
         PictureUp       =   "selpersoxdeta.frx":00EC
      End
      Begin Threed.SSRibbon ribParametro 
         Height          =   360
         Index           =   0
         ...
         BevelWidth      =   0
         Outline         =   0   'False
         PictureUp       =   "selpersoxdeta.frx":0108
      End
      Begin Threed.SSRibbon ribParametro 
         Height          =   360
         Index           =   2
         ...
         BevelWidth      =   0
         Outline         =   0   'False
         PictureUp       =   "selpersoxdeta.frx":0124
      End
   End
End
Attribute VB_Name = "fSelPersoxDetalle"
...
Private Sub RecuperaRegistros(ByVal s_Orden As String)
  ...
  s_Sql = "SELECT psn.codcls, codpsn, apepaterno, apematerno, nombres, "
  ...
  s_Sql = s_Sql & "fecingreso, codtpt, psn.codcgo, cgoconfianza, codpfs, "
  ...
  s_Sql = s_Sql & "fecbaja, psn.estadopsn, cgo.descgo "
  ...
  If Not ribParametro(0).Value Then
    s_Sql = s_Sql & "AND psn.estadopsn" & IIf(ribParametro(1).Value, "<>'I' ", "='I' ")
  End If
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  Select Case Index
   Case 0 ' Calculo de planilla
    ...
    If s_OptRegistro = "calpllpers" Then
      s_SwRegistro = s_OptRegistro
      fCalculoPlanilla.Show vbModal
    End If
   Case 1 ' Depurar calculo de planilla
    ' Verifico que existan registros seleccionados
    If tdbRegistro.SelBookmarks.Count = 0 Then Beep: MsgBox "Debe Seleccionar Rango de Proceso", vbExclamation: Exit Sub
    If s_OptRegistro = "calpllpers" Then
      s_SwRegistro = s_OptRegistro
      o_DepuraCalculo.Show vbModal
    End If
   Case 2, 3  ' Ordena registro ascendentemente o descendentemente
    RecuperaRegistros tdbRegistro.Columns(tdbRegistro.Col).DataField & Choose(Index - 1, " ASC", " DESC")
   ...
   Case 5, 6, 7 ' Selecciono rango de impresión
    gdl_Procedure.MarcaRegistros dcaRegistro, tdbRegistro, as_SelRegistro(0), as_SelRegistro(1), (Index - 5), s_TitleTable
  End Select
...
Private Sub Form_Load()
  ...
  For n_Index = 0 To (UBound(aElemento, 1) - 1)
    aElemento(n_Index, 0) = Choose(n_Index + 1, "Código", "Apellidos y Nombre(s)", "Cargo", "Fec.Ingreso", "Ok")
    aElemento(n_Index, 1) = Choose(n_Index + 1, "codpsn", "nombrepsn", "descgo", "fecingreso", "estadopsn")
    aElemento(n_Index, 2) = Choose(n_Index + 1, 1000, 3532.66, 1250, 950, 300)
  ...
  For n_Index = 0 To (UBound(aElemento, 1) - 1)
    aElemento(n_Index, 1) = Choose(n_Index + 1, "genvouch", "borrafor", "ordascen", "orddesce", "busqueda", "selinici", "selfinal", "cancrang")
    aElemento(n_Index, 2) = Choose(n_Index + 1, "Cálculo de Planilla", "Depurar Cálculo", "Ordenar Ascendente", "Ordenar Descendente", "Buscar " & s_TitleTable$, "Establece Inicio de Rango", "Establece Fin de Rango", "Inicializa Rango de Cálculo")
  Next n_Index
