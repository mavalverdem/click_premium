...
Begin VB.Form fAbcSitrapen 
   ...
   Begin TabDlg.SSTab tabRegister 
      ...
      TabPicture(0)   =   "abcsitrapen.frx":0000
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcsitrapen.frx":00FC
      End
   End
End
Attribute VB_Name = "fAbcSitrapen"
...
Private s_stp As String                           ' Codigo del registro
'[
...
If Me.Tag = s_MdoData_Ins Then
    gdl_Procedure.EditText "PK", txtCodigo, "", Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!codstp.DefinedSize
    gdl_Procedure.EditText "AT", txtDescripcion, "", Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!desstp.DefinedSize
...
Else
    gdl_Procedure.EditText "PK", txtCodigo, fTablaSistema.dcaRegistro.Recordset!codstp, Me.Tag, True, fTablaSistema.dcaRegistro.Recordset!codstp.DefinedSize
    gdl_Procedure.EditText "AT", txtDescripcion, gdl_Funcion.aTexto(fTablaSistema.dcaRegistro.Recordset!desstp), Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!desstp.DefinedSize
    gdl_Procedure.EditOptionCheck "AT", optEstado(0), (fTablaSistema.dcaRegistro.Recordset!estadostp = s_Estado_Act), Me.Tag, True
    gdl_Procedure.EditOptionCheck "AT", optEstado(1), (fTablaSistema.dcaRegistro.Recordset!estadostp = s_Estado_Ina), Me.Tag, True
End If
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  If MsgBox("¿ Estás Seguro de Eliminar el " & lblTitle & " '" & Trim$(txtDescripcion) & "' ?", vbCritical + vbYesNo + vbDefaultButton2) = vbYes Then
    ...
    s_stp = Trim$(txtCodigo)
    
    '[ Inicio la conexión a la base de datos ]
    ps_StrgConnec = OpenConnection(ps_Servidor, ps_DataBase)
    ' Creo los arreglos de eliminacion
    a_Where = Array("codstp")
    a_Valores = Array(s_stp)
    a_Tipos = Array(TipoDato.Caracter)
      
    gdl_Conexion.IniciaTransaccion    'Inicia transacción
    ' Elimino el registro
    If Not Records_Del("plsitrapen", a_Where, a_Valores, a_Tipos) Then GoTo Error
    ...
    If Not l_ExistRecord Then
      fTablaSistema.dcaRegistro.Recordset.Find ("codstp >= '" & s_stp & "'")
...
Private Sub cmdUpdate_Click()
  ...
  a_Campos = Array("codstp", "desstp", "estadostp", IIf(Me.Tag = s_MdoData_Ins, "usrcre", "usrmdf"), IIf(Me.Tag = s_MdoData_Ins, "fyhcre", "fyhmdf"))
  ...
  If Me.Tag = s_MdoData_Ins Then
    If Not Records_Ins("plsitrapen", a_Campos, a_Valores, a_Tipos) Then GoTo Error
  Else
    If Not Records_Upd("plsitrapen", a_Campos, a_Valores, a_Tipos, a_Where) Then GoTo Error
  End If
  gdl_Conexion.ConfirmaTransaccion ' Confirma transacción
...
Private Sub Form_Load()
  ...
  s_TitleWindow = "Actualización Situacion del Trabajador Pensionista"
  lblTitle = "Situacion del Trabajador Pensionista"
  ' Coloco el puntero en espera
  gdl_Procedure.PunteroEnEspera
  ...
  If Not l_ExistRecord Then s_ParCodigo = fTablaSistema.dcaRegistro.Recordset!codstp
