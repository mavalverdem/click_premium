...
Begin VB.Form fEmpresaseqdes 
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "eqdes.frx":00C4
      End
   End
End
Attribute VB_Name = "fEmpresaseqdes"
...
Private Sub RecuperaRegistros(ByVal s_Orden As String)
  ...
  s_Sql = "SELECT codeed, ruceed,deseed,indeed,taseed,estadoeed,esteed "
  s_Sql = s_Sql & " FROM plempresaseqdes"
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  Select Case Index
   ...
   Case 6, 7  ' Opciones de impresión
    ...
    gdl_Procedure.ps_ReportTitle = "ESTABLECIMIENTOS DE EMPRESAS A QUIENES DESTACO O DESPLAZO PERSONAL"
    ...
    s_Sql = "SELECT codeed, deseed, indeed,estadoeed"
    s_Sql = s_Sql & " FROM plempresaseqdes "
...
Private Sub Form_Load()
  ...
  s_TitleTable = "Establecimientos de Empresas a quienes destaco o desplazo personal"
  
  ReDim aElemento(3, 10)
  For i = 0 To (UBound(aElemento, 1) - 1)
    aElemento(i, 0) = Choose(i + 1, "Código", "Descripción", "Ok")
    aElemento(i, 1) = Choose(i + 1, "codeed", "deseed", "estadoeed")
...
Private Sub Form_Unload(Cancel As Integer)
  ...
  If FormVisible("fAbcEmpresaseqdes") Then
    Beep
    MsgBox "Primero debe cerrar la Pantalla de " & fAbcEmpresaseqdes.Caption, vbExclamation
    Cancel = True
  End If
