...
Sub RecuperaRegistros(ByVal s_Orden As String)
  ...
  s_Sql = "SELECT ccc.codcco, ccc.orden, "
  s_Sql = s_Sql & "ccc.codctav_debmn, ccc.codctav_habmn, ccc.codctav_debme, ccc.codctav_habme, "
  s_Sql = s_Sql & "ccc.codctag_debmn, ccc.codctag_habmn, ccc.codctag_debme, ccc.codctag_habme "
  s_Sql = s_Sql & "FROM plctapvs ccc "
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  Select Case Index
   ...
   Case 6, 7  ' Opciones de impresión
    ...
    s_Sql = "SELECT cxc.codcco, cco.detcco, "
    s_Sql = s_Sql & "cxc.codctav_debmn, cxc.codctav_habmn, cxc.codctav_debme, cxc.codctav_habme, "
    s_Sql = s_Sql & "cxc.codctag_debmn, cxc.codctag_habmn, cxc.codctag_debme, cxc.codctag_habme "
    ...
    s_Sql = s_Sql & "ORDER BY codcco, orden"
...
Private Sub Form_Load()
  ...
  For n_Index = 0 To (UBound(aElemento, 1) - 1)
    aElemento(n_Index, 0) = Choose(n_Index + 1, "Debe MN", "Haber MN", "Debe ME", "Haber ME", "Debe MN", "Haber MN", "Debe ME", "Haber ME")
    aElemento(n_Index, 1) = Choose(n_Index + 1, "codctav_debmn", "codctav_habmn", "codctav_debme", "codctav_habme", "codctag_debmn", "codctag_habmn", "codctag_debme", "codctag_habme")
    aElemento(n_Index, 2) = Choose(n_Index + 1, 900, 900, 900, 900, 900, 900, 900, 900)
    aElemento(n_Index, 3) = Choose(n_Index + 1, vbLeftJustify, vbLeftJustify, vbLeftJustify, vbLeftJustify, vbLeftJustify, vbLeftJustify, vbLeftJustify, vbLeftJustify)
    ...
    aElemento(n_Index, 9) = Choose(n_Index + 1, 0, 0, 0, 0, 1, 1, 1, 1)
  Next n_Index
