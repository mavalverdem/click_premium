...
Private Sub cmdUpdate_Click()
  ...
  If txtCuenta(0) = "" Then Beep: MsgBox "Ingresar Cuenta contable vacación debe Moneda Nacional", vbExclamation: txtCuenta(0).SetFocus: Exit Sub
  If lblHelp(0) = "???" Then Beep: MsgBox "Cuenta contable vacación debe Moneda Nacional no es valido; Verificar", vbExclamation: txtCuenta(0).SetFocus: Exit Sub
  If txtCuenta(1) = "" Then Beep: MsgBox "Ingresar Cuenta contable vacación haber Moneda Nacional", vbExclamation: txtCuenta(1).SetFocus: Exit Sub
  If lblHelp(1) = "???" Then Beep: MsgBox "Cuenta contable vacación haber Moneda Nacional no es valido; Verificar", vbExclamation: txtCuenta(1).SetFocus: Exit Sub
  If txtCuenta(2) = "" Then Beep: MsgBox "Ingresar Cuenta contable vacación debe Moneda Extranjera", vbExclamation: txtCuenta(2).SetFocus: Exit Sub
  If lblHelp(2) = "???" Then Beep: MsgBox "Cuenta contable vacación debe Moneda Extranjera no es valido; Verificar", vbExclamation: txtCuenta(2).SetFocus: Exit Sub
  If txtCuenta(3) = "" Then Beep: MsgBox "Ingresar Cuenta contable vacación haber Moneda Extranjera", vbExclamation: txtCuenta(3).SetFocus: Exit Sub
  If lblHelp(3) = "???" Then Beep: MsgBox "Cuenta contable vacación haber Moneda Extranjera no es valido; Verificar", vbExclamation: txtCuenta(3).SetFocus: Exit Sub
  If txtCuenta(4) = "" Then Beep: MsgBox "Ingresar Cuenta contable gratificación debe Moneda Nacional", vbExclamation: txtCuenta(4).SetFocus: Exit Sub
  If lblHelp(4) = "???" Then Beep: MsgBox "Cuenta contable gratificación debe Moneda Nacional no es valido; Verificar", vbExclamation: txtCuenta(4).SetFocus: Exit Sub
  If txtCuenta(5) = "" Then Beep: MsgBox "Ingresar Cuenta contable gratificación haber Moneda Nacional", vbExclamation: txtCuenta(5).SetFocus: Exit Sub
  If lblHelp(5) = "???" Then Beep: MsgBox "Cuenta contable gratificación haber Moneda Nacional no es valido; Verificar", vbExclamation: txtCuenta(5).SetFocus: Exit Sub
  If txtCuenta(6) = "" Then Beep: MsgBox "Ingresar Cuenta contable gratificación debe Moneda Extranjera", vbExclamation: txtCuenta(6).SetFocus: Exit Sub
  If lblHelp(6) = "???" Then Beep: MsgBox "Cuenta contable gratificación debe Moneda Extranjera no es valido; Verificar", vbExclamation: txtCuenta(6).SetFocus: Exit Sub
  If txtCuenta(7) = "" Then Beep: MsgBox "Ingresar Cuenta contable gratificación haber Moneda Extranjera", vbExclamation: txtCuenta(7).SetFocus: Exit Sub
  If lblHelp(7) = "???" Then Beep: MsgBox "Cuenta contable gratificación haber Moneda Extranjera no es valido; Verificar", vbExclamation: txtCuenta(7).SetFocus: Exit Sub
