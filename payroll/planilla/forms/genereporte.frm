...
Begin VB.Form fGeneradoReporte 
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "genereporte.frx":00D0
      End
   End
End
Attribute VB_Name = "fGeneradoReporte"
...
Private Sub RecuperaRegistros(ByVal s_Orden As String)
  ...
  s_Sql = "SELECT codrpt, desrpt, formarpt, titulorpt,"
  s_Sql = s_Sql & " pierpt, interlinea, anchorpt"
  s_Sql = s_Sql & " FROM plgenreporte"
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  Select Case Index
   ...
   Case 6, 7  ' Opciones de impresión
    ...
    gdl_Procedure.ps_ReportTitle = "FORMATO DE REPORTES"
    gdl_Procedure.ps_ReportName = "lstformareport"
    ...
    s_Sql = "SELECT rep.codrpt, rep.desrpt, rep.formarpt, rep.anchorpt,"
    s_Sql = s_Sql & " fmt.orden, fmt.descripcion, fmt.tipo, fmt.alias,"
    s_Sql = s_Sql & " fmt.nivel, fmt.signo , fmt.impreso, fmt.longitud"
    s_Sql = s_Sql & " FROM plgenreporte rep"
    s_Sql = s_Sql & " INNER JOIN pldetareporte fmt ON rep.codcls=fmt.codcls AND rep.codrpt=fmt.codrpt"
    s_Sql = s_Sql & " WHERE rep.codcls='" & ps_ClsPlanilla & "'"
    s_Sql = s_Sql & " ORDER BY " & aElemento(0, 1) & ", orden"
...
Private Sub Form_Load()
  ...
  For i = 0 To 1
    ...
    tdbRegistro.Columns(2).ValueItems.Item(i).Value = Choose(i + 1, "H", "V")
