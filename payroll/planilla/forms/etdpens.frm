...
Begin VB.Form fEntidadPension 
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "etdpens.frx":00D0
      End
   End
End
Attribute VB_Name = "fEntidadPension"
...
Private Sub RecuperaRegistros(ByVal s_Orden As String)
  ...
  s_Sql = s_Sql & " codbco, ctacteafp, desctacteafp, ctactefondo, desctactefondo, codsunat,estadoafp"
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  Select Case Index
   ...
   Case 6, 7  ' Opciones de impresión
    ...
    s_Sql = "SELECT afp.codafp, afp.desafp, afp.factor1, afp.factor2,"
...
Private Sub Form_Unload(Cancel As Integer)
  ...
  If FormVisible("fAbcEntidadPension") Then
    Beep
    MsgBox "Primero debe cerrar la Pantalla de " & fAbcEntidadPension.Caption, vbExclamation
    Cancel = True
  End If
