...
Begin VB.Form fAbcEstablecimientoPropio 
   Caption         =   "Form1"
   ClientHeight    =   5235
   ClientLeft      =   60
   ClientTop       =   345
   ...
   Begin TabDlg.SSTab tabRegister 
      ...
      TabPicture(0)   =   "abcepropio.frx":0000
      ...
      Begin Threed.SSFrame frmCuadro 
         ...
         Begin VB.TextBox txttasa 
            ...
            Width           =   975
         End
         Begin Threed.SSOption optcentro 
            Height          =   195
            Index           =   0
            Left            =   120
            TabIndex        =   2
         ...
         Begin Threed.SSOption optcentro 
            ...
            _ExtentY        =   344
            _StockProps     =   78
            Caption         =   "No es Centro de Riesgo"
            ForeColor       =   12582912
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
      ...
      Begin Threed.SSFrame frmCuadro 
         ...
         End
         Begin VB.Label lblDato 
            Caption         =   "Codigo Establecimiento :"
            ForeColor       =   &H00000000&
            Height          =   195
            Index           =   4
            Left            =   135
   ...
   End
End
Attribute VB_Name = "fAbcEstablecimientoPropio"
...
Private s_Establecimiento As String                      ' Codigo del registro
...
Sub ShowScreen()
  ...
  If Me.Tag = s_MdoData_Ins Then
    gdl_Procedure.EditText "PK", txtCodigo, "", Me.Tag, False, fEstablecimientoPropio.dcaRegistro.Recordset!codepr.DefinedSize
    gdl_Procedure.EditText "AT", txtDescripcion, "", Me.Tag, False, fEstablecimientoPropio.dcaRegistro.Recordset!desepr.DefinedSize
    gdl_Procedure.EditText "AT", txttasa, FormatNumber(0, 2), Me.Tag, False, 6, vbRightJustify
    gdl_Procedure.EditText "AT", txttipo, "", Me.Tag, False, fEstablecimientoPropio.dcaRegistro.Recordset!tipepr.DefinedSize
    gdl_Procedure.EditText "AT", txtcodest, "", Me.Tag, False, fEstablecimientoPropio.dcaRegistro.Recordset!cdgepr.DefinedSize
    ...
    gdl_Procedure.EditOptionCheck "AT", optcentro(0), False, Me.Tag, True
    gdl_Procedure.EditOptionCheck "AT", optcentro(1), True, Me.Tag, True
  Else
    gdl_Procedure.EditText "PK", txtCodigo, fEstablecimientoPropio.dcaRegistro.Recordset!codepr, Me.Tag, True, fEstablecimientoPropio.dcaRegistro.Recordset!codepr.DefinedSize
    gdl_Procedure.EditText "AT", txtDescripcion, gdl_Funcion.aTexto(fEstablecimientoPropio.dcaRegistro.Recordset!desepr), Me.Tag, False, fEstablecimientoPropio.dcaRegistro.Recordset!desepr.DefinedSize
    gdl_Procedure.EditText "AT", txttasa, FormatNumber(fEstablecimientoPropio.dcaRegistro.Recordset!tasepr, 2), Me.Tag, False, 6, vbRightJustify
    gdl_Procedure.EditText "AT", txtcodest, gdl_Funcion.aTexto(fEstablecimientoPropio.dcaRegistro.Recordset!cdgepr), Me.Tag, False, fEstablecimientoPropio.dcaRegistro.Recordset!cdgepr.DefinedSize
    gdl_Procedure.EditText "AT", txttipo, gdl_Funcion.aTexto(fEstablecimientoPropio.dcaRegistro.Recordset!tipepr), Me.Tag, False, fEstablecimientoPropio.dcaRegistro.Recordset!tipepr.DefinedSize
    gdl_Procedure.EditOptionCheck "AT", optcentro(0), (fEstablecimientoPropio.dcaRegistro.Recordset!indepr = s_Centro_Act), Me.Tag, True
    gdl_Procedure.EditOptionCheck "AT", optcentro(1), (fEstablecimientoPropio.dcaRegistro.Recordset!indepr = s_Centro_Ina), Me.Tag, True
    gdl_Procedure.EditOptionCheck "AT", optEstado(0), (fEstablecimientoPropio.dcaRegistro.Recordset!estadoepr = s_Estado_Act), Me.Tag, True
    gdl_Procedure.EditOptionCheck "AT", optEstado(1), (fEstablecimientoPropio.dcaRegistro.Recordset!estadoepr = s_Estado_Ina), Me.Tag, True
  End If
  lblHelp(0) = gdl_Funcion.DameDescripcion(ps_StrgConnec & ps_DataBase, ps_CodEmpresa, txttipo, "TE")
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  If MsgBox("¿ Estás Seguro de Eliminar el " & lblTitle & " '" & Trim$(txtDescripcion) & "' ?", vbCritical + vbYesNo + vbDefaultButton2) = vbYes Then
    ...
    s_Establecimiento = Trim$(txtCodigo)
    
    '[ Inicio la conexión a la base de datos ]
    ps_StrgConnec = OpenConnection(ps_Servidor, ps_DataBase)
    ' Creo los arreglos de eliminacion
    a_Where = Array("codepr")
    a_Valores = Array(s_Establecimiento)
    a_Tipos = Array(TipoDato.Caracter)
      
    gdl_Conexion.IniciaTransaccion    'Inicia transacción
    ' Elimino el registro
    If Not Records_Del("plestablecimientopropio", a_Where, a_Valores, a_Tipos) Then GoTo Error
    gdl_Conexion.ConfirmaTransaccion  'Confirma transacción
    
    MsgBox "Se Elimino exitosamente " & lblTitle, vbInformation
    ' Refresco el Ado control y la grilla
    gdl_Procedure.RefreshAdoControl fEstablecimientoPropio.dcaRegistro, fEstablecimientoPropio.tdbRegistro, lblTitle
    ' Verifico si aun existen registros
    l_ExistRecord = ((fEstablecimientoPropio.dcaRegistro.Recordset.EOF And fEstablecimientoPropio.dcaRegistro.Recordset.BOF) Or fEstablecimientoPropio.dcaRegistro.Recordset.RecordCount = 0)
    If Not l_ExistRecord Then
      fEstablecimientoPropio.dcaRegistro.Recordset.Find ("codepr >= '" & s_Establecimiento & "'")
      If fEstablecimientoPropio.dcaRegistro.Recordset.EOF Then fEstablecimientoPropio.dcaRegistro.Recordset.MoveLast
    Else
      Unload Me
    End If
  End If
...
Private Sub cmdMove_Click(Index As Integer)
  ...
  Select Case Index
   Case 0: fEstablecimientoPropio.dcaRegistro.Recordset.MoveFirst
   Case 1: If Not fEstablecimientoPropio.dcaRegistro.Recordset.BOF Then fEstablecimientoPropio.dcaRegistro.Recordset.MovePrevious
           If fEstablecimientoPropio.dcaRegistro.Recordset.BOF Then fEstablecimientoPropio.dcaRegistro.Recordset.MoveFirst
   Case 2: If Not fEstablecimientoPropio.dcaRegistro.Recordset.EOF Then fEstablecimientoPropio.dcaRegistro.Recordset.MoveNext
           If fEstablecimientoPropio.dcaRegistro.Recordset.EOF Then fEstablecimientoPropio.dcaRegistro.Recordset.MoveLast
   Case 3: fEstablecimientoPropio.dcaRegistro.Recordset.MoveLast
  End Select

End Sub
Private Sub cmdUpdate_Click()
  Dim s_Estado As String * 1
  Dim s_Centro As String * 1

  ' Realizo las validaciones de los campos a actualizar
  If txtCodigo = "" Then Beep: MsgBox "Debe Ingresar el Codigo de " & lblTitle, vbExclamation: txtCodigo.SetFocus: Exit Sub
  If txtDescripcion = "" Then Beep: MsgBox "Debe Ingresar la Descripción " & lblTitle, vbExclamation: txtDescripcion.SetFocus: Exit Sub
  If txttipo = "" Then Beep: MsgBox "Debe Ingresar el Tipo de Establecimiento " & lblTitle, vbExclamation: txtcodest.SetFocus: Exit Sub
  If lblHelp(0) = "???" Then Beep: MsgBox "El Tipo de Establecimiento no es valido; Verificar", vbExclamation: txttipo.SetFocus: Exit Sub
  If txtcodest = "" Then Beep: MsgBox "Debe Ingresar Codigo de Establecimiento " & lblTitle, vbExclamation: txtcodest.SetFocus: Exit Sub
  
  If optcentro(0).Value = True And txttasa.Text = 0 Then Beep: MsgBox "Tasa tiene que ser mayor a Cero, por ser Centro de Riesgo " & lblTitle, vbExclamation: txtDescripcion.SetFocus: Exit Sub
    
  s_Estado = IIf(optEstado(0).Value, s_Estado_Act, s_Estado_Ina)
  s_Centro = IIf(optcentro(0).Value, s_Centro_Act, s_Centro_Ina)
  
  ' Coloco el puntero en espera
  gdl_Procedure.PunteroEnEspera
  ' Capturo el registro a actualizar
  s_Establecimiento = txtCodigo
    
  ' Creo los arreglos para la actualización
  a_Campos = Array("codepr", "desepr", "tipepr", "cdgepr", "indepr", "tasepr", "estadoepr", IIf(Me.Tag = s_MdoData_Ins, "usrcre", "usrmdf"), IIf(Me.Tag = s_MdoData_Ins, "fyhcre", "fyhmdf"))
  a_Valores = Array(txtCodigo, Trim$(txtDescripcion), Trim$(txttipo), Trim$(txtcodest), s_Centro, CDec(txttasa), s_Estado, ps_Usuario, Format(Now, s_FmtFeHoMysql_0))
  a_Tipos = Array(TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Numero, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter)
  a_Where = Array("codepr")
  ...
  If Me.Tag = s_MdoData_Ins Then
    If Not Records_Ins("plestablecimientopropio", a_Campos, a_Valores, a_Tipos) Then GoTo Error
  Else
    If Not Records_Upd("plestablecimientopropio", a_Campos, a_Valores, a_Tipos, a_Where) Then GoTo Error
  End If
  gdl_Conexion.ConfirmaTransaccion ' Confirma transacción
...
Private Sub Form_Load()
  ...
  Me.Height = 5640: Me.Width = 7830
  Me.Left = 1080: Me.Top = 600
  
  ' Titulo del formulario y panel
  s_TitleWindow = "Actualización Establecimientos Propios"
  lblTitle = "Establecimientos Propios"
  n_IndexHelp = -1
' Coloco el puntero en espera
  gdl_Procedure.PunteroEnEspera
  
  ' Obtengo el modo de operación del registro
  Me.Tag = fEstablecimientoPropio.Tag
  ...
  l_ExistRecord = (fEstablecimientoPropio.dcaRegistro.Recordset.EOF Or fEstablecimientoPropio.dcaRegistro.Recordset.BOF)
  If Not l_ExistRecord Then s_ParCodigo = fEstablecimientoPropio.dcaRegistro.Recordset!codepr
 ...
 '[ Configuración de la grilla de ayuda
  ...
  For n_Index = 0 To (UBound(aElemento, 1) - 1)
      ...
      aElemento(n_Index, 1) = Choose(n_Index + 1, "codest", "desest")
  ...
  gdl_Procedure.DefineStyleGrilla tdbHelp, "Tipo de Establecimiento", 2
  ' Asigno el control de datos  ala grilla
  tdbHelp.DataSource = dcaHelp
  
  ' Recupero la información
  s_Sql = gdl_Funcion.HelpTablas("est", tdbHelp.Columns(0).DataField, "", "")
...
Private Sub optcentro_Click(Index As Integer, Value As Integer)
If Index = 0 Then
...
Private Sub tdbHelp_HeadClick(ByVal ColIndex As Integer)
  ...
  s_Sql = gdl_Funcion.HelpTablas("est", tdbHelp.Columns(ColIndex).DataField, "", "")
...
Private Sub tdbHelp_KeyPress(KeyAscii As Integer)
  ...
  ElseIf (UCase$(Chr$(KeyAscii)) >= "A" And UCase$(Chr$(KeyAscii)) <= "Z") Or _
    ...
    s_Sql = gdl_Funcion.HelpTablas("est", tdbHelp.Columns(n_Columna).DataField, "", s_SqlHelp)
    dcaHelp.RecordSource = s_Sql
    dcaHelp.Refresh
...
Private Sub txttasa_Validate(Cancel As Boolean)
  ...
  If CDec(txttasa.Text) < 0 Then MsgBox "Factor no puede ser negativo; Verifique", vbInformation: txttasa.SetFocus: Exit Sub
