...
Begin VB.Form fEstablecimientoPropio 
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "epropio.frx":00C4
      End
   End
End
Attribute VB_Name = "fEstablecimientoPropio"
...
Private Sub RecuperaRegistros(ByVal s_Orden As String)
  ...
  s_Sql = "SELECT codepr, tipepr, cdgepr, desepr,indepr, tasepr,estadoepr"
  s_Sql = s_Sql & " FROM plestablecimientopropio"
  ...
  Select Case Index
   Case 0, 2  ' Visualizar o analizar, eliminar registro
    If Not (dcaRegistro.Recordset.EOF Or dcaRegistro.Recordset.BOF) Then
      ...
      fAbcEstablecimientoPropio.Show
    End If
   ...
   Case 6, 7  ' Opciones de impresión
    ...
    gdl_Procedure.ps_ReportTitle = "ESTABLECIMIENTOS PROPIOS"
    gdl_Procedure.ps_ReportName = "lstestablecimientopropio"
    ...
    s_Sql = "SELECT codepr, tipepr, cdgepr, desepr,"
    s_Sql = s_Sql & " indepr , tasepr, estadoepr"
    s_Sql = s_Sql & " FROM plestablecimientopropio afp"
...
Private Sub dcaRegistro_MoveComplete(ByVal adReason As ADODB.EventReasonEnum, ByVal pError As ADODB.Error, adStatus As ADODB.EventStatusEnum, ByVal pRecordset As ADODB.Recordset)
  ...
  If FormVisible("fAbcEstablecimientoPropio") Then
    If Not dcaRegistro.Recordset.EOF And Not dcaRegistro.Recordset.BOF Then
      fAbcEstablecimientoPropio.ShowScreen
    End If
  End If
...
Private Sub Form_Unload(Cancel As Integer)
  ...
  If FormVisible("fAbcEstablecimientoPropio") Then
    Beep
    MsgBox "Primero debe cerrar la Pantalla de " & fAbcEstablecimientoPropio.Caption, vbExclamation
    Cancel = True
  End If
