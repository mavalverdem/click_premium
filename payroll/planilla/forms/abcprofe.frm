...
Begin VB.Form fAbcProfesion 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   3405
   ClientLeft      =   2265
   ClientTop       =   375
   ClientWidth     =   7200
   Icon            =   "abcprofe.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin TabDlg.SSTab tabRegister 
      ...
      TabPicture(0)   =   "abcprofe.frx":000C
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcprofe.frx":0108
      End
   End
End
Attribute VB_Name = "fAbcProfesion"
...
Private s_Profesion As String                           ' Codigo del registro
'[
...
If Me.Tag = s_MdoData_Ins Then
    gdl_Procedure.EditText "PK", txtCodigo, "", Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!codpfs.DefinedSize
    gdl_Procedure.EditText "AT", txtDescripcion, "", Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!despfs.DefinedSize
...
Else
    gdl_Procedure.EditText "PK", txtCodigo, fTablaSistema.dcaRegistro.Recordset!codpfs, Me.Tag, True, fTablaSistema.dcaRegistro.Recordset!codpfs.DefinedSize
    gdl_Procedure.EditText "AT", txtDescripcion, gdl_Funcion.aTexto(fTablaSistema.dcaRegistro.Recordset!despfs), Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!despfs.DefinedSize
    gdl_Procedure.EditOptionCheck "AT", optEstado(0), (fTablaSistema.dcaRegistro.Recordset!estadopfs = s_Estado_Act), Me.Tag, True
    gdl_Procedure.EditOptionCheck "AT", optEstado(1), (fTablaSistema.dcaRegistro.Recordset!estadopfs = s_Estado_Ina), Me.Tag, True
End If
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  If MsgBox("¿ Estás Seguro de Eliminar el " & lblTitle & " '" & Trim$(txtDescripcion) & "' ?", vbCritical + vbYesNo + vbDefaultButton2) = vbYes Then
    ...
    s_Profesion = Trim$(txtCodigo)
    
    '[ Inicio la conexión a la base de datos ]
    ps_StrgConnec = OpenConnection(ps_Servidor, ps_DataBase)
    ' Creo los arreglos de eliminacion
    a_Where = Array("codpfs")
    a_Valores = Array(s_Profesion)
    a_Tipos = Array(TipoDato.Caracter)
      
    gdl_Conexion.IniciaTransaccion    'Inicia transacción
    ' Elimino el registro
    If Not Records_Del("plprofesion", a_Where, a_Valores, a_Tipos) Then GoTo Error
    ...
    If Not l_ExistRecord Then
      fTablaSistema.dcaRegistro.Recordset.Find ("codpfs >= '" & s_Profesion & "'")
...
Private Sub cmdUpdate_Click()
  ...
  s_Profesion = txtCodigo
    
  ' Creo los arreglos para la actualización
  a_Campos = Array("codpfs", "despfs", "estadopfs", IIf(Me.Tag = s_MdoData_Ins, "usrcre", "usrmdf"), IIf(Me.Tag = s_MdoData_Ins, "fyhcre", "fyhmdf"))
  ...
  If Me.Tag = s_MdoData_Ins Then
    If Not Records_Ins("plprofesion", a_Campos, a_Valores, a_Tipos) Then GoTo Error
  Else
    If Not Records_Upd("plprofesion", a_Campos, a_Valores, a_Tipos, a_Where) Then GoTo Error
  End If
  gdl_Conexion.ConfirmaTransaccion ' Confirma transacción
...
Private Sub Form_Load()
  ...
  s_TitleWindow = "Actualización Profesión u Oficio"
  lblTitle = "Profesión u Oficio"
  ' Coloco el puntero en espera
  gdl_Procedure.PunteroEnEspera
  ...
  If Not l_ExistRecord Then s_ParCodigo = fTablaSistema.dcaRegistro.Recordset!codpfs
