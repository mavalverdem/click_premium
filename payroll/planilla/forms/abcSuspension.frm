...
Private Sub cmdAction_Click(Index As Integer)
  ...
  Beep
  If MsgBox("¿ Estás Seguro de Eliminar este " & lblTitle & "' ?", vbCritical + vbYesNo + vbDefaultButton2) = vbYes Then
...
Private Sub Form_Load()
  ...
  s_TitleWindow = "Actualización Suspension Cuarta Categoria"
