...
Begin VB.Form fAbcLargaDistancia 
   ...
   Begin TabDlg.SSTab tabRegister 
      ...
      TabPicture(0)   =   "abclargadistancia.frx":0000
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdCancel 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abclargadistancia.frx":001C
      End
      Begin Threed.SSCommand cmdUpdate 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abclargadistancia.frx":0038
      End
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdMove 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abclargadistancia.frx":0054
      End
      Begin Threed.SSCommand cmdMove 
         Height          =   360
         Index           =   2
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abclargadistancia.frx":0070
      End
      Begin Threed.SSCommand cmdMove 
         Height          =   360
         Index           =   1
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abclargadistancia.frx":008C
      End
      Begin Threed.SSCommand cmdMove 
         Height          =   360
         Index           =   0
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abclargadistancia.frx":00A8
      End
   End
   Begin Threed.SSPanel panToolBar 
      Height          =   2205
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abclargadistancia.frx":00C4
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   1
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abclargadistancia.frx":00E0
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   2
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abclargadistancia.frx":00FC
      End
   End
End
Attribute VB_Name = "fAbcLargaDistancia"
...
Private s_LargaDistancia As String                      ' Codigo del registro
'[
...
If Me.Tag = s_MdoData_Ins Then
    gdl_Procedure.EditText "PK", txtCodigo, "", Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!codldn.DefinedSize
    gdl_Procedure.EditText "AT", txtDescripcion, "", Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!desldn.DefinedSize
...
Else
    gdl_Procedure.EditText "PK", txtCodigo, fTablaSistema.dcaRegistro.Recordset!codldn, Me.Tag, True, fTablaSistema.dcaRegistro.Recordset!codldn.DefinedSize
    gdl_Procedure.EditText "AT", txtDescripcion, gdl_Funcion.aTexto(fTablaSistema.dcaRegistro.Recordset!desldn), Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!desldn.DefinedSize
    gdl_Procedure.EditOptionCheck "AT", optEstado(0), (fTablaSistema.dcaRegistro.Recordset!estadoldn = s_Estado_Act), Me.Tag, True
    gdl_Procedure.EditOptionCheck "AT", optEstado(1), (fTablaSistema.dcaRegistro.Recordset!estadoldn = s_Estado_Ina), Me.Tag, True
End If
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  If MsgBox("¿ Estás Seguro de Eliminar el " & lblTitle & " '" & Trim$(txtDescripcion.Text) & "' ?", vbCritical + vbYesNo + vbDefaultButton2) = vbYes Then
    ...
    s_LargaDistancia = Trim$(txtCodigo.Text)
    
    '[ Inicio la conexión a la base de datos ]
    ps_StrgConnec = OpenConnection(ps_Servidor, ps_DataBase)
    ' Creo los arreglos de eliminacion
    a_Where = Array("codldn")
    a_Valores = Array(s_LargaDistancia)
    a_Tipos = Array(TipoDato.Caracter)
      
    gdl_Conexion.IniciaTransaccion    'Inicia transacción
    ' Elimino el registro
    If Not Records_Del("plcodigoldn", a_Where, a_Valores, a_Tipos) Then GoTo Error
    ...
    If Not l_ExistRecord Then
      fTablaSistema.dcaRegistro.Recordset.Find ("codldn >= '" & s_LargaDistancia & "'")
...
Private Sub cmdUpdate_Click()
  ...
  s_LargaDistancia = txtCodigo
    
  ' Creo los arreglos para la actualización
  a_Campos = Array("codldn", "desldn", "estadoldn", IIf(Me.Tag = s_MdoData_Ins, "usrcre", "usrmdf"), IIf(Me.Tag = s_MdoData_Ins, "fyhcre", "fyhmdf"))
  a_Valores = Array(txtCodigo.Text, Trim$(txtDescripcion.Text), s_Estado, ps_Usuario, Format(Now, s_FmtFeHoMysql_0))
  ...
  If Me.Tag = s_MdoData_Ins Then
    If Not Records_Ins("plcodigoldn", a_Campos, a_Valores, a_Tipos) Then GoTo Error
  Else
    If Not Records_Upd("plcodigoldn", a_Campos, a_Valores, a_Tipos, a_Where) Then GoTo Error
  End If
  gdl_Conexion.ConfirmaTransaccion ' Confirma transacción
...
Private Sub Form_Load()
  ...
  s_TitleWindow = "Actualización Larga Distancia Nacional"
  lblTitle = "Larga Distancia Nacional"
  ' Coloco el puntero en espera
  gdl_Procedure.PunteroEnEspera
  ...
  If Not l_ExistRecord Then s_ParCodigo = fTablaSistema.dcaRegistro.Recordset!codldn
