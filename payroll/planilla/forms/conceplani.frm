...
Begin VB.Form fConceptoPlanilla 
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "conceplani.frx":00D0
      End
   End
End
Attribute VB_Name = "fConceptoPlanilla"
...
Private Sub RecuperaRegistros(ByVal s_Orden As String)
  ...
  s_Sql = "SELECT cxc.codcpc, cpc.descpc, cxc.clasecpc, cxc.defaultcpc,"
  s_Sql = s_Sql & " cxc.impbolecpc, cxc.formulafun, cxc.imagenfun,cxc.codsunat"
  s_Sql = s_Sql & " FROM plconceplanilla cxc, plconcepto cpc"
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  Select Case Index
   ...
   Case 6, 7  ' Opciones de impresión
    ...
    gdl_Procedure.ps_ReportTitle = "CONCEPTOS DE PLANILLA DE CALCULO"
    gdl_Procedure.ps_ReportName = "lstconceplanil"
    ...
    aElemento(1, 0) = "": aElemento(1, 1) = "TituloReporte="""
    ...
    s_Sql = "SELECT cxc.codcpc, cpc.descpc, cpc.aliascpc, cpc.tipocpc,"
    s_Sql = s_Sql & " cxc.clasecpc, cxc.defaultcpc, cxc.impbolecpc, cxc.codsunat, sun.descon, sun.tipcon"
    s_Sql = s_Sql & " FROM plconceplanilla cxc"
    s_Sql = s_Sql & " INNER JOIN plconcepto cpc on cxc.codcpc=cpc.codcpc"
    s_Sql = s_Sql & " LEFT JOIN plconcesunat sun on cxc.codsunat=sun.codcon"
    s_Sql = s_Sql & " WHERE cxc.codcls='" & ps_ClsPlanilla & "'"
...
Private Sub Form_Load()
  ...
  For i = 0 To (UBound(aElemento, 1) - 1)
    aElemento(i, 0) = Choose(i + 1, "Código", "Descripción", "Tp")
    aElemento(i, 1) = Choose(i + 1, "codcpc", "descpc", "clasecpc")
    aElemento(i, 2) = Choose(i + 1, 800, 3555.213, 300)
  ...
  For i = 0 To 1
    ...
    tdbRegistro.Columns(2).ValueItems.Item(i).Value = Choose(i + 1, "C", "F")
    tdbRegistro.Columns(2).ValueItems.Item(i).DisplayValue = LoadPicture(gdl_Procedure.ps_PathImagen & Choose(i + 1, "constant", "funcion") & ".bmp")
  Next i
