...
Begin VB.Form fAbcUbicacion 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   3405
   ClientLeft      =   2265
   ClientTop       =   375
   ClientWidth     =   7200
   Icon            =   "abcubicacion.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin TabDlg.SSTab tabRegister 
      ...
      TabPicture(0)   =   "abcubicacion.frx":000C
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcubicacion.frx":0108
      End
   End
End
Attribute VB_Name = "fAbcUbicacion"
...
If Me.Tag = s_MdoData_Ins Then
  gdl_Procedure.EditText "PK", txtCodigo, "", Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!codubica.DefinedSize
  gdl_Procedure.EditText "AT", txtDescripcion, "", Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!desubica.DefinedSize
  gdl_Procedure.EditText "AT", txtInterno, "", Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!codinterubica.DefinedSize
...
Else
  gdl_Procedure.EditText "PK", txtCodigo, fTablaSistema.dcaRegistro.Recordset!codubica, Me.Tag, True, fTablaSistema.dcaRegistro.Recordset!codubica.DefinedSize
  gdl_Procedure.EditText "AT", txtDescripcion, gdl_Funcion.aTexto(fTablaSistema.dcaRegistro.Recordset!desubica), Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!desubica.DefinedSize
  gdl_Procedure.EditText "AT", txtInterno, gdl_Funcion.aTexto(fTablaSistema.dcaRegistro.Recordset!codinterubica), Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!codinterubica.DefinedSize
  gdl_Procedure.EditOptionCheck "AT", optEstado(0), (fTablaSistema.dcaRegistro.Recordset!estadoubica = s_Estado_Act), Me.Tag, True
  gdl_Procedure.EditOptionCheck "AT", optEstado(1), (fTablaSistema.dcaRegistro.Recordset!estadoubica = s_Estado_Ina), Me.Tag, True
End If
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  If MsgBox("¿ Estás Seguro de Eliminar el " & lblTitle & " '" & Trim$(txtDescripcion) & "' ?", vbCritical + vbYesNo + vbDefaultButton2) = vbYes Then
    ...
    a_Where = Array("codubica")
    a_Valores = Array(s_Registro)
    a_Tipos = Array(TipoDato.Caracter)
      
    gdl_Conexion.IniciaTransaccion    'Inicia transacción
    ' Elimino el registro
    If Not Records_Del("plubicacion", a_Where, a_Valores, a_Tipos) Then GoTo Error
    ...
    If Not l_ExistRecord Then
      fTablaSistema.dcaRegistro.Recordset.Find ("codubica >= '" & s_Registro & "'")
...
Private Sub cmdUpdate_Click()
  ...
  If txtDescripcion.Text = "" Then Beep: MsgBox "Debe Ingresar la Descripción " & lblTitle, vbExclamation: txtDescripcion.SetFocus: Exit Sub
  ...
  a_Campos = Array("codubica", "desubica", "codinterubica", "estadoubica", IIf(Me.Tag = s_MdoData_Ins, "usrcre", "usrmdf"), IIf(Me.Tag = s_MdoData_Ins, "fyhcre", "fyhmdf"))
  a_Valores = Array(txtCodigo.Text, Trim$(txtDescripcion.Text), Trim(txtInterno.Text), s_Estado, ps_Usuario, Format(Now, s_FmtFeHoMysql_0))
  ...
  If Me.Tag = s_MdoData_Ins Then
    If Not Records_Ins("plubicacion", a_Campos, a_Valores, a_Tipos) Then GoTo Error
  Else
    If Not Records_Upd("plubicacion", a_Campos, a_Valores, a_Tipos, a_Where) Then GoTo Error
  End If
  gdl_Conexion.ConfirmaTransaccion ' Confirma transacción
...
Private Sub Form_Load()
  ...
  s_TitleWindow = "Actualización Ubicación o Localidad"
  lblTitle = "Ubicación o Localidad"
  ' Coloco el puntero en espera
  gdl_Procedure.PunteroEnEspera
  ...
  If Not l_ExistRecord Then s_ParCodigo = fTablaSistema.dcaRegistro.Recordset!codubica
...
Private Sub txtInterno_GotFocus()
  gdl_Procedure.MarcaGet txtInterno
End Sub
