...
Begin VB.Form fReporteBoleta 
   ...
   Begin TabDlg.SSTab tabRegister 
      ...
      TabPicture(0)   =   "rptboleta.frx":01CC
...
Private Sub PrnBoletaGenerica(ByVal nTabIndex As Integer, ByVal s_Proceso As String, ByVal s_FechaHora As String, ByVal s_Tabla As String, ByVal n_Accion As Integer)
  ...
  s_Sql = s_Sql & "(asi.diaprepostnatal+asi.enfermedad) AS diasubsidio, (asi.licencia+asi.diavacaciones) AS dianolaboral, asi.accidente, "
  ...
  s_Sql = s_Sql & "pdo.fechaini, pdo.fechafin, pdo.fechapago, "
  ...
  s_Sql = s_Sql & "asi.diavacaventa, "
  s_Sql = s_Sql & "CASE  WHEN asi.pdovaca1 IS NOT NULL THEN CONCAT(LEFT(pdovaca1,4),'-',right(asi.pdovaca1,4) ) ELSE '' END AS pervaca1, "
  s_Sql = s_Sql & "CASE  WHEN asi.pdovaca2 IS NOT NULL THEN CONCAT(LEFT(pdovaca2,4),'-',right(asi.pdovaca2,4) ) ELSE '' END AS pervaca2, "
  s_Sql = s_Sql & "CASE  WHEN asi.pdovaca3 IS NOT NULL THEN CONCAT(LEFT(pdovaca3,4),'-',right(asi.pdovaca3,4) ) ELSE '' END AS pervaca3, asi.indvacadelanta "
  ...
  End If
  s_Sql = s_Sql & "ORDER BY " & Choose(nTabIndex + 1, "", "dxr.codcco, ", "dxr.codubica, ", "dxr.codsec, ") & "nompsn"
  ...
  s_Sql = s_Sql & "psn.dianolaboral, psn.accidente, psn.diavacaciones, psn.diatradesemanal, psn.diasuspension, psn.dialibre, psn.licencia, "
  ...
  s_Sql = s_Sql & "psn.basico, psn.detcco, psn.fechaini, psn.fechafin, psn.fechapago, "
  s_Sql = s_Sql & "psn.descdt, psn.desdci, psn.destpt, "
  s_Sql = s_Sql & "psn.tardanza, psn.seccion, psn.ubicacion, psn.codtab,psn.diavacaventa, "
  s_Sql = s_Sql & "psn.pervaca1, psn.pervaca2, psn.pervaca3, psn.indvacadelanta "
    ...
    Do While Not porstRecordset.EOF
      ...
      For n_Index = 1 To nDetalle
        ...
        a_Campos = Array("codpsn", "nompsn", "codcgo", "descgo", "fecingreso", "nroessalud", "despdo", "desconfianza", _
                        ...
                        "descpcdsc", "impcpcdsc", "codcpcapo", "descpcapo", "impcpcapo", "moneda", "monpago", "importipcmb", "impornetocmb", "salinicte", "salfincte", "detcco", "fechaini", "fechafin", "fechapago", _
                        "descdt", "tipdoc", "tiptra", "tardanza", "diavacaciones", "diatradesemanal", "diasuspension", "dialibre", "dialicencia", "diaenfermedad", "seccion", "ubicacion", "codtab", "diavacaventa", "pervaca1", "pervaca2", "pervaca3", "indvacadelanta")
        a_Valores = Array(porstRecordset("codpsn"), porstRecordset("nompsn"), porstRecordset("codcgo"), porstRecordset("descgo"), Format(porstRecordset("fecingreso"), s_FmtFechMysql_0), porstRecordset("nroessalud"), porstRecordset("despdo"), s_DesConfianza, _
                          Format(porstRecordset("fechainivacacion"), s_FmtFechMysql_0), Format(porstRecordset("fechafinvacacion"), s_FmtFechMysql_0), porstRecordset("numdociden"), porstRecordset("numeroafp"), porstRecordset("codafp"), porstRecordset("desafp"), CInt(porstRecordset("diatrabajo")), CInt(porstRecordset("diasubsidio")), CInt(porstRecordset("diaferiado")), CInt(porstRecordset("diafalta")), CInt(porstRecordset("dialaboral")), CInt(porstRecordset("dianolaboral")), _
                          ...
                          a_Boleta(5), a_Boleta(8), a_Boleta(3), a_Boleta(6), a_Boleta(9), sMoneda, sMonedaPago, CDec(porstRecordset("tipocambio")), nImportePag, nSalIniCtaCte, nSalFinCtaCte, porstRecordset("detcco"), Format(porstRecordset("fechaini"), s_FmtFechMysql_0), Format(porstRecordset("fechafin"), s_FmtFechMysql_0), Format(porstRecordset("fechapago"), s_FmtFechMysql_0), _
                          porstRecordset("descdt"), porstRecordset("desdci"), porstRecordset("destpt"), porstRecordset("tardanza"), porstRecordset("diavacaciones"), porstRecordset("diatradesemanal"), porstRecordset("diasuspension"), porstRecordset("dialibre"), porstRecordset("licencia"), porstRecordset("accidente"), porstRecordset("seccion"), porstRecordset("ubicacion"), porstRecordset!codtab, porstRecordset!diavacaventa, porstRecordset!pervaca1, porstRecordset!pervaca2, porstRecordset!pervaca3, porstRecordset!indvacadelanta)
        a_Tipos = Array(TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter, TipoDato.FECHA, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter, _
                        ...
                        TipoDato.Caracter, TipoDato.Numero, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Numero, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Numero, TipoDato.Numero, TipoDato.Numero, TipoDato.Numero, TipoDato.Caracter, TipoDato.FECHA, TipoDato.FECHA, TipoDato.FECHA, _
                        TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Numero, TipoDato.Numero, TipoDato.Numero, TipoDato.Numero, TipoDato.Numero, TipoDato.Numero, TipoDato.Numero, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Numero, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter)
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  Select Case Index
   ...
   Case 6, 7, 8, 9 ' Opciones de impresión
    ...
    sDireccion = ""
    s_Sql = "SELECT via.abrevia, cfg.direccionvia, cfg.numerodir, zon.abrezona, cfg.direccionzona, cfg.ubigeodir "
    ...
    s_Sql = s_Sql & "WHERE cfg.pdoano='" & ps_Anyo & "' and cfg.dirimpbol=1 "
    ...
    Else
      ...
      aElemento(2, 1) = "TituloReporte;" & IIf(s_FmtBoleta = "3", "RECIBO DE PAGO (", "BOLETA DE REMUNERACIONES - SUELDOS (") & IIf(fMenu.ribMoneda(0).Value, s_Codmon_mn_Txt, s_Codmon_me_Txt) & ")" & ";true"
      ...
      s_Sql = s_Sql & "diatrabajo smallint(3) Null Default '0', diaferiado smallint(3) Null Default '0', "
      ...
      s_Sql = s_Sql & "horaextrax decimal(6,2) Null Default '0', fecbaja date Null, copia char(1) Not Null, "
      s_Sql = s_Sql & "secuencia smallint(3) Not Null, basico decimal(18,2) Null Default '0', "
      ...
      s_Sql = s_Sql & "fechaini date Null, fechafin date Null, fechapago date Null, "
      s_Sql = s_Sql & "dialaboral smallint(3) Null Default '0', dianolaboral smallint(3) Null Default '0', "
      s_Sql = s_Sql & "diasubsidio smallint(3) Null Default '0', diafalta smallint(3) Null Default '0', "
      s_Sql = s_Sql & "diavacaciones smallint(3) Null Default '0', diatradesemanal smallint(3) Null Default '0', "
      s_Sql = s_Sql & "diasuspension smallint(3) Null Default '0', dialibre smallint(3) Null Default '0', "
      s_Sql = s_Sql & "dialicencia smallint(3) Null Default '0', diaenfermedad smallint(3) Null Default '0', "
      s_Sql = s_Sql & "tipdoc varchar(40) Null, tiptra varchar(40) Null, "
      s_Sql = s_Sql & "tardanza decimal(6,2) Null Default '0', seccion varchar(40) Null, ubicacion varchar(40) Null, codtab varchar(11) Not Null, "
      s_Sql = s_Sql & "diavacaventa smallint(3) Null Default '0', "
      s_Sql = s_Sql & "pervaca1 varchar(12) Null, pervaca2 varchar(12) Null, pervaca3 varchar(12) Null, "
      s_Sql = s_Sql & "indvacadelanta char(1) Null, "
      ...
      s_Sql = s_Sql & "(CASE WHEN bol.indvacadelanta='" & s_Estado_Ina & "' THEN bol.fechainivacacion ELSE Null END) AS fechainivacacion, "
      s_Sql = s_Sql & "(CASE WHEN bol.indvacadelanta='" & s_Estado_Ina & "' THEN bol.fechafinvacacion ELSE Null END) AS fechafinvacacion, "
      s_Sql = s_Sql & "bol.numdociden, bol.numeroafp, bol.codafp, bol.desafp, bol.diatrabajo, bol.horanormal, "
      ...
      If s_FmtBoleta = 0 Or s_FmtBoleta = 2 Or s_FmtBoleta = 3 Or s_FmtBoleta = 5 Or s_FmtBoleta = 7 Or s_FmtBoleta = 11 Then
        s_Sql = s_Sql & IIf(((ribOrdenar.Value = True) And (nTabIndex = 0)), "Null", "bol.codtab") & " AS codtab, "
      ElseIf s_FmtBoleta = 1 Then
        s_Sql = s_Sql & IIf(((ribOrdenar.Value = True) And (nTabIndex = 0)), "Null", "bol.codtab") & " AS codtab, "
        s_Sql = s_Sql & "bol.diasubsidio, bol.diafalta, bol.tardanza, "
      ElseIf s_FmtBoleta = 4 Then
        s_Sql = s_Sql & "(CASE psn.sexopsn WHEN '0' THEN 'M' ELSE 'F' END) AS Sexo, desnac, "
        ...
        s_Sql = s_Sql & "bol.seccion, psn.fecnacimiento, bol.horaextra4, "
        s_Sql = s_Sql & "(CASE WHEN bol.indvacadelanta='" & s_Estado_Act & "' THEN bol.diavacaciones ELSE 0 END) AS diavacaciones, "
        s_Sql = s_Sql & "bol.tiptra, (CASE WHEN psn.interbankpago='" & s_Estado_Act & "' THEN bnk.desbco ELSE bco.desbco END) AS desbco, psn.cuentapago, bol.fechapago, dci.sigladci, "
        s_Sql = s_Sql & IIf(((ribOrdenar.Value = True) And (nTabIndex = 0)), "Null", "bol.codtab") & " AS codtab, "
      ElseIf s_FmtBoleta = 6 Then
      ...
      ElseIf s_FmtBoleta = 8 Then
        ...
        s_Sql = s_Sql & "bol.tiptra, (CASE WHEN psn.interbankpago='" & s_Estado_Act & "' THEN bnk.desbco ELSE bco.desbco END) AS desbco, psn.cuentapago, bol.fechapago, " & IIf(((ribOrdenar.Value = True) And (nTabIndex = 0)), "Null", "bol.codtab") & " AS codtab, dci.sigladci, bol.diaenfermedad, "
        s_Sql = s_Sql & "bol.diavacaventa, bol.pervaca1, bol.pervaca2, bol.pervaca3, "
      ElseIf s_FmtBoleta = 10 Or s_FmtBoleta = 9 Then
        s_Sql = s_Sql & "bol.tipdoc, bol.tiptra, "
        s_Sql = s_Sql & IIf(((ribOrdenar.Value = True) And (nTabIndex = 0)), "Null", "bol.codtab") & " AS codtab, "
      ElseIf s_FmtBoleta = 12 Then
        s_Sql = s_Sql & "bol.diasubsidio, bol.diafalta, bol.tardanza, bol.seccion, "
        s_Sql = s_Sql & IIf(((ribOrdenar.Value = True) And (nTabIndex = 0)), "Null", "bol.codtab") & " AS codtab, "
      ElseIf s_FmtBoleta = 13 Then
        s_Sql = s_Sql & "bol.dialaboral, bol.diaferiado, bol.diasubsidio, bol.diafalta, bol.dianolaboral, bol.horaextra4, "
        s_Sql = s_Sql & "bol.tiptra, (CASE WHEN psn.interbankpago='" & s_Estado_Act & "' THEN bnk.desbco ELSE bco.desbco END) AS desbco, psn.cuentapago, bol.fechapago, " & IIf(((ribOrdenar.Value = True) And (nTabIndex = 0)), "Null", "bol.codtab") & " AS codtab, dci.sigladci, "
        s_Sql = s_Sql & "bol.diavacaciones, "
        s_Sql = s_Sql & "bol.diatradesemanal, bol.diasuspension, bol.dialibre, bol.dialicencia, bol.diaenfermedad, "
        s_Sql = s_Sql & "bol.ubicacion, tco.destco, "
      End If
      s_Sql = s_Sql & "cfg.logo, cfg.firma" & s_Expresion & "," & IIf(ribOrdenar.Value = True, "bol.nompsn", "bol.codpsn") & " AS ordengrupo "
      ...
      If s_FmtBoleta = 4 Then
        s_Sql = s_Sql & "LEFT JOIN plbanco bco ON bco.codbco=psn.codbcopago "
        s_Sql = s_Sql & "LEFT JOIN plbanco bnk ON bnk.codbco=psn.codbnkpago "
        s_Sql = s_Sql & "LEFT JOIN pldocidentidad dci ON dci.coddci=psn.coddci "
        s_Sql = s_Sql & "LEFT JOIN plnacionalidad nac ON psn.nacionalidad=nac.codnac "
      ...
      s_PdfWhere = "ORDER BY nompsn, copia, secuencia"
      ...
      If Index = 9 Then
        ...
        If porstExporta.RecordCount > 0 Then
          ...
          While Not porstExporta.EOF
            ...
            s_PdfWhere = s_PdfWhere & "ORDER BY " & IIf(ribOrdenar.Value, "nompsn", "codpsn") & ", copia, secuencia"
            ...
            'fMenu.CryReport.ExportOptions.FormatType = crEFTPortableDocFormat  'formato PDF
            'fMenu.CryReport.ExportOptions.DestinationType = crEDTDiskFile  'salvar en disco duro
            'fMenu.CryReport.ExportOptions.PDFExportAllPages = True 'rango = todas las paginas del PDF
            'fMenu.CryReport.ExportOptions.DiskFileName = "c:\tmpexportar\hola.pdf "
            'fMenu.CryReport.Export False 'falso para que mande exportar SIN pedir de nuevo los parametros
            ...
            Do While (StrConv(dir$(s_Expresion, vbHidden), vbLowerCase) = vbNullString) And (nTemporizador < (nMaxTime * 1000 / nSleepTime))
              nTemporizador = nTemporizador + 1
              Sleep 200
            Loop
            Sleep 200
            If n_ServerEnvio = s_Estado_Ina Then
              EnviaCorreoOutlook porstExporta!correoelect, "Boleta de pago " & lblHelp(1).Caption, "Buen día adjunto boleta de pago correspondiente a " & lblHelp(1).Caption, "", "", s_Expresion, 1
            Else
              EnviaCorreoCDOWeb n_ServerEnvio, s_UsuarioEnvio, s_PasswordEnvio, s_CorreoEnvio, porstExporta!correoelect, "Boleta de pago " & lblHelp(1).Caption, "Buen día adjunto boleta de pago correspondiente a " & lblHelp(1).Caption, "", "", s_Expresion, n_PuertoEnvio, 1
            End If
...
Private Sub Form_Load()
  ...
  For n_Index = 0 To (UBound(aElemento, 1) - 1)
    aElemento(n_Index, 1) = Choose(n_Index + 1, "ordascen", "orddesce", "busqueda", "selinici", "selfinal", "cancrang", "prelimin", "imprimir", "imprapid", "genemail")
    aElemento(n_Index, 2) = Choose(n_Index + 1, "Ordenar Ascendente", "Ordenar Descendente", "Buscar " & s_TitleTable$, "Establece Inicio de Rango", "Establece Fin de Rango", "Inicializa Rango de Impresión", "Presentación Preliminar", "Imprimir", "Imprime Formato", "Correo Electrónico")
  Next n_Index
