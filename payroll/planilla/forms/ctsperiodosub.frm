...
Begin VB.Form fCtsPeriodoSub 
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "ctsperiodosub.frx":000C
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   2
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "ctsperiodosub.frx":0028
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   3
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "ctsperiodosub.frx":0044
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   4
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "ctsperiodosub.frx":0060
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   6
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "ctsperiodosub.frx":007C
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   7
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "ctsperiodosub.frx":0098
      End
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "ctsperiodosub.frx":00B4
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   5
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "ctsperiodosub.frx":00D0
      End
   End
End
Attribute VB_Name = "fCtsPeriodoSub"
...
Sub RecuperaRegistros(ByVal s_Orden As String)
  ...
  s_Registro = fCtsPeriodo.dcaRegistro.Recordset!pdocts
  ' Cadenas de Texto, Recuperar Información
  s_Sql = "SELECT subcts, descrisub, pdoano, pdomes, fechaini, fechafin, fechaven, "
  s_Sql = s_Sql & "fechacan, numeroanos, numeromeses, numerodias, estadosub "
  s_Sql = s_Sql & "FROM plctsperiodosub "
  s_Sql = s_Sql & "WHERE codcls='" & ps_ClsPlanilla & "' "
  s_Sql = s_Sql & "AND pdocts='" & s_Registro & "' "
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  Select Case Index
   ...
   Case 6, 7  ' Opciones de impresión
    ...
    s_Sql = "SELECT subcts, descrisub, fechaini, fechafin, "
    s_Sql = s_Sql & "pdoano, pdomes, '', estadosub "
    s_Sql = s_Sql & "FROM plctsperiodosub "
    s_Sql = s_Sql & "WHERE codcls='" & ps_ClsPlanilla & "' "
    s_Sql = s_Sql & "AND pdocts='" & fCtsPeriodo.dcaRegistro.Recordset!pdocts & "' "
...
Private Sub Form_Load()
  ...
  Me.Height = 5550: Me.Width = 7830
  Me.Left = 2300: Me.Top = 1150
  ' Recupera parámetro
  gdl_Procedure.pl_RecordSelector = True
  
  ' Titulo del formulario y la Grilla
  s_TitleWindow = "Registro de Sub Periodos de Provisión"
  ...
  For n_Index = 0 To (UBound(aElemento, 1) - 1)
    ...
    aElemento(n_Index, 3) = Choose(n_Index + 1, "&s", "&n", "&e", "&a", "&d", "&b", "&v", "&i")
  Next n_Index
...
Private Sub Form_Unload(Cancel As Integer)
  ...
  If FormVisible("fAbcCtsPeriodoSub") Then
    Beep
    MsgBox "Primero debe cerrar la Pantalla de " & fAbcCtsPeriodoSub.Caption, vbExclamation
    Cancel = True
  End If
