...
Begin VB.Form fAbcPvsPeriodo 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   4890
   ClientLeft      =   2265
   ClientTop       =   375
   ClientWidth     =   7200
   Icon            =   "abcpvsperiodo.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin TabDlg.SSTab tabRegister 
      ...
      TabPicture(0)   =   "abcpvsperiodo.frx":000C
      ...
      Tab(0).Control(4)=   "dtpFecha"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "frmCuadro(2)"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "txtDescripcion"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "cmbCodigo"
      ...
      Begin VB.ComboBox cmbCodigo 
         ...
         ForeColor       =   &H00FF8080&
         Height          =   315
         ItemData        =   "abcpvsperiodo.frx":0028
         Left            =   1340
         List            =   "abcpvsperiodo.frx":002A
      ...
      Begin Threed.SSFrame frmCuadro 
         ...
         _ExtentY        =   2831
         _StockProps     =   14
         Caption         =   " Conceptos de Beneficios "
         ForeColor       =   12582912
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdCancel 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcpvsperiodo.frx":002C
      End
      Begin Threed.SSCommand cmdUpdate 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcpvsperiodo.frx":0048
      End
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdMove 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcpvsperiodo.frx":0064
      End
      Begin Threed.SSCommand cmdMove 
         Height          =   360
         Index           =   2
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcpvsperiodo.frx":0080
      End
      Begin Threed.SSCommand cmdMove 
         Height          =   360
         Index           =   1
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcpvsperiodo.frx":009C
      End
      Begin Threed.SSCommand cmdMove 
         Height          =   360
         Index           =   0
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcpvsperiodo.frx":00B8
      End
   End
   Begin Threed.SSPanel panToolBar 
      Height          =   3660
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcpvsperiodo.frx":00D4
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   1
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcpvsperiodo.frx":00F0
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   2
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcpvsperiodo.frx":010C
      End
   End
   ...
   End
End
Attribute VB_Name = "fAbcPvsPeriodo"
...
Sub ShowScreen()
  ...
  If Me.Tag = s_MdoData_Ins Then
    ...
    gdl_Procedure.EditText "AT", txtDescripcion, "", Me.Tag, False, o_PvsVacaPeriodo.dcaRegistro.Recordset!descripvs.DefinedSize
    gdl_Procedure.EditDTPicker "PK", dtpFecha, Date, s_MdoData_Upd, True, s_FormatoFecha, dtpShortDate
    gdl_Procedure.EditText "AT", txtRemunera(0), "", Me.Tag, False, o_PvsVacaPeriodo.dcaRegistro.Recordset!rembasbeneficio.DefinedSize
    gdl_Procedure.EditText "AT", txtRemunera(1), "", Me.Tag, False, o_PvsVacaPeriodo.dcaRegistro.Recordset!rembasbeneficio.DefinedSize
  ...
  Else
    n_Index = o_PvsVacaPeriodo.dcaRegistro.Recordset!codpvs
    ...
    gdl_Procedure.EditText "AT", txtDescripcion, o_PvsVacaPeriodo.dcaRegistro.Recordset!descripvs, Me.Tag, False, o_PvsVacaPeriodo.dcaRegistro.Recordset!descripvs.DefinedSize
    gdl_Procedure.EditDTPicker "PK", dtpFecha, o_PvsVacaPeriodo.dcaRegistro.Recordset!fechapvs, Me.Tag, True, s_FormatoFecha, dtpShortDate
    gdl_Procedure.EditText "AT", txtRemunera(0), gdl_Funcion.aTexto(o_PvsVacaPeriodo.dcaRegistro.Recordset!rembasbeneficio), Me.Tag, False, o_PvsVacaPeriodo.dcaRegistro.Recordset!rembasbeneficio.DefinedSize
    gdl_Procedure.EditText "AT", txtRemunera(1), gdl_Funcion.aTexto(o_PvsVacaPeriodo.dcaRegistro.Recordset!rembasbeneficio), Me.Tag, False, o_PvsVacaPeriodo.dcaRegistro.Recordset!rembasbeneficio.DefinedSize
    gdl_Procedure.EditOptionCheck "AT", optEstado(0), (o_PvsVacaPeriodo.dcaRegistro.Recordset!estadopvs <> s_Estado_Blq), Me.Tag, False
    gdl_Procedure.EditOptionCheck "AT", optEstado(1), (o_PvsVacaPeriodo.dcaRegistro.Recordset!estadopvs = s_Estado_Blq), Me.Tag, False
  End If
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  If optEstado(1).Value And Index <> 0 Then Beep: MsgBox "Periodo No se puede Actualizar se encuentra Provisionado", vbExclamation: Me.Tag = s_MdoData_Vis: Exit Sub
  ...
  If MsgBox("¿ Estás Seguro de Eliminar el " & lblTitle & " '" & Trim$(txtDescripcion) & "' ?", vbCritical + vbYesNo + vbDefaultButton2) = vbYes Then
    ...
    s_Registro = Trim$(cmbCodigo)
    
    '[ Inicio la conexión a la base de datos ]
    ps_StrgConnec = OpenConnection(ps_Servidor, ps_DataBase)
    ' Creo los arreglos de eliminacion
    a_Where = Array("codcls", "codpvs")
    a_Valores = Array(ps_ClsPlanilla, s_Registro)
    a_Tipos = Array(TipoDato.Caracter, TipoDato.Caracter)
      
    gdl_Conexion.IniciaTransaccion    'Inicia transacción
    ' Elimino el registro
    If Not Records_Del("plpvsperiodovac", a_Where, a_Valores, a_Tipos) Then GoTo Error
    gdl_Conexion.ConfirmaTransaccion  'Confirma transacción
    
    MsgBox "Se Elimino exitosamente " & lblTitle, vbInformation
    ' Refresco el Ado control y la grilla
    gdl_Procedure.RefreshAdoControl o_PvsVacaPeriodo.dcaRegistro, o_PvsVacaPeriodo.tdbRegistro, lblTitle
    ' Verifico si aun existen registros
    l_ExistRecord = ((o_PvsVacaPeriodo.dcaRegistro.Recordset.EOF And o_PvsVacaPeriodo.dcaRegistro.Recordset.BOF) Or o_PvsVacaPeriodo.dcaRegistro.Recordset.RecordCount = 0)
    If Not l_ExistRecord Then
      o_PvsVacaPeriodo.dcaRegistro.Recordset.Find ("codpvs >= '" & s_Registro & "'")
      If o_PvsVacaPeriodo.dcaRegistro.Recordset.EOF Then o_PvsVacaPeriodo.dcaRegistro.Recordset.MoveLast
    Else
      Unload Me
    End If
  End If
...
Private Sub cmdHelp_Click(Index As Integer)
  ...
  s_SqlHelp = ""
  Select Case Index
   Case 0, 1    ' Concepto de remuneración asegurable
...
Private Sub cmdMove_Click(Index As Integer)
  ...
  Select Case Index
   Case 0: o_PvsVacaPeriodo.dcaRegistro.Recordset.MoveFirst
   Case 1: If Not o_PvsVacaPeriodo.dcaRegistro.Recordset.BOF Then o_PvsVacaPeriodo.dcaRegistro.Recordset.MovePrevious
           If o_PvsVacaPeriodo.dcaRegistro.Recordset.BOF Then o_PvsVacaPeriodo.dcaRegistro.Recordset.MoveFirst
   Case 2: If Not o_PvsVacaPeriodo.dcaRegistro.Recordset.EOF Then o_PvsVacaPeriodo.dcaRegistro.Recordset.MoveNext
           If o_PvsVacaPeriodo.dcaRegistro.Recordset.EOF Then o_PvsVacaPeriodo.dcaRegistro.Recordset.MoveLast
   Case 3: o_PvsVacaPeriodo.dcaRegistro.Recordset.MoveLast
  End Select
...
Private Sub cmdUpdate_Click()
  ...
  If txtRemunera(0) = "" Then Beep: MsgBox "Debe Ingresar el Concepto Remuneración Básica", vbExclamation: txtRemunera(0).SetFocus: Exit Sub
  If lblHelp(0) = "???" Then Beep: MsgBox "Concepto de Remuneración Básica no es valido; Verificar", vbExclamation: txtRemunera(0).SetFocus: Exit Sub
  If (txtRemunera(1).Text <> "" And (lblHelp(1).Caption = "???" Or lblHelp(1).Caption = "")) Then Beep: MsgBox "Concepto de Remuneración Extraordinaria no es valido; Verificar", vbExclamation: txtRemunera(1).SetFocus: Exit Sub
  s_Estado = IIf(optEstado(0).Value, s_Estado_Ina, IIf(optEstado(1).Value, s_Estado_Act, s_Estado_Blq))
  
  sFecha = "01/01/" & cmbCodigo
  
  ' Coloco el puntero en espera
  gdl_Procedure.PunteroEnEspera
  ' Capturo el registro a actualizar
  s_Registro = cmbCodigo
    
  ' Creo los arreglos para la actualización
  a_Campos = Array("codcls", "codpvs", "descripvs", "fechapvs", "rembasbeneficio", "remextbeneficio", "estadopvs", IIf(Me.Tag = s_MdoData_Ins, "usrcre", "usrmdf"), IIf(Me.Tag = s_MdoData_Ins, "fyhcre", "fyhmdf"))
  a_Valores = Array(ps_ClsPlanilla, cmbCodigo, Trim(txtDescripcion), Format(sFecha, s_FmtFechMysql_0), Trim(txtRemunera(0)), Trim(txtRemunera(1)), s_Estado, ps_Usuario, Format(Now, s_FmtFeHoMysql_0))
  a_Tipos = Array(TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Fecha, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter, TipoDato.Caracter)
  a_Where = Array("codcls", "codpvs")
  ...
  If Me.Tag = s_MdoData_Ins Then
    If Not Records_Ins("plpvsperiodovac", a_Campos, a_Valores, a_Tipos) Then GoTo Error
  Else
    If Not Records_Upd("plpvsperiodovac", a_Campos, a_Valores, a_Tipos, a_Where) Then GoTo Error
  End If
  gdl_Conexion.ConfirmaTransaccion ' Confirma transacción
...
Private Sub Form_Load()
  ...
  l_ExistRecord = (o_PvsVacaPeriodo.dcaRegistro.Recordset.EOF Or o_PvsVacaPeriodo.dcaRegistro.Recordset.BOF)
  If Not l_ExistRecord Then s_ParCodigo = o_PvsVacaPeriodo.dcaRegistro.Recordset!codpvs
...
Private Sub tdbHelp_DblClick()
  ...
  Select Case n_IndexHelp
   Case 0, 1      ' Conceptos de remuneración asegurable
