...
Begin VB.Form fPrmBoleLiquida 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   4950
   ClientLeft      =   2265
   ClientTop       =   375
   ClientWidth     =   6420
   Icon            =   "prmboliquida.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ScaleHeight     =   4950
   ...
   Begin TabDlg.SSTab tabRegister 
      ...
      TabPicture(0)   =   "prmboliquida.frx":000C
      ...
      Tab(0).Control(5)=   "lblDato(2)"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "lblHelp(3)"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "lblHelp(2)"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "lblDato(3)"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "lblHelp(4)"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "lblDato(4)"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "cmdHelp(4)"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "cmdHelp(3)"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "cmdHelp(2)"
      ...
      Tab(0).Control(17)=   "txtRemunera(1)"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).Control(18)=   "txtRemunera(3)"
      Tab(0).Control(18).Enabled=   0   'False
      Tab(0).Control(19)=   "txtRemunera(2)"
      Tab(0).Control(19).Enabled=   0   'False
      Tab(0).Control(20)=   "txtRemunera(4)"
      ...
      End
      Begin VB.Label lblDato 
         Caption         =   "Remuneración por Compensación :"
         ForeColor       =   &H00C00000&
         Height          =   195
         Index           =   3
         Left            =   240
   ...
   End
End
Attribute VB_Name = "fPrmBoleLiquida"
...
Sub ShowScreen()
  ...
  s_Sql = "SELECT remupromeliq, remuliquiex, remuliquisu, remuvacaliq, remuvacatrun "
  ...
  If Not (porstRecordset.BOF And porstRecordset.BOF) Then
    ...
    gdl_Procedure.EditText "AT", txtRemunera(0), gdl_Funcion.aTexto(porstRecordset!remupromeliq), Me.Tag, False, porstRecordset!remupromeliq.DefinedSize
    gdl_Procedure.EditText "AT", txtRemunera(1), gdl_Funcion.aTexto(porstRecordset!remuliquiex), Me.Tag, False, porstRecordset!remuliquiex.DefinedSize
    gdl_Procedure.EditText "AT", txtRemunera(2), gdl_Funcion.aTexto(porstRecordset!remuliquisu), Me.Tag, False, porstRecordset!remuliquisu.DefinedSize
    gdl_Procedure.EditText "AT", txtRemunera(3), gdl_Funcion.aTexto(porstRecordset!remuvacaliq), Me.Tag, False, porstRecordset!remuvacaliq.DefinedSize
    gdl_Procedure.EditText "AT", txtRemunera(4), gdl_Funcion.aTexto(porstRecordset!remuvacatrun), Me.Tag, False, porstRecordset!remuvacatrun.DefinedSize
  Else
    Me.Tag = s_MdoData_Ins
    gdl_Procedure.EditText "AT", txtRemunera(0), "", Me.Tag, False, porstRecordset!remupromeliq.DefinedSize
    gdl_Procedure.EditText "AT", txtRemunera(1), "", Me.Tag, False, porstRecordset!remuliquiex.DefinedSize
    gdl_Procedure.EditText "AT", txtRemunera(2), "", Me.Tag, False, porstRecordset!remuliquisu.DefinedSize
    gdl_Procedure.EditText "AT", txtRemunera(3), "", Me.Tag, False, porstRecordset!remuvacaliq.DefinedSize
    gdl_Procedure.EditText "AT", txtRemunera(4), "", Me.Tag, False, porstRecordset!remuvacatrun.DefinedSize
  End If
...
Private Sub cmdHelp_Click(Index As Integer)
  ...
  s_SqlHelp = ""
  Select Case Index
   Case 0, 1, 2, 3, 4 ' Conceptos de planilla remuneracion liquidación
    tdbHelp.Columns(0).DataField = "codcpc": tdbHelp.Columns(1).DataField = "descpc"
    tdbHelp.Caption = "Conceptos Ingresos"
    s_Registro = ps_ClsPlanilla & s_Estado_Ina
    ' Recupero la información
    s_Sql = gdl_Funcion.HelpTablas("ctp", "codcpc", s_Registro, "")
  End Select
  ...
  tdbHelp.Top = tabRegister.Top + (Choose(Index + 1, cmdHelp(Index).Top, cmdHelp(Index).Top, cmdHelp(Index).Top, 1700, 1750) + (cmdHelp(Index).Height / 2))
...
Private Sub cmdUpdate_Click(Index As Integer)
  ...
  If txtRemunera(0) = "" Then Beep: MsgBox "Debe Ingresar el Concepto Remuneración Liquidación - Promedio", vbExclamation: txtRemunera(0).SetFocus: Exit Sub
  If lblHelp(0) = "???" Then Beep: MsgBox "Concepto Remuneración Liquidación - Promedio no es valido; Verificar", vbExclamation: txtRemunera(0).SetFocus: Exit Sub
  If txtRemunera(1) = "" Then Beep: MsgBox "Debe Ingresar el Concepto Remuneración Liquidación - Extraordinaria", vbExclamation: txtRemunera(1).SetFocus: Exit Sub
  If lblHelp(1) = "???" Then Beep: MsgBox "Concepto Remuneración Liquidación - Extraordinaria no es valido; Verificar", vbExclamation: txtRemunera(1).SetFocus: Exit Sub
  If txtRemunera(2) = "" Then Beep: MsgBox "Debe Ingresar el Concepto de Remuneración Liquidación - Compensación", vbExclamation: txtRemunera(2).SetFocus: Exit Sub
  If lblHelp(2) = "???" Then Beep: MsgBox "Concepto de Remuneración Liquidación - Compensación no es valido; Verificar", vbExclamation: txtRemunera(2).SetFocus: Exit Sub
  If txtRemunera(3) = "" Then Beep: MsgBox "Debe Ingresar el Concepto de Vacaciones Liquidación", vbExclamation: txtRemunera(3).SetFocus: Exit Sub
  If lblHelp(3) = "???" Then Beep: MsgBox "Concepto de Vacaciones Liquidación no es valido; Verificar", vbExclamation: txtRemunera(3).SetFocus: Exit Sub
  If txtRemunera(4) = "" Then Beep: MsgBox "Debe Ingresar el Concepto de Vacaciones Truncas", vbExclamation: txtRemunera(4).SetFocus: Exit Sub
  If lblHelp(4) = "???" Then Beep: MsgBox "Concepto de Vacaciones Truncas no es valido; Verificar", vbExclamation: txtRemunera(4).SetFocus: Exit Sub
    
  ' Coloco el puntero en espera
  gdl_Procedure.PunteroEnEspera
    
  ' Creo los arreglos para la actualización
  a_Campos = Array("pdoano", "remupromeliq", "remuliquiex", "remuliquisu", "remuvacaliq", "remuvacatrun", IIf(Me.Tag = s_MdoData_Ins, "usrcre", "usrmdf"), IIf(Me.Tag = s_MdoData_Ins, "fyhcre", "fyhmdf"))
  a_Valores = Array(ps_Anyo, txtRemunera(0).Text, txtRemunera(1).Text, txtRemunera(2).Text, txtRemunera(3).Text, txtRemunera(4).Text, ps_Usuario, Format(Now, s_FmtFeHoMysql_0))
...
Private Sub Form_Load()
  ...
  Me.Height = 5430: Me.Width = 6510
  Me.Left = 3580: Me.Top = 2500
  
  ' Titulo del formulario y panel
  s_TitleWindow = "Actualización Parametros de Liquidación"
  lblTitle = "Parametros"
...
Private Sub tdbHelp_DblClick()
  ...
  Select Case n_IndexHelp
   Case 0, 1, 2, 3, 4   ' Concepto de remuneración liquidación
...
Private Sub tdbHelp_HeadClick(ByVal ColIndex As Integer)
  ...
  Select Case n_IndexHelp
   Case 0, 1, 2, 3, 4 ' Conceptos de remuneración Liquidación
    s_Registro = ps_ClsPlanilla & s_Estado_Ina
    s_Sql = gdl_Funcion.HelpTablas("ctp", tdbHelp.Columns(ColIndex).DataField, s_Registro, "")
  End Select
  Set porstHelp = OpenRecordset(ps_StrgConnec & ps_DataBase, adOpenForwardOnly, adLockReadOnly, adUseClient, s_Sql)
  tdbHelp.DataSource = porstHelp
