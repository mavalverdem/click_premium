...
Begin VB.Form fEmpresasqdes 
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "empresasqdes.frx":00C4
      End
   End
End
Attribute VB_Name = "fEmpresasqdes"
...
Private Sub RecuperaRegistros(ByVal s_Orden As String)
  ...
  s_Sql = "SELECT codeqd, deseqd, acteqd, fechaini_eqd, fechafin_eqd, estadoeqd"
  s_Sql = s_Sql & " FROM plempresasqdes"
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  Select Case Index
   ...
   Case 6, 7  ' Opciones de impresión
    ...
    gdl_Procedure.ps_ReportTitle = "EMPRESAS A QUIENES DESTACO O DESPLAZO PERSONAL"
    gdl_Procedure.ps_ReportName = "lstempresasqdes"
    ...
    s_Sql = "SELECT codeqd, deseqd, acteqd,estadoeqd"
    s_Sql = s_Sql & " FROM plempresasqdes afp"
...
Private Sub Form_Load()
  ...
  s_TitleTable = "Empresas a quienes destaco o desplazo personal"
  
  ReDim aElemento(3, 10)
  For i = 0 To (UBound(aElemento, 1) - 1)
    aElemento(i, 0) = Choose(i + 1, "Código", "Descripción", "Ok")
    aElemento(i, 1) = Choose(i + 1, "codeqd", "deseqd", "estadoeqd")
...
Private Sub Form_Unload(Cancel As Integer)
  ...
  If FormVisible("fAbcEmpresasqdes") Then
    Beep
    MsgBox "Primero debe cerrar la Pantalla de " & fAbcEmpresasqdes.Caption, vbExclamation
    Cancel = True
  End If
