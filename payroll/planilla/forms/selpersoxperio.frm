...
Begin VB.Form fSelPersoxPeriodo 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "."
      TabPicture(0)   =   "selpersoxperio.frx":000C
      ...
      Tab(0).Control(5)=   "lblhelp(2)"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "cmdHelp(2)"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "cmdHelp(1)"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "desdemes"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "hastames"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "Aceptar"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "Cancelar"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "desdeano"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "hastaano"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "txtConcepto"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).Control(15)=   "txtConceptoFin"
      Tab(0).Control(15).Enabled=   0   'False
      Tab(0).ControlCount=   16
      Begin VB.TextBox txtConceptoFin 
         Height          =   280
         Left            =   120
         TabIndex        =   36
         Top             =   2280
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "selpersoxperio.frx":0028
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   3
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "selpersoxperio.frx":0044
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   4
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "selpersoxperio.frx":0060
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   5
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "selpersoxperio.frx":007C
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   7
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "selpersoxperio.frx":0098
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   8
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "selpersoxperio.frx":00B4
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   1
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "selpersoxperio.frx":00D0
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   6
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "selpersoxperio.frx":00EC
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   0
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "selpersoxperio.frx":0108
      End
   End
   Begin Threed.SSPanel panToolBar 
      Align           =   1  'Align Top
      ...
      Begin Threed.SSRibbon ribParametro 
         ...
         BevelWidth      =   0
         Outline         =   0   'False
         PictureUp       =   "selpersoxperio.frx":0124
      End
      Begin Threed.SSRibbon ribParametro 
         Height          =   360
         Index           =   0
         ...
         BevelWidth      =   0
         Outline         =   0   'False
         PictureUp       =   "selpersoxperio.frx":0140
      End
      Begin Threed.SSRibbon ribParametro 
         Height          =   360
         Index           =   2
         ...
         BevelWidth      =   0
         Outline         =   0   'False
         PictureUp       =   "selpersoxperio.frx":015C
      End
   ...
   End
End
Attribute VB_Name = "fSelPersoxPeriodo"
...
'**********************
  ...
  contar = 0
  'Determinando el tipo de Moneda del reporte
...
'  Next
    ...
    If opcion = 1 Then
        aElemento(2, 2) = "Periodo;" & Right(desdemes, Len(desdemes) - 4) & " del " & desdeano.Text & " - " & Right(hastames, Len(hastames) - 4) & " del " & hastaano.Text & ";true"
    Else
        aElemento(2, 2) = "Periodo;" & Right(desdemes, Len(desdemes) - 4) & " del " & desdeano.Text & " - " & Right(hastames, Len(hastames) - 4) & " del " & hastaano.Text & ";true"
    End If
    ...
    s_Sql = "SELECT LEFT(asis.codpdo,4) AS anio,asis.codpsn,CONCAT(psn.apepaterno, ' ', psn.apematerno, ' ' , psn.nombres) as Apellidosnombres, "
    s_Sql = s_Sql & "SUM(CASE WHEN SUBSTRING(asis.codpdo,5,2) ='01'THEN asis.diafalta ELSE 0 END) as 'ENERO', "
    s_Sql = s_Sql & "SUM(CASE WHEN SUBSTRING(asis.codpdo,5,2) ='02' THEN asis.diafalta ELSE 0 END) as 'FEBRERO', "
    s_Sql = s_Sql & "SUM(CASE WHEN SUBSTRING(asis.codpdo,5,2) ='03' THEN asis.diafalta ELSE 0 END) as 'MARZO', "
    s_Sql = s_Sql & "SUM(CASE WHEN SUBSTRING(asis.codpdo,5,2) ='04' THEN asis.diafalta ELSE 0 END) as 'ABRIL', "
    s_Sql = s_Sql & "SUM(CASE WHEN SUBSTRING(asis.codpdo,5,2) ='05' THEN asis.diafalta ELSE 0 END) as 'MAYO', "
    s_Sql = s_Sql & "SUM(CASE WHEN SUBSTRING(asis.codpdo,5,2) ='06' THEN asis.diafalta ELSE 0 END) as 'JUNIO', "
    s_Sql = s_Sql & "SUM(CASE WHEN SUBSTRING(asis.codpdo,5,2) ='07' THEN asis.diafalta ELSE 0 END) as 'JULIO', "
    s_Sql = s_Sql & "SUM(CASE WHEN SUBSTRING(asis.codpdo,5,2) ='08' THEN asis.diafalta ELSE 0 END) as 'AGOSTO',"
    s_Sql = s_Sql & "SUM(CASE WHEN SUBSTRING(asis.codpdo,5,2) ='09' THEN asis.diafalta ELSE 0 END) as 'SEPTIEMBRE', "
    s_Sql = s_Sql & "SUM(CASE WHEN SUBSTRING(asis.codpdo,5,2) ='10' THEN asis.diafalta ELSE 0 END) as 'OCTUBRE', "
    s_Sql = s_Sql & "SUM(CASE WHEN SUBSTRING(asis.codpdo,5,2) ='11' THEN asis.diafalta ELSE 0 END) as 'NOVIEMBRE', "
    s_Sql = s_Sql & "SUM(CASE WHEN SUBSTRING(asis.codpdo,5,2) ='12' THEN asis.diafalta ELSE 0 END) as 'DICIEMBRE' "
    s_Sql = s_Sql & "FROM plpersonal psn "
    s_Sql = s_Sql & "INNER JOIN plasistencia asis ON asis.codpsn=psn.codpsn and psn.codcls= asis.codcls "
    s_Sql = s_Sql & "WHERE SUBSTRING(asis.codpdo,1,6)>=  '" & desdeano.Text & Left(desdemes, 2) & "' AND SUBSTRING(asis.codpdo,1,6)<='" & hastaano.Text & Left(hastames, 2) & "' "
    s_Sql = s_Sql & "AND ASIS.codcls ='" & ps_ClsPlanilla & "'  and asis.diafalta<>0 "
    s_Sql = s_Sql & "AND  asis.codpsn IN(SELECT valor FROM rangoimpresion "
    s_Sql = s_Sql & "WHERE proceso='" & s_OptRegistro & "' "
    s_Sql = s_Sql & "AND usrcre='" & ps_Usuario & " ' "
    s_Sql = s_Sql & "AND fyhcre='" & s_FechaHora & "') "
    s_Sql = s_Sql & "GROUP BY anio,asis.codpsn,Apellidosnombres "
   
    ElseIf opcion = 2 Then
    'PLRESULTADO
     If s_Moneda = "N" Then
        s_Sql = "SELECT res.pdoano,res.codcpc,cpc.descpc,res.codpsn,CONCAT(psn.apepaterno, ' ', psn.apematerno, ' ' , psn.nombres) as Apellidosnombres, "
        s_Sql = s_Sql & "'" & s_Codmon_mn_Txt & "' AS tipomoneda, "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='01'THEN res.importe_mn ELSE 0 END) as 'ENERO', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='02'THEN res.importe_mn ELSE 0 END) as 'FEBRERO', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='03'THEN res.importe_mn ELSE 0 END) as 'MARZO', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='04'THEN res.importe_mn ELSE 0 END) as 'ABRIL', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='05'THEN res.importe_mn ELSE 0 END) as 'MAYO', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='06'THEN res.importe_mn ELSE 0 END) as 'JUNIO', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='07'THEN res.importe_mn ELSE 0 END) as 'JULIO', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='08'THEN res.importe_mn ELSE 0 END) as 'AGOSTO', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='09'THEN res.importe_mn ELSE 0 END) as 'SEPTIEMBRE', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='10'THEN res.importe_mn ELSE 0 END) as 'OCTUBRE', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='11'THEN res.importe_mn ELSE 0 END) as 'NOVIEMBRE', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='12'THEN res.importe_mn ELSE 0 END) as 'DICIEMBRE' "
        s_Sql = s_Sql & "FROM plresultado res "
        s_Sql = s_Sql & "INNER JOIN plpersonal psn ON psn.codcls=res.codcls AND psn.codpsn=res.codpsn "
        s_Sql = s_Sql & "INNER JOIN plconcepto cpc ON cpc.codcpc=res.codcpc "
        s_Sql = s_Sql & "WHERE CONCAT(res.pdoano,res.pdomes)>=  '" & desdeano.Text & Left(desdemes, 2) & "' AND CONCAT(res.pdoano,res.pdomes)<='" & hastaano.Text & Left(hastames, 2) & "' "
        s_Sql = s_Sql & "AND res.codcls='" & ps_ClsPlanilla & "' "
        s_Sql = s_Sql & "and res.codcpc>='" & txtConcepto.Text & "' AND res.codcpc<='" & txtConceptoFin.Text & "' "
        s_Sql = s_Sql & "AND res.codpsn IN(SELECT valor FROM rangoimpresion "
        s_Sql = s_Sql & "WHERE proceso='" & s_OptRegistro & "' "
        s_Sql = s_Sql & "AND usrcre='" & ps_Usuario & " ' "
        s_Sql = s_Sql & "AND fyhcre='" & s_FechaHora & "') "
        s_Sql = s_Sql & "GROUP BY res.pdoano, res.codcpc,cpc.descpc, res.codpsn,Apellidosnombres "
        s_Sql = s_Sql & "ORDER BY  res.pdoano,res.codpsn"
      ElseIf s_Moneda = "E" Then
        s_Sql = "SELECT res.pdoano,res.codcpc,cpc.descpc,res.codpsn,CONCAT(psn.apepaterno, ' ', psn.apematerno, ' ' , psn.nombres) as Apellidosnombres, "
        
        s_Sql = s_Sql & "'" & s_Codmon_me_Txt & "' AS tipomoneda, "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='01'THEN res.importe_me ELSE 0 END) as 'ENERO', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='02'THEN res.importe_me ELSE 0 END) as 'FEBRERO', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='03'THEN res.importe_me ELSE 0 END) as 'MARZO', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='04'THEN res.importe_me ELSE 0 END) as 'ABRIL', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='05'THEN res.importe_me ELSE 0 END) as 'MAYO', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='06'THEN res.importe_me ELSE 0 END) as 'JUNIO', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='07'THEN res.importe_me ELSE 0 END) as 'JULIO', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='08'THEN res.importe_me ELSE 0 END) as 'AGOSTO', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='09'THEN res.importe_me ELSE 0 END) as 'SEPTIEMBRE', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='10'THEN res.importe_me ELSE 0 END) as 'OCTUBRE', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='11'THEN res.importe_me ELSE 0 END) as 'NOVIEMBRE', "
        s_Sql = s_Sql & "SUM(CASE WHEN res.pdomes='12'THEN res.importe_me ELSE 0 END) as 'DICIEMBRE' "
        s_Sql = s_Sql & "FROM plresultado res "
        s_Sql = s_Sql & "INNER JOIN plpersonal psn ON psn.codcls=res.codcls AND psn.codpsn=res.codpsn "
        s_Sql = s_Sql & "INNER JOIN plconcepto cpc ON cpc.codcpc=res.codcpc "
        s_Sql = s_Sql & "WHERE CONCAT(res.pdoano,res.pdomes)>=  '" & desdeano.Text & Left(desdemes, 2) & "' AND CONCAT(res.pdoano,res.pdomes)<='" & hastaano.Text & Left(hastames, 2) & "' "
...
If opcion = 3 Then
    ...
    s_Sql = "select CONCAT(LEFT(codpdo,4),'-',RIGHT(codpdo,2)) AS codpdo,asis.codpsn, CONCAT(per.apepaterno,' ', apematerno, ' ', nombres) as apellidosnombres, "
    ...
    s_Sql = s_Sql & "UNION "
    s_Sql = s_Sql & "SELECT  CONCAT(LEFT(codpdo,4),'-',RIGHT(codpdo,2)) AS codpdo,asis.codpsn,  CONCAT(per.apepaterno,' ', per.apematerno, ' ', nombres) as apellidosnombres, "
  ...
  Select Case Index
   ...
   Case 7, 8  ' Opciones de impresión
    ...
    ElseIf s_OptRegistro = "asistencia" Then
      ...
      If checkAsistencia.Value = Checked Then
        s_Sql = s_Sql & " WHERE LEFT(asi.codpdo,4)='" & ps_Anyo & "' "
      Else
...
Private Sub cmdHelp_Click(Index As Integer)
  ...
  Select Case Index
   Case 0     ' Periodo de Pago
    ...
    s_Sql = gdl_Funcion.HelpTablas("ped", "codpdo", IIf(s_OptRegistro = "consulxcpc", s_Estado_Ina, s_Estado_Blq) & ps_ClsPlanilla & ps_Anyo, "")
   Case 1, 2  ' Concepto
...
Private Sub dcaRegistro_MoveComplete(ByVal adReason As ADODB.EventReasonEnum, ByVal pError As ADODB.Error, adStatus As ADODB.EventStatusEnum, ByVal pRecordset As ADODB.Recordset)
  ...
  ElseIf s_OptRegistro = "asistencia" Then
    If FormVisible("fAbcAsistencia") Then
      ...
      End If
    End If
  ElseIf (s_OptRegistro = "consulxcpc" And lblDato(0).Tag = s_OptRegistro) Then
...
Private Sub tdbHelp_DblClick()
  ...
  Select Case n_IndexHelp
   Case 0       ' Periodo de pago
    ...
    txtPeriodo.SetFocus
   Case 1       ' Conceptos Uno
    txtConcepto = tdbHelp.Columns(0).Value
    lblHelp(n_IndexHelp) = tdbHelp.Columns(1).Value
    txtConcepto.SetFocus
    Case 2       ' Conceptos Dos
    txtConceptoFin = tdbHelp.Columns(0).Value
    lblHelp(n_IndexHelp) = tdbHelp.Columns(1).Value
    txtConceptoFin.SetFocus
...
Private Sub txtconceptofin_GotFocus()
 gdl_Procedure.MarcaGet txtConceptoFin
End Sub

Private Sub txtconceptofin_LostFocus()
