...
Begin VB.Form fAbcCuenta 
   ...
   Begin TabDlg.SSTab tabRegister 
      ...
      TabPicture(0)   =   "abccuenta.frx":0000
      ...
      Tab(0).Control(5)=   "chk(1)"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "chk(0)"
      ...
      Tab(0).Control(11)=   "cmbcuenta"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "cmbsaldo"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).ControlCount=   13
      Begin VB.ComboBox cmbsaldo 
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "abccuenta.frx":001C
         Left            =   1320
         List            =   "abccuenta.frx":001E
      ...
      Begin VB.ComboBox cmbcuenta 
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "abccuenta.frx":0020
         Left            =   1320
         List            =   "abccuenta.frx":0022
         Style           =   2  'Dropdown List
         TabIndex        =   25
         Top             =   1440
         Width           =   1320
      ...
      Begin VB.ComboBox cmbtipo 
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "abccuenta.frx":0024
         Left            =   1320
         List            =   "abccuenta.frx":0026
         Style           =   2  'Dropdown List
         TabIndex        =   22
         Top             =   1080
         Width           =   1320
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abccuenta.frx":0108
      End
   End
End
Attribute VB_Name = "fAbcCuenta"
...
Private s_Cuenta As String                           ' Codigo del registro
'[
...
If Me.Tag = s_MdoData_Ins Then
    ...
    gdl_Procedure.EditText "PK", txtCodigo, "", Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!codcta.DefinedSize
    gdl_Procedure.EditText "AT", txtDescripcion, "", Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!detcta.DefinedSize
    ...
    gdl_Procedure.EditOptionCheck "AT", chk(0), False, Me.Tag, True
    gdl_Procedure.EditOptionCheck "AT", chk(1), False, Me.Tag, True
  
    gdl_Procedure.EditCombo "AT", cmbtipo, -1, Me.Tag, False
    gdl_Procedure.EditCombo "AT", cmbcuenta, -1, Me.Tag, False
    gdl_Procedure.EditCombo "AT", cmbsaldo, -1, Me.Tag, False
    
Else
    
    gdl_Procedure.EditText "PK", txtCodigo, fTablaSistema.dcaRegistro.Recordset!codcta, Me.Tag, True, fTablaSistema.dcaRegistro.Recordset!codcta.DefinedSize
    gdl_Procedure.EditText "AT", txtDescripcion, gdl_Funcion.aTexto(fTablaSistema.dcaRegistro.Recordset!detcta), Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!detcta.DefinedSize
    gdl_Procedure.EditOptionCheck "AT", optEstado(0), (fTablaSistema.dcaRegistro.Recordset!estcta = s_Estado_Act), Me.Tag, True
    gdl_Procedure.EditOptionCheck "AT", optEstado(1), (fTablaSistema.dcaRegistro.Recordset!estcta = s_Estado_Ina), Me.Tag, True
    
    gdl_Procedure.EditOptionCheck "AT", chk(0), (fTablaSistema.dcaRegistro.Recordset!inddoc = "1"), Me.Tag, True
    gdl_Procedure.EditOptionCheck "AT", chk(1), (fTablaSistema.dcaRegistro.Recordset!indcco = "1"), Me.Tag, True
    ...
    cmbtipo.ListIndex = fTablaSistema.dcaRegistro.Recordset!Tpocta
    
    cmbcuenta.ForeColor = &HC00000
    If Me.Tag = "C" Then
      cmbcuenta.Locked = False
      cmbcuenta.BackColor = &H80000005
      Else
      cmbcuenta.Locked = True
      cmbcuenta.BackColor = &HC7D8E0
    End If
      
    cmbcuenta.ListIndex = fTablaSistema.dcaRegistro.Recordset!natcta
    
    cmbsaldo.ForeColor = &HC00000
    If Me.Tag = "C" Then
      cmbsaldo.Locked = False
      cmbsaldo.BackColor = &H80000005
      Else
      cmbsaldo.Locked = True
      cmbsaldo.BackColor = &HC7D8E0
    End If
      
    Select Case fTablaSistema.dcaRegistro.Recordset!tposdo
    Case "I"
        cmbsaldo.ListIndex = 0      'Inventario
    Case "R"
        cmbsaldo.ListIndex = 1      'Resultados
    Case "F"
        cmbsaldo.ListIndex = 2      'Función
    Case "N"
        cmbsaldo.ListIndex = 3      'Naturaleza
    Case "A"
        cmbsaldo.ListIndex = 4      'Función y Naturaleza
    End Select
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  If MsgBox("¿ Estás Seguro de Eliminar el " & lblTitle & " '" & Trim$(txtDescripcion) & "' ?", vbCritical + vbYesNo + vbDefaultButton2) = vbYes Then
    ...
    s_Cuenta = Trim$(txtCodigo)
    
    '[ Inicio la conexión a la base de datos ]
    ps_StrgConnec = OpenConnection(ps_Servidor, ps_DataBase)
    ' Creo los arreglos de eliminacion
    a_Where = Array("codcta")
    a_Valores = Array(s_Cuenta)
    a_Tipos = Array(TipoDato.Caracter)
      
    gdl_Conexion.IniciaTransaccion    'Inicia transacción
    ' Elimino el registro
    If Not Records_Del("cocta", a_Where, a_Valores, a_Tipos) Then GoTo Error
    ...
    If Not l_ExistRecord Then
      fTablaSistema.dcaRegistro.Recordset.Find ("codcta >= '" & s_Cuenta & "'")
...
Private Sub cmdUpdate_Click()
  Dim s_Estado As String * 1, s_Tipo As String * 1, s_TCuenta As String * 1, s_Saldo As String * 1
  ...
  If cmbtipo = "" Then Beep: MsgBox "Seleccione Tipo de Cuenta " & lblTitle, vbExclamation: cmbtipo.SetFocus: Exit Sub
  ...
  s_Tipo = cmbtipo.ListIndex
  s_TCuenta = cmbcuenta.ListIndex
  ...
  a_Campos = Array("codcta", "detcta", "tpocta", "natcta", "tposdo", "inddoc", "indcco", "estcta", IIf(Me.Tag = s_MdoData_Ins, "usrcre", "usrmdf"), IIf(Me.Tag = s_MdoData_Ins, "fyhcre", "fyhmdf"))
  If s_Estado = 0 Then
    s_Estado = "I"
  Else
    s_Estado = "A"
  End If
  a_Valores = Array(txtCodigo, Trim$(txtDescripcion), s_Tipo, s_TCuenta, s_Saldo, IIf(chk(0).Value, 1, 0), IIf(chk(1).Value, 1, 0), s_Estado, ps_Usuario, Format(Now, s_FmtFeHoMysql_0))
  ...
  If Me.Tag = s_MdoData_Ins Then
    If Not Records_Ins("cocta", a_Campos, a_Valores, a_Tipos) Then GoTo Error
  Else
    If Not Records_Upd("cocta", a_Campos, a_Valores, a_Tipos, a_Where) Then GoTo Error
  End If
  gdl_Conexion.ConfirmaTransaccion ' Confirma transacción
...
Private Sub Form_Load()
  ...
  Me.Height = 4215: Me.Width = 7290
  Me.Left = 1080: Me.Top = 1500
  
  ' Titulo del formulario y panel
  s_TitleWindow = "Actualización Cuentas Contables"
  ...
  If Not l_ExistRecord Then s_ParCodigo = fTablaSistema.dcaRegistro.Recordset!codcta
  
  For i = 0 To 1
    cmbtipo.AddItem Choose(i + 1, "Titulo", "Detalle")
  Next i
  
  For i = 0 To 1
    cmbcuenta.AddItem Choose(i + 1, "Deudora", "Acreedora")
  Next i
  
  For i = 0 To 4
    cmbsaldo.AddItem Choose(i + 1, "Inventario", "Resultados", "Funcion", "Naturaleza", "Función y Naturaleza")
  Next i
