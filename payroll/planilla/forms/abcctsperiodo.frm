...
Begin VB.Form fAbcCtsPeriodo 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   3675
   ClientLeft      =   2265
   ClientTop       =   375
   ClientWidth     =   7200
   Icon            =   "abcctsperiodo.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin TabDlg.SSTab tabRegister 
      ...
      TabPicture(0)   =   "abcctsperiodo.frx":000C
      ...
      Begin VB.ComboBox cmbEjercicio 
         ForeColor       =   &H00FF0000&
         Height          =   315
         ItemData        =   "abcctsperiodo.frx":0028
         Left            =   1340
         List            =   "abcctsperiodo.frx":002A
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdCancel 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcctsperiodo.frx":002C
      End
      Begin Threed.SSCommand cmdUpdate 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcctsperiodo.frx":0048
      End
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdMove 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcctsperiodo.frx":0064
      End
      Begin Threed.SSCommand cmdMove 
         Height          =   360
         Index           =   2
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcctsperiodo.frx":0080
      End
      Begin Threed.SSCommand cmdMove 
         Height          =   360
         Index           =   1
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcctsperiodo.frx":009C
      End
      Begin Threed.SSCommand cmdMove 
         Height          =   360
         Index           =   0
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcctsperiodo.frx":00B8
      End
   End
   Begin Threed.SSPanel panToolBar 
      Height          =   2500
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcctsperiodo.frx":00D4
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   1
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcctsperiodo.frx":00F0
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   2
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcctsperiodo.frx":010C
      End
   End
End
Attribute VB_Name = "fAbcCtsPeriodo"
...
Sub ShowScreen()
  ...
  If Me.Tag = s_MdoData_Ins Then
    gdl_Procedure.EditText "PK", txtCodigo, "", Me.Tag, False, fCtsPeriodo.dcaRegistro.Recordset!pdocts.DefinedSize
    gdl_Procedure.EditText "AT", txtDescripcion, "", Me.Tag, False, fCtsPeriodo.dcaRegistro.Recordset!descricts.DefinedSize
    gdl_Procedure.EditCombo "AT", cmbejercicio, 20, Me.Tag, False
  ...
  Else
    gdl_Procedure.EditText "PK", txtCodigo, fCtsPeriodo.dcaRegistro.Recordset!pdocts, Me.Tag, True, fCtsPeriodo.dcaRegistro.Recordset!pdocts.DefinedSize
    gdl_Procedure.EditText "AT", txtDescripcion, fCtsPeriodo.dcaRegistro.Recordset!descricts, Me.Tag, False, fCtsPeriodo.dcaRegistro.Recordset!descricts.DefinedSize
    n_Index = fCtsPeriodo.dcaRegistro.Recordset!pdoano
    n_Index = IIf((Val(ps_Anyo) - n_Index) >= 0, (20 - Abs(Val(ps_Anyo) - n_Index)), (20 + Abs(Val(ps_Anyo) - n_Index)))
    gdl_Procedure.EditCombo "AT", cmbejercicio, n_Index, Me.Tag, False
    gdl_Procedure.EditOptionCheck "AT", optEstado(0), (fCtsPeriodo.dcaRegistro.Recordset!estadocts = s_Estado_Ina), Me.Tag, False
    gdl_Procedure.EditOptionCheck "AT", optEstado(1), (fCtsPeriodo.dcaRegistro.Recordset!estadocts = s_Estado_Act), Me.Tag, False
    gdl_Procedure.EditOptionCheck "AT", optEstado(2), (fCtsPeriodo.dcaRegistro.Recordset!estadocts = s_Estado_Blq), Me.Tag, False
  End If
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  If MsgBox("¿ Estás Seguro de Eliminar el " & lblTitle & " '" & Trim$(txtDescripcion) & "' ?", vbCritical + vbYesNo + vbDefaultButton2) = vbYes Then
    ...
    a_Where = Array("codcls", "pdocts")
    a_Valores = Array(ps_ClsPlanilla, s_Registro)
    a_Tipos = Array(TipoDato.Caracter, TipoDato.Caracter)
      
    gdl_Conexion.IniciaTransaccion    'Inicia transacción
    ' Elimino el registro
    If Not Records_Del("plctsperiodo", a_Where, a_Valores, a_Tipos) Then GoTo Error
    gdl_Conexion.ConfirmaTransaccion  'Confirma transacción
    
    MsgBox "Se Elimino exitosamente " & lblTitle, vbInformation
    ' Refresco el Ado control y la grilla
    gdl_Procedure.RefreshAdoControl fCtsPeriodo.dcaRegistro, fCtsPeriodo.tdbRegistro, lblTitle
    ' Verifico si aun existen registros
    l_ExistRecord = ((fCtsPeriodo.dcaRegistro.Recordset.EOF And fCtsPeriodo.dcaRegistro.Recordset.BOF) Or fCtsPeriodo.dcaRegistro.Recordset.RecordCount = 0)
    If Not l_ExistRecord Then
      fCtsPeriodo.dcaRegistro.Recordset.Find ("pdocts >= '" & s_Registro & "'")
      If fCtsPeriodo.dcaRegistro.Recordset.EOF Then fCtsPeriodo.dcaRegistro.Recordset.MoveLast
    Else
      Unload Me
    End If
  End If
...
Private Sub cmdMove_Click(Index As Integer)
  ...
  Select Case Index
   Case 0: fCtsPeriodo.dcaRegistro.Recordset.MoveFirst
   Case 1: If Not fCtsPeriodo.dcaRegistro.Recordset.BOF Then fCtsPeriodo.dcaRegistro.Recordset.MovePrevious
           If fCtsPeriodo.dcaRegistro.Recordset.BOF Then fCtsPeriodo.dcaRegistro.Recordset.MoveFirst
   Case 2: If Not fCtsPeriodo.dcaRegistro.Recordset.EOF Then fCtsPeriodo.dcaRegistro.Recordset.MoveNext
           If fCtsPeriodo.dcaRegistro.Recordset.EOF Then fCtsPeriodo.dcaRegistro.Recordset.MoveLast
   Case 3: fCtsPeriodo.dcaRegistro.Recordset.MoveLast
  End Select
...
Private Sub cmdUpdate_Click()
  ...
  If cmbejercicio = "" Then Beep: MsgBox "Debe Seleccionar Ejercicio " & lblTitle, vbExclamation: cmbejercicio.SetFocus: Exit Sub
  ...
  a_Campos = Array("codcls", "pdocts", "descricts", "pdoano", "estadocts", IIf(Me.Tag = s_MdoData_Ins, "usrcre", "usrmdf"), IIf(Me.Tag = s_MdoData_Ins, "fyhcre", "fyhmdf"))
  a_Valores = Array(ps_ClsPlanilla, txtCodigo, Trim(txtDescripcion), cmbejercicio, s_Estado, ps_Usuario, Format(Now, s_FmtFeHoMysql_0))
  ...
  If Me.Tag = s_MdoData_Ins Then
    If Not Records_Ins("plctsperiodo", a_Campos, a_Valores, a_Tipos) Then GoTo Error
  Else
    If Not Records_Upd("plctsperiodo", a_Campos, a_Valores, a_Tipos, a_Where) Then GoTo Error
  End If
  gdl_Conexion.ConfirmaTransaccion ' Confirma transacción
...
Private Sub Form_Load()
  ...
  l_ExistRecord = (fCtsPeriodo.dcaRegistro.Recordset.EOF Or fCtsPeriodo.dcaRegistro.Recordset.BOF)
  If Not l_ExistRecord Then s_ParCodigo = fCtsPeriodo.dcaRegistro.Recordset!pdocts
  
  ' Adiciono los datos adicionales
  For n_Index = (Val(ps_Anyo) - 20) To (Val(ps_Anyo) + 20): cmbejercicio.AddItem Format(n_Index, "0000"): Next n_Index
