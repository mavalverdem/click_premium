...
Begin VB.Form fAbcNivEducativo 
   ...
   Begin TabDlg.SSTab tabRegister 
      ...
      TabPicture(0)   =   "abcniveducativo.frx":0000
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdCancel 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcniveducativo.frx":001C
      End
      Begin Threed.SSCommand cmdUpdate 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcniveducativo.frx":0038
      End
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdMove 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcniveducativo.frx":0054
      End
      Begin Threed.SSCommand cmdMove 
         Height          =   360
         Index           =   2
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcniveducativo.frx":0070
      End
      Begin Threed.SSCommand cmdMove 
         Height          =   360
         Index           =   1
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcniveducativo.frx":008C
      End
      Begin Threed.SSCommand cmdMove 
         Height          =   360
         Index           =   0
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcniveducativo.frx":00A8
      End
   End
   Begin Threed.SSPanel panToolBar 
      Height          =   2205
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcniveducativo.frx":00C4
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   1
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcniveducativo.frx":00E0
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   2
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "abcniveducativo.frx":00FC
      End
   End
End
Attribute VB_Name = "fAbcNivEducativo"
...
Private s_Nivel As String                           ' Codigo del registro
'[
...
If Me.Tag = s_MdoData_Ins Then
    gdl_Procedure.EditText "PK", txtCodigo, "", Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!codniv.DefinedSize
    gdl_Procedure.EditText "AT", txtDescripcion, "", Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!desniv.DefinedSize
...
Else
    gdl_Procedure.EditText "PK", txtCodigo, fTablaSistema.dcaRegistro.Recordset!codniv, Me.Tag, True, fTablaSistema.dcaRegistro.Recordset!codniv.DefinedSize
    gdl_Procedure.EditText "AT", txtDescripcion, gdl_Funcion.aTexto(fTablaSistema.dcaRegistro.Recordset!desniv), Me.Tag, False, fTablaSistema.dcaRegistro.Recordset!desniv.DefinedSize
    gdl_Procedure.EditOptionCheck "AT", optEstado(0), (fTablaSistema.dcaRegistro.Recordset!estadoniv = s_Estado_Act), Me.Tag, True
    gdl_Procedure.EditOptionCheck "AT", optEstado(1), (fTablaSistema.dcaRegistro.Recordset!estadoniv = s_Estado_Ina), Me.Tag, True
End If
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  If MsgBox("¿ Estás Seguro de Eliminar el " & lblTitle & " '" & Trim$(txtDescripcion) & "' ?", vbCritical + vbYesNo + vbDefaultButton2) = vbYes Then
    ...
    s_Nivel = Trim$(txtCodigo)
    
    '[ Inicio la conexión a la base de datos ]
    ps_StrgConnec = OpenConnection(ps_Servidor, ps_DataBase)
    ' Creo los arreglos de eliminacion
    a_Where = Array("codniv")
    a_Valores = Array(s_Nivel)
    a_Tipos = Array(TipoDato.Caracter)
      
    gdl_Conexion.IniciaTransaccion    'Inicia transacción
    ' Elimino el registro
    If Not Records_Del("plniveducativo", a_Where, a_Valores, a_Tipos) Then GoTo Error
    ...
    If Not l_ExistRecord Then
      fTablaSistema.dcaRegistro.Recordset.Find ("codniv >= '" & s_Nivel & "'")
...
Private Sub cmdUpdate_Click()
  ...
  a_Campos = Array("codniv", "desniv", "estadoniv", IIf(Me.Tag = s_MdoData_Ins, "usrcre", "usrmdf"), IIf(Me.Tag = s_MdoData_Ins, "fyhcre", "fyhmdf"))
  ...
  If Me.Tag = s_MdoData_Ins Then
    If Not Records_Ins("plniveducativo", a_Campos, a_Valores, a_Tipos) Then GoTo Error
  Else
    If Not Records_Upd("plniveducativo", a_Campos, a_Valores, a_Tipos, a_Where) Then GoTo Error
  End If
  gdl_Conexion.ConfirmaTransaccion ' Confirma transacción
...
Private Sub Form_Load()
  ...
  s_TitleWindow = "Actualización Nivel Educativo"
  lblTitle = "Nivel Educativo"
  ' Coloco el puntero en espera
  gdl_Procedure.PunteroEnEspera
  ...
  If Not l_ExistRecord Then s_ParCodigo = fTablaSistema.dcaRegistro.Recordset!codniv
