...
Begin VB.Form fEmpresasqmdes 
   ...
   Begin Threed.SSPanel panToolBar 
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "empresasqmdes.frx":0000
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   2
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "empresasqmdes.frx":001C
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   3
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "empresasqmdes.frx":0038
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   4
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "empresasqmdes.frx":0054
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   6
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "empresasqmdes.frx":0070
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   7
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "empresasqmdes.frx":008C
      End
      ...
      Begin Threed.SSCommand cmdAction 
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "empresasqmdes.frx":00A8
      End
      Begin Threed.SSCommand cmdAction 
         Height          =   360
         Index           =   5
         ...
         Outline         =   0   'False
         AutoSize        =   2
         Picture         =   "empresasqmdes.frx":00C4
      End
   End
End
Attribute VB_Name = "fEmpresasqmdes"
...
Private Sub RecuperaRegistros(ByVal s_Orden As String)
  ...
  s_Sql = "SELECT codqmd, desqmd, actqmd, fechaini_qmd, fechafin_qmd, estadoqmd "
  s_Sql = s_Sql & "FROM plempresasqmdes "
...
Private Sub cmdAction_Click(Index As Integer)
  ...
  Select Case Index
   ...
   Case 6, 7  ' Opciones de impresión
    ...
    gdl_Procedure.ps_ReportTitle = "EMPRESAS QUE ME DESTACAN O DESPLAZAN PERSONAL"
    gdl_Procedure.ps_ReportName = "lstempresasqmdes"
    ...
    s_Sql = "SELECT codqmd, desqmd, actqmd,estadoqmd"
    s_Sql = s_Sql & " FROM plempresasqmdes afp"
...
Private Sub Form_Load()
  ...
  s_TitleTable = "Empresas que me Destacan o Desplazan Personal"
  
  ReDim aElemento(3, 10)
  For i = 0 To (UBound(aElemento, 1) - 1)
    aElemento(i, 0) = Choose(i + 1, "Código", "Descripción", "Ok")
    aElemento(i, 1) = Choose(i + 1, "codqmd", "desqmd", "estadoqmd")
...
Private Sub Form_Unload(Cancel As Integer)
  ...
  If FormVisible("fAbcEmpresasqmdes") Then
    Beep
    MsgBox "Primero debe cerrar la Pantalla de " & fAbcEmpresasqmdes.Caption, vbExclamation
    Cancel = True
  End If
